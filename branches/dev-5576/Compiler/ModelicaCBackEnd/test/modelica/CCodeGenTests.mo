...
#define __homotopy_lambda ((*(jmi->z))[jmi->offs_homotopy_lambda])
    ...
    (*res)[0] = (1.0 - (1.0 * (_x2_1) * (_x2_1))) * _der_x2_6 - _x2_1 + _p_3 * _u_2 - (_der_x1_5);
...
annotation(__JModelica(UnitTesting(tests={
    CCodeGenTestCase(
        ...
        generatedCode="
    (*res)[0] = _y_1 - (_der_x_2);
    (*res)[1] = (COND_EXP_EQ(COND_EXP_LE(_time, jmi_divide_equation(jmi, AD_WRAP_LITERAL(3.141592653589793), AD_WRAP_LITERAL(2.0), \"3.141592653589793 / 2\"), JMI_TRUE, JMI_FALSE), JMI_TRUE, sin(_time), _x_0)) - (_der_x_2);
")})));
end CCodeGenTest4;
...
annotation(__JModelica(UnitTesting(tests={
    CCodeGenTestCase(
        ...
        generatedCode="
    (*res)[0] = _y_3 - (_der_x_4);
    (*res)[1] = (COND_EXP_EQ(COND_EXP_LE(_time, _one_0, JMI_TRUE, JMI_FALSE), JMI_TRUE, _x_2, COND_EXP_EQ(COND_EXP_LE(_time, _two_1, JMI_TRUE, JMI_FALSE), JMI_TRUE, AD_WRAP_LITERAL(-2.0) * _x_2, AD_WRAP_LITERAL(3.0) * _x_2))) - (_der_x_4);
")})));
end CCodeGenTest5;
...
",
        generatedCode="
    (*res)[0] = _y_2 - (_der_x_3);
    (*res)[1] = (COND_EXP_EQ(COND_EXP_LE(_time, AD_WRAP_LITERAL(2.0), JMI_TRUE, JMI_FALSE), JMI_TRUE, AD_WRAP_LITERAL(0.0), COND_EXP_EQ(COND_EXP_GE(_time, AD_WRAP_LITERAL(4.0), JMI_TRUE, JMI_FALSE), JMI_TRUE, AD_WRAP_LITERAL(1.0), COND_EXP_EQ(COND_EXP_LT(_x_1, AD_WRAP_LITERAL(2.0), JMI_TRUE, JMI_FALSE), JMI_TRUE, AD_WRAP_LITERAL(2.0), COND_EXP_EQ(COND_EXP_GT(_x_1, AD_WRAP_LITERAL(4.0), JMI_TRUE, JMI_FALSE), JMI_TRUE, AD_WRAP_LITERAL(4.0), COND_EXP_EQ(COND_EXP_EQ(_z_0, AD_WRAP_LITERAL(3.0), JMI_TRUE, JMI_FALSE), JMI_TRUE, AD_WRAP_LITERAL(4.0), AD_WRAP_LITERAL(7.0))))))) - (_der_x_3);
...
annotation(__JModelica(UnitTesting(tests={
    CCodeGenTestCase(
        ...
        template="$C_DAE_equation_residuals$",
        generatedCode="
    (*res)[0] = COND_EXP_EQ(_sw(0), JMI_TRUE, AD_WRAP_LITERAL(-1.0) + _y_1, - _y_1) - (_x_0);
    (*res)[1] = _z_2 + _x_0 + COND_EXP_EQ(_sw(1), JMI_TRUE, AD_WRAP_LITERAL(-3.0), AD_WRAP_LITERAL(3.0)) - (_y_1);
    (*res)[2] = - _y_1 - _x_0 + COND_EXP_EQ(_sw(2), JMI_TRUE, AD_WRAP_LITERAL(-1.0), AD_WRAP_LITERAL(1.0)) - (_z_2);
")})));
end CCodeGenTest8;
...
",
    ...
    (*res)[1] = - _y_1 - (_der_y_4);
    (*res)[2] = - _z_2 - (_der_z_5);
    (*res)[3] = (COND_EXP_EQ(COND_EXP_GE(_time, AD_WRAP_LITERAL(1.0), JMI_TRUE, JMI_FALSE), JMI_TRUE, AD_WRAP_LITERAL(-1.0) + _y_1, - _y_1)) - (_x_0);
    (*res)[4] = 2.0 * (_z_2 + _x_0 + COND_EXP_EQ(COND_EXP_GE(_z_2, AD_WRAP_LITERAL(-1.5), JMI_TRUE, JMI_FALSE), JMI_TRUE, AD_WRAP_LITERAL(-3.0), AD_WRAP_LITERAL(3.0))) - (_y_1);
    (*res)[5] = - _y_1 - _x_0 + COND_EXP_EQ(_sw_init(0), JMI_TRUE, AD_WRAP_LITERAL(-1.0), AD_WRAP_LITERAL(1.0)) - (_z_2);
...
",
    ...
    (*res)[1] = - _y_1 - (_der_y_4);
    (*res)[2] = - _z_2 - (_der_z_5);
    (*res)[3] = COND_EXP_EQ(_sw_init(0), JMI_TRUE, AD_WRAP_LITERAL(-1.0) + _y_1, - _y_1) - (_x_0);
    (*res)[4] = _z_2 + _x_0 + COND_EXP_EQ(_sw_init(1), JMI_TRUE, AD_WRAP_LITERAL(-3.0), AD_WRAP_LITERAL(3.0)) - (_y_1);
    (*res)[5] = - _y_1 - _x_0 + COND_EXP_EQ(_sw_init(2), JMI_TRUE, AD_WRAP_LITERAL(-1.0), AD_WRAP_LITERAL(1.0)) - (_z_2);

    int ef = 0;
    JMI_DYNAMIC_INIT()
    (*res)[0] = _time - (AD_WRAP_LITERAL(1.0));
...
int model_ode_initialize_base(jmi_t* jmi) {
    ...
    _der_x2_6 = _x1_0;
    _x2_1 = 1;
    _der_x1_5 = (1.0 - (1.0 * (_x2_1) * (_x2_1))) * _der_x2_6 + (- _x2_1) + _p_3 * _u_2;
...
0
    int ef = 0;
    JMI_DYNAMIC_INIT()
    (*res)[0] = _time - (AD_WRAP_LITERAL(5.0));
    (*res)[1] = _time - (AD_WRAP_LITERAL(1.0));
    (*res)[2] = COND_EXP_EQ(LOG_EXP_NOT(_sw_init(0)), JMI_TRUE, _time - (AD_WRAP_LITERAL(2.0)), AD_WRAP_LITERAL(1));
    JMI_DYNAMIC_FREE()
    return ef;
...
int model_ode_initialize_base(jmi_t* jmi) {
    ...
    if (jmi->atInitial || jmi->atEvent) {
        _sw_init(0) = jmi_turn_switch(jmi, _time - (AD_WRAP_LITERAL(1.0)), _sw_init(0), JMI_REL_GEQ);
    }
    if (_sw_init(0)) {
    } else {
        if (jmi->atInitial || jmi->atEvent) {
            _sw_init(1) = jmi_turn_switch(jmi, _time - (AD_WRAP_LITERAL(2.0)), _sw_init(1), JMI_REL_GEQ);
        }
    }
    _der_x_3 = COND_EXP_EQ(_sw_init(0), JMI_TRUE, AD_WRAP_LITERAL(1.0), COND_EXP_EQ(_sw_init(1), JMI_TRUE, AD_WRAP_LITERAL(3.0), AD_WRAP_LITERAL(5.0)));
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(jmi, _time - (AD_WRAP_LITERAL(5.0)), _sw(0), JMI_REL_GEQ);
    }
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    if (jmi->atInitial || jmi->atEvent) {
        _sw(1) = jmi_turn_switch(jmi, _time - (pre_index_4 + AD_WRAP_LITERAL(1.0)), _sw(1), JMI_REL_GEQ);
    }
    _index_4 = COND_EXP_EQ(LOG_EXP_OR(LOG_EXP_OR(_sw(0), _sw(1)), _atInitial), JMI_TRUE, floor(_time), pre_index_4);
    pre_index_4 = _index_4;
    _x_3 = pre_x_3;
    if (COND_EXP_LT(_index_4, 4.0, JMI_TRUE, JMI_FALSE)) {
...
void func_CCodeGenTests_CCodeGenTest20_fw_def0(jmi_array_t* x_a, jmi_array_t* y_a) {
    ...
    JMI_DEF(REA, t_v)
    JMI_ARR(STAT, jmi_real_t, jmi_array_t, tmp_1, 1, 2)
    if (y_a == NULL) {
        JMI_ARRAY_INIT_2(STAT, jmi_real_t, jmi_array_t, y_an, 1, 2, 1, 1)
        y_a = y_an;
    }
    JMI_ARRAY_INIT_2(STAT, jmi_real_t, jmi_array_t, tmp_1, 1, 2, 1, 1)
    jmi_array_ref_2(tmp_1, 1,1) = jmi_array_val_2(x_a, 1.0, 1.0);
...
void func_CCodeGenTests_CCodeGenTest20_mysum_def2(jmi_array_t* x_a, jmi_real_t* y_o) {
    ...
    for (i1_0i = 1.0; i1_0i < i1_0ie; i1_0i += 1) {
        i2_1ie = jmi_array_size(x_a, 1) + 1 / 2.0;
        for (i2_1i = 1.0; i2_1i < i2_1ie; i2_1i += 1) {
...
int model_ode_derivatives_base(jmi_t* jmi) {
    int ef = 0;
    JMI_DYNAMIC_INIT()
    _der_x_1 = jmi_divide_equation(jmi, _x_0, 1234.0, \"x / 1234\");
    JMI_DYNAMIC_FREE()
    return ef;
}
")})));
...
annotation(__JModelica(UnitTesting(tests={
    ...
    snprintf(JMI_STR_END(tmp_2), JMI_STR_LEFT(tmp_2), \"%-*d\", (int) AD_WRAP_LITERAL(12.0), (int) _intVar_1);
    func_CCodeGenTests_CStringExp_StringCompare_def0(\"42          \", tmp_2);
    JMI_INI_STR_STAT(tmp_3)
    snprintf(JMI_STR_END(tmp_3), JMI_STR_LEFT(tmp_3), COND_EXP_EQ(JMI_FALSE, JMI_TRUE, \"%-*d\", \"%*d\"), (int) AD_WRAP_LITERAL(12.0), (int) _intVar_1);
    ...
    snprintf(JMI_STR_END(tmp_5), JMI_STR_LEFT(tmp_5), \"%-*.*g\", (int) AD_WRAP_LITERAL(12.0), (int) 6, _realVar_0);
    func_CCodeGenTests_CStringExp_StringCompare_def0(\"3.14000     \", tmp_5);
    JMI_INI_STR_STAT(tmp_6)
    snprintf(JMI_STR_END(tmp_6), JMI_STR_LEFT(tmp_6), COND_EXP_EQ(JMI_FALSE, JMI_TRUE, \"%-*.*g\", \"%*.*g\"), (int) AD_WRAP_LITERAL(12.0), (int) 6, _realVar_0);
    func_CCodeGenTests_CStringExp_StringCompare_def0(\"     3.14000\", tmp_6);
    JMI_INI_STR_STAT(tmp_7)
    snprintf(JMI_STR_END(tmp_7), JMI_STR_LEFT(tmp_7), \"%-.*g\", (int) AD_WRAP_LITERAL(8.0), _realVar_0);
    func_CCodeGenTests_CStringExp_StringCompare_def0(\"3.1400000\", tmp_7);
    JMI_INI_STR_STAT(tmp_8)
    snprintf(JMI_STR_END(tmp_8), JMI_STR_LEFT(tmp_8), \"%-*.*g\", (int) AD_WRAP_LITERAL(12.0), (int) AD_WRAP_LITERAL(8.0), _realVar_0);
    func_CCodeGenTests_CStringExp_StringCompare_def0(\"3.1400000   \", tmp_8);
    JMI_INI_STR_STAT(tmp_9)
    snprintf(JMI_STR_END(tmp_9), JMI_STR_LEFT(tmp_9), COND_EXP_EQ(JMI_FALSE, JMI_TRUE, \"%-*.*g\", \"%*.*g\"), (int) AD_WRAP_LITERAL(12.0), (int) AD_WRAP_LITERAL(8.0), _realVar_0);
    ...
    snprintf(JMI_STR_END(tmp_11), JMI_STR_LEFT(tmp_11), \"%-*.*g\", (int) AD_WRAP_LITERAL(12.0), (int) 6, - _realVar_0);
    func_CCodeGenTests_CStringExp_StringCompare_def0(\"-3.14000    \", tmp_11);
    JMI_INI_STR_STAT(tmp_12)
    snprintf(JMI_STR_END(tmp_12), JMI_STR_LEFT(tmp_12), COND_EXP_EQ(JMI_FALSE, JMI_TRUE, \"%-*.*g\", \"%*.*g\"), (int) AD_WRAP_LITERAL(12.0), (int) 6, - _realVar_0);
    func_CCodeGenTests_CStringExp_StringCompare_def0(\"    -3.14000\", tmp_12);
    JMI_INI_STR_STAT(tmp_13)
    snprintf(JMI_STR_END(tmp_13), JMI_STR_LEFT(tmp_13), \"%-.*g\", (int) AD_WRAP_LITERAL(8.0), - _realVar_0);
    func_CCodeGenTests_CStringExp_StringCompare_def0(\"-3.1400000\", tmp_13);
    JMI_INI_STR_STAT(tmp_14)
    snprintf(JMI_STR_END(tmp_14), JMI_STR_LEFT(tmp_14), \"%-*.*g\", (int) AD_WRAP_LITERAL(12.0), (int) AD_WRAP_LITERAL(8.0), - _realVar_0);
    func_CCodeGenTests_CStringExp_StringCompare_def0(\"-3.1400000  \", tmp_14);
    JMI_INI_STR_STAT(tmp_15)
    snprintf(JMI_STR_END(tmp_15), JMI_STR_LEFT(tmp_15), COND_EXP_EQ(JMI_FALSE, JMI_TRUE, \"%-*.*g\", \"%*.*g\"), (int) AD_WRAP_LITERAL(12.0), (int) AD_WRAP_LITERAL(8.0), - _realVar_0);
    ...
    snprintf(JMI_STR_END(tmp_17), JMI_STR_LEFT(tmp_17), \"%-*s\", (int) AD_WRAP_LITERAL(12.0), COND_EXP_EQ(_boolVar_2, JMI_TRUE, \"true\", \"false\"));
    func_CCodeGenTests_CStringExp_StringCompare_def0(\"false       \", tmp_17);
    JMI_INI_STR_STAT(tmp_18)
    snprintf(JMI_STR_END(tmp_18), JMI_STR_LEFT(tmp_18), COND_EXP_EQ(JMI_FALSE, JMI_TRUE, \"%-*s\", \"%*s\"), (int) AD_WRAP_LITERAL(12.0), COND_EXP_EQ(_boolVar_2, JMI_TRUE, \"true\", \"false\"));
    ...
    snprintf(JMI_STR_END(tmp_20), JMI_STR_LEFT(tmp_20), \"%-*s\", (int) AD_WRAP_LITERAL(12.0), COND_EXP_EQ(LOG_EXP_NOT(_boolVar_2), JMI_TRUE, \"true\", \"false\"));
    func_CCodeGenTests_CStringExp_StringCompare_def0(\"true        \", tmp_20);
    JMI_INI_STR_STAT(tmp_21)
    snprintf(JMI_STR_END(tmp_21), JMI_STR_LEFT(tmp_21), COND_EXP_EQ(JMI_FALSE, JMI_TRUE, \"%-*s\", \"%*s\"), (int) AD_WRAP_LITERAL(12.0), COND_EXP_EQ(LOG_EXP_NOT(_boolVar_2), JMI_TRUE, \"true\", \"false\"));
    ...
    snprintf(JMI_STR_END(tmp_23), JMI_STR_LEFT(tmp_23), \"%-*s\", (int) AD_WRAP_LITERAL(12.0), E_0_e[(int) _enumVar_3]);
    func_CCodeGenTests_CStringExp_StringCompare_def0(\"medium      \", tmp_23);
    JMI_INI_STR_STAT(tmp_24)
    snprintf(JMI_STR_END(tmp_24), JMI_STR_LEFT(tmp_24), COND_EXP_EQ(JMI_FALSE, JMI_TRUE, \"%-*s\", \"%*s\"), (int) AD_WRAP_LITERAL(12.0), E_0_e[(int) _enumVar_3]);
    ...
    (*res)[0] = COND_EXP_EQ(COND_EXP_LT(_realVar_0, AD_WRAP_LITERAL(2.5), JMI_TRUE, JMI_FALSE), JMI_TRUE, AD_WRAP_LITERAL(12.0), AD_WRAP_LITERAL(42.0)) - (_intVar_1);
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    __stream_s_1_21 = jmi_max(_a_c2_f_4, AD_WRAP_LITERAL(0.0)) + jmi_max(_a_c3_f_7, AD_WRAP_LITERAL(0.0));
    __stream_alpha_1_22 = (COND_EXP_EQ(COND_EXP_GT(__stream_s_1_21, jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1), JMI_TRUE, JMI_FALSE), JMI_TRUE, AD_WRAP_LITERAL(1.0), COND_EXP_EQ(COND_EXP_GT(__stream_s_1_21, AD_WRAP_LITERAL(0.0), JMI_TRUE, JMI_FALSE), JMI_TRUE, jmi_divide_equation(jmi, __stream_s_1_21, (jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1)), \"_stream_s_1 / (_inStreamEpsilon * 0.1)\") * (jmi_divide_equation(jmi, __stream_s_1_21, (jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1)), \"_stream_s_1 / (_inStreamEpsilon * 0.1)\") * (AD_WRAP_LITERAL(3.0) - AD_WRAP_LITERAL(2.0) * __stream_s_1_21)), AD_WRAP_LITERAL(0.0))));
    __stream_positiveMax_1_23 = __stream_alpha_1_22 * jmi_max(_a_c2_f_4, AD_WRAP_LITERAL(0.0)) + (1.0 - __stream_alpha_1_22) * (jmi_in_stream_eps(jmi) * 0.1);
    _b_c5_s_17 = 5;
    __stream_positiveMax_2_24 = __stream_alpha_1_22 * jmi_max(_a_c3_f_7, AD_WRAP_LITERAL(0.0)) + (1.0 - __stream_alpha_1_22) * (jmi_in_stream_eps(jmi) * 0.1);
    _b_c6_s_20 = 6;
    ...
    _a_c2_p_3 = _a_c1_p_0;
    __stream_s_2_25 = jmi_max(_a_c1_f_1, AD_WRAP_LITERAL(0.0)) + jmi_max(_a_c3_f_7, AD_WRAP_LITERAL(0.0));
    __stream_alpha_2_26 = (COND_EXP_EQ(COND_EXP_GT(__stream_s_2_25, jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1), JMI_TRUE, JMI_FALSE), JMI_TRUE, AD_WRAP_LITERAL(1.0), COND_EXP_EQ(COND_EXP_GT(__stream_s_2_25, AD_WRAP_LITERAL(0.0), JMI_TRUE, JMI_FALSE), JMI_TRUE, jmi_divide_equation(jmi, __stream_s_2_25, (jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1)), \"_stream_s_2 / (_inStreamEpsilon * 0.1)\") * (jmi_divide_equation(jmi, __stream_s_2_25, (jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1)), \"_stream_s_2 / (_inStreamEpsilon * 0.1)\") * (AD_WRAP_LITERAL(3.0) - AD_WRAP_LITERAL(2.0) * __stream_s_2_25)), AD_WRAP_LITERAL(0.0))));
    __stream_positiveMax_3_27 = __stream_alpha_2_26 * jmi_max(_a_c1_f_1, AD_WRAP_LITERAL(0.0)) + (1.0 - __stream_alpha_2_26) * (jmi_in_stream_eps(jmi) * 0.1);
    _b_c4_s_14 = 4;
    __stream_positiveMax_4_28 = __stream_alpha_2_26 * jmi_max(_a_c3_f_7, AD_WRAP_LITERAL(0.0)) + (1.0 - __stream_alpha_2_26) * (jmi_in_stream_eps(jmi) * 0.1);
    ...
    _a_c3_p_6 = _a_c2_p_3;
    __stream_s_3_29 = jmi_max(_a_c1_f_1, AD_WRAP_LITERAL(0.0)) + jmi_max(_a_c2_f_4, AD_WRAP_LITERAL(0.0));
    __stream_alpha_3_30 = (COND_EXP_EQ(COND_EXP_GT(__stream_s_3_29, jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1), JMI_TRUE, JMI_FALSE), JMI_TRUE, AD_WRAP_LITERAL(1.0), COND_EXP_EQ(COND_EXP_GT(__stream_s_3_29, AD_WRAP_LITERAL(0.0), JMI_TRUE, JMI_FALSE), JMI_TRUE, jmi_divide_equation(jmi, __stream_s_3_29, (jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1)), \"_stream_s_3 / (_inStreamEpsilon * 0.1)\") * (jmi_divide_equation(jmi, __stream_s_3_29, (jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1)), \"_stream_s_3 / (_inStreamEpsilon * 0.1)\") * (AD_WRAP_LITERAL(3.0) - AD_WRAP_LITERAL(2.0) * __stream_s_3_29)), AD_WRAP_LITERAL(0.0))));
    __stream_positiveMax_5_31 = __stream_alpha_3_30 * jmi_max(_a_c1_f_1, AD_WRAP_LITERAL(0.0)) + (1.0 - __stream_alpha_3_30) * (jmi_in_stream_eps(jmi) * 0.1);
    __stream_positiveMax_6_32 = __stream_alpha_3_30 * jmi_max(_a_c2_f_4, AD_WRAP_LITERAL(0.0)) + (1.0 - __stream_alpha_3_30) * (jmi_in_stream_eps(jmi) * 0.1);
...
int model_init_eval_parameters_base(jmi_t* jmi) {
    ...
    JMI_DYNAMIC_INIT()
    _y_1 = ((_x_0*sf(0)))/sf(1);
    _z_2 = (func_CCodeGenTests_CCodeGenParameters1_f_exp0(AD_WRAP_LITERAL(1.0)))/sf(2);
    JMI_DYNAMIC_FREE()
    return ef;
}
...
#define __homotopy_lambda ((*(jmi->z))[jmi->offs_homotopy_lambda])
    ...
    (*res)[0] = 1 - (_x_y_0);
    (*res)[1] = _x_y_0 + 2.0 - (_x_y_1);
    (*res)[2] = _der_x_y_3 - 1.0 - (_der_x_y_2);
")})));
...
annotation(__JModelica(UnitTesting(tests={
    CCodeGenTestCase(
        ...
        template="$C_DAE_equation_residuals$",
        generatedCode="
    (*res)[0] = jmi_divide_equation(jmi, _y_1_1_4 * _y_1_1_4, jmi_pow_equation(jmi, (_y_1_1_4 + _y_1_1_4 - 2.0), _y_1_1_4, \"(y[1,1] .+ y[1,1] .- 2) .^ y[1,1]\"), \"y[1,1] .* y[1,1] ./ (y[1,1] .+ y[1,1] .- 2) .^ y[1,1]\") - (_x_1_1_0);
    (*res)[1] = jmi_divide_equation(jmi, _y_1_2_5 * _y_1_2_5, jmi_pow_equation(jmi, (_y_1_2_5 + _y_1_2_5 - 2.0), _y_1_2_5, \"(y[1,2] .+ y[1,2] .- 2) .^ y[1,2]\"), \"y[1,2] .* y[1,2] ./ (y[1,2] .+ y[1,2] .- 2) .^ y[1,2]\") - (_x_1_2_1);
    (*res)[2] = jmi_divide_equation(jmi, _y_2_1_6 * _y_2_1_6, jmi_pow_equation(jmi, (_y_2_1_6 + _y_2_1_6 - 2.0), _y_2_1_6, \"(y[2,1] .+ y[2,1] .- 2) .^ y[2,1]\"), \"y[2,1] .* y[2,1] ./ (y[2,1] .+ y[2,1] .- 2) .^ y[2,1]\") - (_x_2_1_2);
    (*res)[3] = jmi_divide_equation(jmi, _y_2_2_7 * _y_2_2_7, jmi_pow_equation(jmi, (_y_2_2_7 + _y_2_2_7 - 2.0), _y_2_2_7, \"(y[2,2] .+ y[2,2] .- 2) .^ y[2,2]\"), \"y[2,2] .* y[2,2] ./ (y[2,2] .+ y[2,2] .- 2) .^ y[2,2]\") - (_x_2_2_3);
    (*res)[4] = 1 - (_y_1_1_4);
    (*res)[5] = 2 - (_y_1_2_5);
    (*res)[6] = 3 - (_y_2_1_6);
    (*res)[7] = 4 - (_y_2_2_7);
...
int model_ode_derivatives_base(jmi_t* jmi) {
    int ef = 0;
    JMI_DYNAMIC_INIT()
    _y_0 = jmi_atan2_equation(jmi, _time, _time + AD_WRAP_LITERAL(1.0), \"atan2(time, time + 1)\") + func_CCodeGenTests_CCodeGenATan2Op_f_exp0(_time);
    JMI_DYNAMIC_FREE()
    return ef;
}
...
void func_CCodeGenTests_CCodeGenATan2Op_f_def0(jmi_real_t x_v, jmi_real_t* y_o) {
    JMI_DYNAMIC_INIT()
    JMI_DEF(REA, y_v)
    y_v = jmi_atan2_function(\"CCodeGenTests.CCodeGenATan2Op.f\", x_v, x_v + AD_WRAP_LITERAL(1.0), \"atan2(x, x + 1)\");
    JMI_RET(GEN, y_o, y_v)
    JMI_DYNAMIC_FREE()
    return;
}
...
annotation(__JModelica(UnitTesting(tests={
    ...
    (*res)[5] = jmi_min(AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(2.0)) - (_y2_5);
    (*res)[6] = jmi_max(jmi_max(_x_1_1_0, _x_1_2_1), jmi_max(_x_2_1_2, _x_2_2_3)) - (_y3_6);
    (*res)[7] = jmi_max(AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(2.0)) - (_y4_7);
")})));
end CCodeGenMinMax;
...
jmi_real_t func_CCodeGenTests_TestFunction2_exp0(jmi_real_t i1_v, jmi_real_t i2_v) {
    ...
    JMI_DEF(REA, tmp_1)
    JMI_DEF(REA, tmp_2)
    func_CCodeGenTests_TestFunction2_def0(AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(2.0), &tmp_1, &tmp_2);
    (*res)[0] = tmp_1 - (_x_0);
    (*res)[1] = tmp_2 - (_y_1);
")})));
end CFunctionTest2;
...
jmi_real_t func_CCodeGenTests_TestFunction2_exp0(jmi_real_t i1_v, jmi_real_t i2_v) {
    ...
    (*res)[0] = func_CCodeGenTests_TestFunction2_exp0(AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(0.0)) - (_x_0);
    (*res)[1] = func_CCodeGenTests_TestFunction2_exp0(AD_WRAP_LITERAL(2.0), AD_WRAP_LITERAL(3.0)) - (_y_1);
")})));
end CFunctionTest3;
...
jmi_real_t func_CCodeGenTests_TestFunction1_exp1(jmi_real_t i1_v) {
    ...
    (*res)[0] = func_CCodeGenTests_TestFunction1_exp1(_y_1 * AD_WRAP_LITERAL(2.0)) - (_x_0);
    (*res)[1] = func_CCodeGenTests_TestFunction2_exp0(AD_WRAP_LITERAL(2.0), AD_WRAP_LITERAL(3.0)) - (_y_1);
")})));
end CFunctionTest4;
...
jmi_real_t func_CCodeGenTests_TestFunction3_exp0(jmi_real_t i1_v, jmi_real_t i2_v, jmi_real_t i3_v) {
    ...
    JMI_DEF(REA, tmp_1)
    JMI_DEF(REA, tmp_2)
    func_CCodeGenTests_TestFunction3_def0(AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(2.0), AD_WRAP_LITERAL(3.0), &tmp_1, &tmp_2, NULL);
    (*res)[0] = tmp_1 - (_x_0);
    (*res)[1] = tmp_2 - (_y_1);
")})));
end CFunctionTest5;
...
jmi_real_t func_CCodeGenTests_TestFunction3_exp0(jmi_real_t i1_v, jmi_real_t i2_v, jmi_real_t i3_v) {
    ...
    JMI_DEF(REA, tmp_1)
    JMI_DEF(REA, tmp_2)
    func_CCodeGenTests_TestFunction3_def0(AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(2.0), AD_WRAP_LITERAL(3.0), &tmp_1, NULL, &tmp_2);
    (*res)[0] = tmp_1 - (_x_0);
    (*res)[1] = tmp_2 - (_z_1);
")})));
end CFunctionTest6;
...
jmi_real_t func_CCodeGenTests_TestFunction2_exp0(jmi_real_t i1_v, jmi_real_t i2_v) {
    ...
    func_CCodeGenTests_TestFunction2_def0(AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(2.0), NULL, NULL);
")})));
end CFunctionTest7;
...
jmi_real_t func_CCodeGenTests_TestFunction1_exp1(jmi_real_t i1_v) {
    ...
    (*res)[0] = func_CCodeGenTests_TestFunctionCallingFunction_exp0(AD_WRAP_LITERAL(1.0)) - (_x_0);
")})));
end CFunctionTest8;
...
void func_CCodeGenTests_TestFunctionRecursive_def0(jmi_real_t i1_v, jmi_real_t* o1_o) {
    JMI_DYNAMIC_INIT()
    JMI_DEF(INT, o1_v)
    if (COND_EXP_LT(i1_v, 3.0, JMI_TRUE, JMI_FALSE)) {
        o1_v = 1;
    } else {
        o1_v = func_CCodeGenTests_TestFunctionRecursive_exp0(i1_v - AD_WRAP_LITERAL(1.0)) + func_CCodeGenTests_TestFunctionRecursive_exp0(i1_v - AD_WRAP_LITERAL(2.0));
    }
    JMI_RET(GEN, o1_o, o1_v)
    JMI_DYNAMIC_FREE()
    return;
...
void func_CCodeGenTests_TestFunctionNoOut_def0(jmi_real_t i1_v) {
    ...
    func_CCodeGenTests_TestFunctionNoOut_def0(AD_WRAP_LITERAL(1.0));
")})));
end CFunctionTest11;
...
void func_CCodeGenTests_CFunctionTest12_f_def0(jmi_array_t* x_a, jmi_array_t* y_a) {
    ...
    jmi_array_ref_1(y_a, 1.0) = jmi_array_val_1(x_a, 1.0);
    jmi_array_ref_1(y_a, 2.0) = jmi_array_val_1(x_a, 2.0);
    JMI_DYNAMIC_FREE()
    return;
}
...
void func_CCodeGenTests_CFunctionTest13_F_def0(jmi_array_t* x_a, jmi_real_t u_v, jmi_array_t* dx_a, jmi_array_t* y_a) {
    ...
    jmi_array_ref_1(dx_a, 1.0) = - jmi_array_val_1(x_a, 1.0) + u_v;
    jmi_array_ref_1(dx_a, 2.0) = - jmi_array_val_1(x_a, 2.0);
    jmi_array_ref_1(y_a, 1.0) = 2.0 * jmi_array_val_1(x_a, 1.0);
    jmi_array_ref_1(y_a, 2.0) = 2.0 * jmi_array_val_1(x_a, 2.0);
    JMI_DYNAMIC_FREE()
    return;
}
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    JMI_ARR(STAT, jmi_real_t, jmi_array_t, tmp_2, 2, 1)
    JMI_ARRAY_INIT_1(STAT, jmi_real_t, jmi_array_t, tmp_2, 2, 1, 2)
    func_CCodeGenTests_CFunctionTest16_f_def0(AD_WRAP_LITERAL(2.0), _time, tmp_1, tmp_2);
    _y1_b_1 = (tmp_1->b);
...
void func_CCodeGenTests_CFunctionTest17_F1_def0(jmi_real_t x_v, jmi_array_t* y_a) {
    ...
    jmi_array_ref_1(y_a, 2.0) = 2.0 * x_v;
    JMI_ARRAY_INIT_1(STAT, jmi_real_t, jmi_array_t, tmp_1, 2, 1, 2)
...
void func_CCodeGenTests_CFunctionTest17_F2_def1(jmi_array_t* x_a, jmi_array_t* y_a) {
    ...
    for (i_0i = 1.0; i_0i < i_0ie; i_0i += 1) {
        jmi_array_ref_1(y_a, i_0i) = jmi_array_val_1(x_a, 1.0) + jmi_array_val_1(x_a, 2.0);
    }
    JMI_DYNAMIC_FREE()
    return;
}
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    func_CCodeGenTests_CFunctionTest20_f_def0(tmp_3, AD_WRAP_LITERAL(3.0), tmp_1);
...
int model_init_eval_parameters_base(jmi_t* jmi) {
    ...
    jmi_array_ref_1(tmp_3, 4) = AD_WRAP_LITERAL(4.0);
    jmi_array_ref_1(tmp_3, 5) = AD_WRAP_LITERAL(5.0);
...
jmi_real_t func_CCodeGenTests_CForLoop1_f_exp0() {
    JMI_DEF(REA, o_v)
 ...
 Real x = f();
    ...
    annotation(__JModelica(UnitTesting(tests={
        CCodeGenTestCase(
            ...
            template="$C_functions$",
            generatedCode="
void func_CCodeGenTests_CForLoop2_f_def0(jmi_real_t* o_o) {
    JMI_DYNAMIC_INIT()
    JMI_DEF(REA, o_v)
    JMI_DEF(REA, x_v)
...
jmi_real_t func_CCodeGenTests_CForLoop2_f_exp0() {
    JMI_DEF(REA, o_v)
...
void func_CCodeGenTests_CForLoop3_f_def0(jmi_real_t* o_o) {
    ...
    x_v = 0;
    i_0ie = 1.0 + -1.0 / 2.0;
    for (i_0i = 3.0; i_0i > i_0ie; i_0i += -1.0) {
        x_v = x_v + i_0i;
    }
    JMI_RET(GEN, o_o, o_v)
    JMI_DYNAMIC_FREE()
...
jmi_real_t func_CCodeGenTests_CForLoop3_f_exp0() {
    JMI_DEF(REA, o_v)
...
void func_CCodeGenTests_CForLoop4_f_def0(jmi_real_t i_v, jmi_real_t* o_o) {
    ...
    x_v = 0;
    i_0ie = 1.0 + i_v / 2.0;
    for (i_0i = 3.0; i_0i * i_v < i_0ie * i_v; i_0i += i_v) {
        x_v = x_v + i_0i;
    }
    JMI_RET(GEN, o_o, o_v)
    JMI_DYNAMIC_FREE()
...
jmi_real_t func_CCodeGenTests_CForLoop4_f_exp0(jmi_real_t i_v) {
    JMI_DEF(REA, o_v)
...
void func_CCodeGenTests_CArrayInput1_f_def0(jmi_array_t* inp_a, jmi_real_t* out_o) {
    JMI_DYNAMIC_INIT()
    JMI_DEF(REA, out_v)
    out_v = jmi_array_val_1(inp_a, 1.0) + jmi_array_val_1(inp_a, 2.0) + jmi_array_val_1(inp_a, 3.0);
...
jmi_real_t func_CCodeGenTests_CArrayInput1_f_exp0(jmi_array_t* inp_a) {
    ...
    jmi_array_ref_1(tmp_1, 3) = AD_WRAP_LITERAL(3.0);
...
jmi_real_t func_CCodeGenTests_CArrayInput2_f_exp0(jmi_array_t* inp_a) {
    ...
    JMI_ARR(STAT, jmi_real_t, jmi_array_t, tmp_1, 3, 1)
    JMI_ARRAY_INIT_1(STAT, jmi_real_t, jmi_array_t, tmp_1, 3, 1, 3)
    jmi_array_ref_1(tmp_1, 1) = AD_WRAP_LITERAL(1.0) + AD_WRAP_LITERAL(3.0);
    jmi_array_ref_1(tmp_1, 2) = AD_WRAP_LITERAL(2.0) + AD_WRAP_LITERAL(5.0);
    jmi_array_ref_1(tmp_1, 3) = AD_WRAP_LITERAL(3.0) + AD_WRAP_LITERAL(7.0);
    (*res)[0] = 2.0 + 5.0 * func_CCodeGenTests_CArrayInput2_f_exp0(tmp_1) - (_x_0);
")})));
end CArrayInput2;
...
jmi_real_t func_CCodeGenTests_CArrayInput3_f_exp0(jmi_array_t* inp_a) {
    ...
    jmi_array_ref_1(tmp_2, 1) = AD_WRAP_LITERAL(4.0);
    jmi_array_ref_1(tmp_2, 2) = AD_WRAP_LITERAL(5.0);
    jmi_array_ref_1(tmp_2, 3) = AD_WRAP_LITERAL(6.0);
    JMI_ARRAY_INIT_1(STAT, jmi_real_t, jmi_array_t, tmp_3, 3, 1, 3)
    jmi_array_ref_1(tmp_3, 1) = AD_WRAP_LITERAL(7.0);
    jmi_array_ref_1(tmp_3, 2) = AD_WRAP_LITERAL(8.0);
    jmi_array_ref_1(tmp_3, 3) = AD_WRAP_LITERAL(9.0);
...
void func_CCodeGenTests_CArrayInput5_f2_def1(jmi_array_t* inp_a, jmi_real_t* out1_o, jmi_real_t* out2_o) {
    ...
    JMI_DEF(REA, out1_v)
    JMI_DEF(REA, out2_v)
    out1_v = jmi_array_val_1(inp_a, 1.0) + jmi_array_val_1(inp_a, 2.0) + jmi_array_val_1(inp_a, 3.0);
    out2_v = jmi_max(jmi_max(jmi_array_val_1(inp_a, 1.0), jmi_array_val_1(inp_a, 2.0)), jmi_array_val_1(inp_a, 3.0));
...
void func_CCodeGenTests_CArrayInput6_f1_def0(jmi_real_t i_v, jmi_real_t* out_o) {
    ...
    jmi_real_t i1_2ie;
    out_v = 1.0;
    if (COND_EXP_EQ(jmi_max(floor(AD_WRAP_LITERAL(2.0) - (i_v + AD_WRAP_LITERAL(1.0))) + AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(0.0)), AD_WRAP_LITERAL(2.0), JMI_TRUE, JMI_FALSE) == JMI_FALSE) {
        jmi_assert_failed(\"Mismatching sizes in CCodeGenTests.CArrayInput6.f1\", JMI_ASSERT_ERROR);
    }
    JMI_ARRAY_INIT_1(DYNA, jmi_real_t, jmi_array_t, temp_1_a, jmi_max(floor(AD_WRAP_LITERAL(2.0) - (i_v + AD_WRAP_LITERAL(1.0))) + AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(0.0)), 1, jmi_max(floor(AD_WRAP_LITERAL(2.0) - (i_v + AD_WRAP_LITERAL(1.0))) + AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(0.0)))
    i1_0ie = jmi_max(floor(AD_WRAP_LITERAL(2.0) - (i_v + AD_WRAP_LITERAL(1.0))) + AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(0.0)) + 1 / 2.0;
    for (i1_0i = 1.0; i1_0i < i1_0ie; i1_0i += 1) {
        jmi_array_ref_1(temp_1_a, i1_0i) = i_v + 1.0 + (i1_0i - 1.0);
    }
    if (COND_EXP_LT(func_CCodeGenTests_CArrayInput6_f2_exp1(temp_1_a), 4.0, JMI_TRUE, JMI_FALSE)) {
        if (COND_EXP_EQ(jmi_max(floor(AD_WRAP_LITERAL(6.0) - (i_v + AD_WRAP_LITERAL(5.0))) + AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(0.0)), AD_WRAP_LITERAL(2.0), JMI_TRUE, JMI_FALSE) == JMI_FALSE) {
            jmi_assert_failed(\"Mismatching sizes in CCodeGenTests.CArrayInput6.f1\", JMI_ASSERT_ERROR);
        }
        JMI_ARRAY_INIT_1(DYNA, jmi_real_t, jmi_array_t, temp_2_a, jmi_max(floor(AD_WRAP_LITERAL(6.0) - (i_v + AD_WRAP_LITERAL(5.0))) + AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(0.0)), 1, jmi_max(floor(AD_WRAP_LITERAL(6.0) - (i_v + AD_WRAP_LITERAL(5.0))) + AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(0.0)))
        i1_1ie = jmi_max(floor(AD_WRAP_LITERAL(6.0) - (i_v + AD_WRAP_LITERAL(5.0))) + AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(0.0)) + 1 / 2.0;
        for (i1_1i = 1.0; i1_1i < i1_1ie; i1_1i += 1) {
            jmi_array_ref_1(temp_2_a, i1_1i) = i_v + 5.0 + (i1_1i - 1.0);
        }
        out_v = func_CCodeGenTests_CArrayInput6_f2_exp1(temp_2_a);
    } else {
        if (COND_EXP_EQ(jmi_max(floor(AD_WRAP_LITERAL(8.0) - (i_v + AD_WRAP_LITERAL(7.0))) + AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(0.0)), AD_WRAP_LITERAL(2.0), JMI_TRUE, JMI_FALSE) == JMI_FALSE) {
            jmi_assert_failed(\"Mismatching sizes in CCodeGenTests.CArrayInput6.f1\", JMI_ASSERT_ERROR);
        }
        JMI_ARRAY_INIT_1(DYNA, jmi_real_t, jmi_array_t, temp_3_a, jmi_max(floor(AD_WRAP_LITERAL(8.0) - (i_v + AD_WRAP_LITERAL(7.0))) + AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(0.0)), 1, jmi_max(floor(AD_WRAP_LITERAL(8.0) - (i_v + AD_WRAP_LITERAL(7.0))) + AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(0.0)))
        i1_2ie = jmi_max(floor(AD_WRAP_LITERAL(8.0) - (i_v + AD_WRAP_LITERAL(7.0))) + AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(0.0)) + 1 / 2.0;
        for (i1_2i = 1.0; i1_2i < i1_2ie; i1_2i += 1) {
            jmi_array_ref_1(temp_3_a, i1_2i) = i_v + 7.0 + (i1_2i - 1.0);
        }
...
void func_CCodeGenTests_CArrayInput6_f2_def1(jmi_array_t* inp_a, jmi_real_t* out_o) {
    JMI_DYNAMIC_INIT()
    JMI_DEF(REA, out_v)
    out_v = jmi_array_val_1(inp_a, 1.0) + jmi_array_val_1(inp_a, 2.0);
    JMI_RET(GEN, out_o, out_v)
    JMI_DYNAMIC_FREE()
    return;
}
...
void func_CCodeGenTests_CArrayInput7_f1_def0(jmi_real_t* out_o) {
    ...
    jmi_array_ref_1(tmp_1, 2) = AD_WRAP_LITERAL(2.0);
    jmi_array_ref_1(tmp_1, 3) = AD_WRAP_LITERAL(3.0);
    while (COND_EXP_LT(func_CCodeGenTests_CArrayInput7_f2_exp1(tmp_1), 2.0, JMI_TRUE, JMI_FALSE)) {
        JMI_ARRAY_INIT_1(STAT, jmi_real_t, jmi_array_t, tmp_2, 3, 1, 3)
        jmi_array_ref_1(tmp_2, 1) = AD_WRAP_LITERAL(4.0);
        jmi_array_ref_1(tmp_2, 2) = AD_WRAP_LITERAL(5.0);
        jmi_array_ref_1(tmp_2, 3) = AD_WRAP_LITERAL(6.0);
...
void func_CCodeGenTests_CArrayOutputs2_f_def0(jmi_array_t* o_a) {
    ...
    (*res)[2] = _temp_1_1_1 * 3.0 + _temp_1_2_2 * 4.0 - (_x_0);
")})));
end CArrayOutputs2;
...
void func_CCodeGenTests_CArrayOutputs3_f1_def0(jmi_real_t* o_o) {
    ...
    x_v = jmi_array_val_1(temp_1_a, 1) * 3.0 + jmi_array_val_1(temp_1_a, 2) * 4.0;
    JMI_RET(GEN, o_o, o_v)
    JMI_DYNAMIC_FREE()
    return;
}
...
void func_CCodeGenTests_CArrayOutputs5_f2_def1(jmi_array_t* i_a, jmi_array_t* o1_a, jmi_real_t* o2_o) {
    ...
    jmi_array_ref_1(o1_a, 1) = jmi_array_val_1(i_a, 1.0);
    jmi_array_ref_1(o1_a, 2) = jmi_array_val_1(i_a, 2.0);
    o2_v = 3;
    JMI_RET(GEN, o2_o, o2_v)
    JMI_DYNAMIC_FREE()
    return;
...
void func_CCodeGenTests_CUnknownArray2_f_def0(jmi_array_t* x_a, jmi_array_t* y_a) {
    ...
    for (i1_0i = 1.0; i1_0i < i1_0ie; i1_0i += 1) {
        ...
        for (i2_1i = 1.0; i2_1i < i2_1ie; i2_1i += 1) {
            temp_2_v = 0.0;
            i3_2ie = 2.0 + 1 / 2.0;
            for (i3_2i = 1.0; i3_2i < i3_2ie; i3_2i += 1) {
                temp_2_v = temp_2_v + jmi_array_val_2(x_a, i1_0i, i3_2i) * jmi_array_val_2(temp_3_a, i3_2i, i2_1i);
            }
            jmi_array_ref_2(temp_1_a, i1_0i, i2_1i) = temp_2_v;
        }
    }
    i1_3ie = jmi_array_size(x_a, 0) + 1 / 2.0;
    for (i1_3i = 1.0; i1_3i < i1_3ie; i1_3i += 1) {
        i2_4ie = 2.0 + 1 / 2.0;
        for (i2_4i = 1.0; i2_4i < i2_4ie; i2_4i += 1) {
...
void func_CCodeGenTests_CUnknownArray4_fw_def0(jmi_array_t* i_a, jmi_array_t* o_a, jmi_real_t* dummy_o) {
    ...
    dummy_v = 1;
    jmi_array_ref_1(o_a, 1.0) = 1;
    jmi_array_ref_1(o_a, 3.0) = 1;
    jmi_array_ref_1(o_a, 5.0) = 1;
    JMI_ARRAY_INIT_1(DYNA, jmi_real_t, jmi_array_t, temp_1_a, jmi_array_size(i_a, 0), 1, jmi_array_size(i_a, 0))
    i1_0ie = jmi_array_size(i_a, 0) + 1 / 2.0;
    for (i1_0i = 1.0; i1_0i < i1_0ie; i1_0i += 1) {
        jmi_array_ref_1(temp_1_a, i1_0i) = jmi_array_val_1(o_a, jmi_array_val_1(i_a, i1_0i));
    }
    JMI_ARRAY_INIT_1(DYNA, jmi_real_t, jmi_array_t, temp_2_a, jmi_array_size(i_a, 0), 1, jmi_array_size(i_a, 0))
...
void func_CCodeGenTests_CUnknownArray5_f_def0(jmi_array_t* i1_a, jmi_array_t* i2_a, jmi_array_t* x_a, jmi_array_t* y_a) {
    ...
    for (i5_0i = 1.0; i5_0i < i5_0ie; i5_0i += 1) {
        i6_1ie = jmi_array_size(i2_a, 0) + 1 / 2.0;
        for (i6_1i = 1.0; i6_1i < i6_1ie; i6_1i += 1) {
...
void func_CCodeGenTests_CUnknownArray6_f_def0(jmi_array_t* i1_a, jmi_array_t* i2_a, jmi_array_t* x_a, jmi_array_t* y_a) {
    ...
    jmi_real_t i4_5ie;
    if (y_a == NULL) {
        JMI_ARRAY_INIT_2(DYNA, jmi_real_t, jmi_array_t, y_an, (jmi_array_size(i1_a, 0) * 2.0 - 2.0) * jmi_array_size(i1_a, 0), 2, jmi_array_size(i1_a, 0) * 2.0 - 2.0, jmi_array_size(i1_a, 0))
        y_a = y_an;
    }
    JMI_ARRAY_INIT_2(DYNA, jmi_real_t, jmi_array_t, temp_1_a, jmi_array_size(i1_a, 0) * jmi_array_size(i2_a, 0), 2, jmi_array_size(i1_a, 0), jmi_array_size(i2_a, 0))
    JMI_ARRAY_INIT_2(DYNA, jmi_real_t, jmi_array_t, temp_2_a, jmi_array_size(i1_a, 0) * jmi_array_size(i2_a, 0), 2, jmi_array_size(i1_a, 0), jmi_array_size(i2_a, 0))
...
void func_CCodeGenTests_CUnknownArray7_f_def0(jmi_real_t m_v, R1_1_ra* o_a) {
    ...
    i_0ie = m_v + 1 / 2.0;
    for (i_0i = 1.0; i_0i < i_0ie; i_0i += 1) {
        JMI_ARRAY_INIT_1(DYNA, R1_1_r, R1_1_ra, temp_1_a, jmi_max(m_v, AD_WRAP_LITERAL(0.0)), 1, jmi_max(m_v, AD_WRAP_LITERAL(0.0)))
        tmp_3_max = jmi_max(m_v, AD_WRAP_LITERAL(0.0)) + 1;
        ...
        i1_1ie = jmi_max(m_v, AD_WRAP_LITERAL(0.0)) + 1 / 2.0;
        for (i1_1i = 1.0; i1_1i < i1_1ie; i1_1i += 1) {
            jmi_array_ref_1(jmi_array_rec_1(jmi_array_rec_1(temp_1_a, i1_1i)->x, 1)->y, 1) = i_0i * i1_1i;
        }
        i1_2ie = jmi_max(m_v, AD_WRAP_LITERAL(0.0)) + 1 / 2.0;
        for (i1_2i = 1.0; i1_2i < i1_2ie; i1_2i += 1) {
...
void func_CCodeGenTests_CUnknownArray12_f_def0(jmi_real_t i_v, jmi_real_t* y_o) {
    ...
    y_v = jmi_array_val_1(jmi_array_rec_1(c_a, i_v)->a, 1.0);
    JMI_RET(GEN, y_o, y_v)
    JMI_DYNAMIC_FREE()
    return;
}
...
void func_CCodeGenTests_CUnknownArray13_f_def0(jmi_array_t* x_a, jmi_array_t* y_a) {
    ...
    jmi_real_t i1_3ie;
    if (y_a == NULL) {
        JMI_ARRAY_INIT_1(DYNA, jmi_real_t, jmi_array_t, y_an, jmi_array_size(x_a, 0) * 2.0, 1, jmi_array_size(x_a, 0) * 2.0)
        y_a = y_an;
    }
    i_0ie = jmi_array_size(x_a, 0) + 1 / 2.0;
    for (i_0i = 1.0; i_0i < i_0ie; i_0i += 1) {
        JMI_ARRAY_INIT_1(DYNA, jmi_real_t, jmi_array_t, temp_1_a, (jmi_array_size(x_a, 0) + jmi_max(i_0i, AD_WRAP_LITERAL(0.0))), 1, jmi_array_size(x_a, 0) + jmi_max(i_0i, AD_WRAP_LITERAL(0.0)))
        i1_1ie = jmi_array_size(x_a, 0) + 1 / 2.0;
        for (i1_1i = 1.0; i1_1i < i1_1ie; i1_1i += 1) {
            jmi_array_ref_1(temp_1_a, i1_1i) = jmi_array_val_1(x_a, i1_1i);
        }
        i1_2ie = jmi_max(i_0i, AD_WRAP_LITERAL(0.0)) + 1 / 2.0;
        for (i1_2i = 1.0; i1_2i < i1_2ie; i1_2i += 1) {
            jmi_array_ref_1(temp_1_a, i1_2i + jmi_array_size(x_a, 0)) = i1_2i;
        }
        i1_3ie = jmi_array_size(x_a, 0) + jmi_max(i_0i, AD_WRAP_LITERAL(0.0)) + 1 / 2.0;
        for (i1_3i = 1.0; i1_3i < i1_3ie; i1_3i += 1) {
...
void func_CCodeGenTests_CRecordDecl8_f_def0(jmi_real_t* o_o) {
    ...
    o_v = jmi_array_rec_1(jmi_array_rec_1(x_a, 1.0)->b, 2.0)->c;
    JMI_RET(GEN, o_o, o_v)
    JMI_DYNAMIC_FREE()
    return;
}
...
jmi_real_t func_CCodeGenTests_CRecordDecl13_f_exp0(A_0_r* x_v) {
    ...
    JMI_RECORD_STATIC(A_0_r, tmp_1)
    tmp_1->a = AD_WRAP_LITERAL(1.0);
    tmp_1->b = AD_WRAP_LITERAL(2.0);
...
jmi_real_t func_CCodeGenTests_CRecordDecl15_f_exp0(A_0_r* x_v) {
    ...
    JMI_ARRAY_INIT_1(STAT, jmi_real_t, jmi_array_t, tmp_2, 2, 1, 2)
    tmp_1->a = tmp_2;
    jmi_array_ref_1(tmp_1->a, 1) = AD_WRAP_LITERAL(1.0);
    jmi_array_ref_1(tmp_1->a, 2) = AD_WRAP_LITERAL(2.0);
...
void func_CCodeGenTests_CRecordDecl16_f_def0(A_1_ra* x_a, jmi_real_t* o_o) {
    ...
    i1_0ie = 3.0 + 1 / 2.0;
    for (i1_0i = 1.0; i1_0i < i1_0ie; i1_0i += 1) {
        if (COND_EXP_EQ(AD_WRAP_LITERAL(2.0), jmi_array_size(jmi_array_rec_1(x_a, i1_0i)->b, 0), JMI_TRUE, JMI_FALSE) == JMI_FALSE) {
...
jmi_real_t func_CCodeGenTests_CRecordDecl16_f_exp0(A_1_ra* x_a) {
    ...
    JMI_ARRAY_INIT_1(STAT, B_0_r, B_0_ra, tmp_4, 2, 1, 2)
    jmi_array_rec_1(tmp_1, 3)->b = tmp_4;
    jmi_array_rec_1(tmp_1, 1)->a = AD_WRAP_LITERAL(1.0);
    jmi_array_rec_1(jmi_array_rec_1(tmp_1, 1)->b, 1)->c = AD_WRAP_LITERAL(2.0);
    jmi_array_rec_1(jmi_array_rec_1(tmp_1, 1)->b, 2)->c = AD_WRAP_LITERAL(3.0);
    jmi_array_rec_1(tmp_1, 2)->a = AD_WRAP_LITERAL(4.0);
    jmi_array_rec_1(jmi_array_rec_1(tmp_1, 2)->b, 1)->c = AD_WRAP_LITERAL(5.0);
    jmi_array_rec_1(jmi_array_rec_1(tmp_1, 2)->b, 2)->c = AD_WRAP_LITERAL(6.0);
    jmi_array_rec_1(tmp_1, 3)->a = AD_WRAP_LITERAL(7.0);
    jmi_array_rec_1(jmi_array_rec_1(tmp_1, 3)->b, 1)->c = AD_WRAP_LITERAL(8.0);
    jmi_array_rec_1(jmi_array_rec_1(tmp_1, 3)->b, 2)->c = AD_WRAP_LITERAL(9.0);
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    JMI_RECORD_STATIC(R_0_r, tmp_1)
    tmp_1->x1 = _time;
    tmp_1->y = AD_WRAP_LITERAL(2.0);
    tmp_1->z = AD_WRAP_LITERAL(3.0);
    tmp_1->x2 = _time;
...
annotation(__JModelica(UnitTesting(tests={
    CCodeGenTestCase(
        ...
        template="$C_DAE_initial_dependent_parameter_residuals$",
        generatedCode="
    (*res)[0] = COND_EXP_EQ(COND_EXP_LE(AD_WRAP_LITERAL(1.0), _N_0, JMI_TRUE, JMI_FALSE), JMI_TRUE, AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(2.0)) - (_r_1_1);
    (*res)[1] = COND_EXP_EQ(COND_EXP_LE(AD_WRAP_LITERAL(2.0), _N_0, JMI_TRUE, JMI_FALSE), JMI_TRUE, AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(2.0)) - (_r_2_2);
    (*res)[2] = COND_EXP_EQ(COND_EXP_LE(AD_WRAP_LITERAL(3.0), _N_0, JMI_TRUE, JMI_FALSE), JMI_TRUE, AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(2.0)) - (_r_3_3);
")})));
end IfExpInParExp;
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    JMI_DYNAMIC_INIT()
    if (jmi->atInitial || jmi->atEvent) {
        _sw(3) = jmi_turn_switch(jmi, _time - (1.0), _sw(3), JMI_REL_GT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(4) = jmi_turn_switch(jmi, _time - (1.1), _sw(4), JMI_REL_LT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(5) = jmi_turn_switch(jmi, _time - (2.0), _sw(5), JMI_REL_GT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(6) = jmi_turn_switch(jmi, _time - (2.1), _sw(6), JMI_REL_LT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(7) = jmi_turn_switch(jmi, _time - (3.0), _sw(7), JMI_REL_GT);
    }
    if (jmi->atInitial || jmi->atEvent) {
...
int model_ode_initialize_base(jmi_t* jmi) {
    ...
    pre_z_5 = JMI_TRUE;
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(jmi, _y_2 - (2.0), _sw(0), JMI_REL_GT);
    }
    _temp_1_6 = LOG_EXP_AND(_sw(0), pre_z_5);
    _z_5 = pre_z_5;
    if (jmi->atInitial || jmi->atEvent) {
        _sw(1) = jmi_turn_switch(jmi, _y_2 - (2.0), _sw(1), JMI_REL_GT);
    }
    _temp_2_7 = LOG_EXP_AND(_sw(1), _z_5);
    if (jmi->atInitial || jmi->atEvent) {
        _sw(2) = jmi_turn_switch(jmi, _x_1 - (2.0), _sw(2), JMI_REL_GT);
    }
    _temp_3_8 = _sw(2);
    if (jmi->atInitial || jmi->atEvent) {
        _sw(3) = jmi_turn_switch(jmi, _time - (1.0), _sw(3), JMI_REL_GT);
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    int ef = 0;
    JMI_DYNAMIC_INIT()
    (*res)[0] = COND_EXP_EQ(pre_z_5, JMI_TRUE, _y_2 - (2.0), AD_WRAP_LITERAL(1));
    (*res)[1] = COND_EXP_EQ(_z_5, JMI_TRUE, _y_2 - (2.0), AD_WRAP_LITERAL(1));
    (*res)[2] = _x_1 - (2.0);
    (*res)[3] = _time - (1.0);
    (*res)[4] = COND_EXP_EQ(_sw(3), JMI_TRUE, _time - (1.1), AD_WRAP_LITERAL(1));
    (*res)[5] = COND_EXP_EQ(LOG_EXP_NOT(LOG_EXP_AND(_sw(3), _sw(4))), JMI_TRUE, _time - (2.0), AD_WRAP_LITERAL(1));
    (*res)[6] = COND_EXP_EQ(LOG_EXP_AND(LOG_EXP_NOT(LOG_EXP_AND(_sw(3), _sw(4))), _sw(5)), JMI_TRUE, _time - (2.1), AD_WRAP_LITERAL(1));
    (*res)[7] = COND_EXP_EQ(LOG_EXP_NOT(LOG_EXP_OR(LOG_EXP_AND(_sw(3), _sw(4)), LOG_EXP_AND(_sw(5), _sw(6)))), JMI_TRUE, _time - (3.0), AD_WRAP_LITERAL(1));
...
",
        generatedCode="
                       ...
                       jmi_real_t nSamp;
    if (SURELY_LT_ZERO(_time - (AD_WRAP_LITERAL(1.0)))) {
        jmi_min_time_event(nextTimeEvent, 1, 0, AD_WRAP_LITERAL(1.0));
    }
    ...
    if (SURELY_LT_ZERO(_time - ((pre__sampleItr_1_8 + AD_WRAP_LITERAL(1.0)) * _h_6))) {
        jmi_min_time_event(nextTimeEvent, 1, 0, (pre__sampleItr_1_8 + AD_WRAP_LITERAL(1.0)) * _h_6);
    }
")})));
end WhenTest2; 
...
",
        generatedCode="
    jmi_real_t nSamp;
    if (SURELY_LT_ZERO(COND_EXP_EQ(LOG_EXP_NOT(_atInitial), JMI_TRUE, _time - (pre__sampleItr_1_4 * jmi_divide_equation(jmi, 2.0, 3.0, \"(2 / 3)\")), AD_WRAP_LITERAL(1)))) {
        jmi_min_time_event(nextTimeEvent, 1, 0, pre__sampleItr_1_4 * jmi_divide_equation(jmi, 2.0, 3.0, \"(2 / 3)\"));
    }
    if (SURELY_LT_ZERO(_time - ((pre__sampleItr_1_4 + AD_WRAP_LITERAL(1.0)) * jmi_divide_equation(jmi, AD_WRAP_LITERAL(2.0), AD_WRAP_LITERAL(3.0), \"(2 / 3)\")))) {
        jmi_min_time_event(nextTimeEvent, 1, 0, (pre__sampleItr_1_4 + AD_WRAP_LITERAL(1.0)) * jmi_divide_equation(jmi, AD_WRAP_LITERAL(2.0), AD_WRAP_LITERAL(3.0), \"(2 / 3)\"));
    }
    if (SURELY_LT_ZERO(COND_EXP_EQ(LOG_EXP_NOT(_atInitial), JMI_TRUE, _time - (pre__sampleItr_2_6 * jmi_divide_equation(jmi, 1.0, 3.0, \"(1 / 3)\")), AD_WRAP_LITERAL(1)))) {
        jmi_min_time_event(nextTimeEvent, 1, 0, pre__sampleItr_2_6 * jmi_divide_equation(jmi, 1.0, 3.0, \"(1 / 3)\"));
    }
    if (SURELY_LT_ZERO(_time - ((pre__sampleItr_2_6 + AD_WRAP_LITERAL(1.0)) * jmi_divide_equation(jmi, AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(3.0), \"(1 / 3)\")))) {
        jmi_min_time_event(nextTimeEvent, 1, 0, (pre__sampleItr_2_6 + AD_WRAP_LITERAL(1.0)) * jmi_divide_equation(jmi, AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(3.0), \"(1 / 3)\"));
    }
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    _der_dummy_13 = 0;
    if (jmi->atInitial || jmi->atEvent) {
        _sw(3) = jmi_turn_switch_time(jmi, _time - ((pre__sampleItr_2_6 + AD_WRAP_LITERAL(1.0)) * jmi_divide_equation(jmi, AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(3.0), \"(1 / 3)\")), _sw(3), JMI_REL_LT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(2) = jmi_turn_switch_time(jmi, _time - (pre__sampleItr_2_6 * jmi_divide_equation(jmi, 1.0, 3.0, \"(1 / 3)\")), _sw(2), JMI_REL_GEQ);
    }
    ef |= jmi_solve_block_residual(jmi->dae_block_residuals[0]);
    if (jmi->atInitial || jmi->atEvent) {
        _sw(1) = jmi_turn_switch_time(jmi, _time - ((pre__sampleItr_1_4 + AD_WRAP_LITERAL(1.0)) * jmi_divide_equation(jmi, AD_WRAP_LITERAL(2.0), AD_WRAP_LITERAL(3.0), \"(2 / 3)\")), _sw(1), JMI_REL_LT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch_time(jmi, _time - (pre__sampleItr_1_4 * jmi_divide_equation(jmi, 2.0, 3.0, \"(2 / 3)\")), _sw(0), JMI_REL_GEQ);
    }
...
int model_ode_initialize_base(jmi_t* jmi) {
    ...
    _der_dummy_13 = 0;
    if (jmi->atInitial || jmi->atEvent) {
        _sw_init(0) = jmi_turn_switch_time(jmi, _time - (AD_WRAP_LITERAL(0.0)), _sw_init(0), JMI_REL_LT);
    }
    __sampleItr_1_4 = COND_EXP_EQ(_sw_init(0), JMI_TRUE, AD_WRAP_LITERAL(0.0), ceil(jmi_divide_equation(jmi, _time, jmi_divide_equation(jmi, AD_WRAP_LITERAL(2.0), AD_WRAP_LITERAL(3.0), \"(2 / 3)\"), \"time / (2 / 3)\")));
    ...
    __sampleItr_2_6 = COND_EXP_EQ(_sw_init(0), JMI_TRUE, AD_WRAP_LITERAL(0.0), ceil(jmi_divide_equation(jmi, _time, jmi_divide_equation(jmi, AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(3.0), \"(1 / 3)\"), \"time / (1 / 3)\")));
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_SOLVED_REAL_VALUE_REFERENCE) {
        ...
        _x_0 = COND_EXP_EQ(LOG_EXP_AND(_temp_2_5, LOG_EXP_NOT(pre_temp_2_5)), JMI_TRUE, pre_x_0 + AD_WRAP_LITERAL(1.0), pre_x_0);
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            __sampleItr_2_6 = COND_EXP_EQ(LOG_EXP_AND(_temp_2_5, LOG_EXP_NOT(pre_temp_2_5)), JMI_TRUE, pre__sampleItr_2_6 + AD_WRAP_LITERAL(1.0), pre__sampleItr_2_6);
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
        }
    }
...
static int dae_block_1(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_SOLVED_REAL_VALUE_REFERENCE) {
        ...
        _y_1 = COND_EXP_EQ(LOG_EXP_AND(_temp_1_3, LOG_EXP_NOT(pre_temp_1_3)), JMI_TRUE, pre_y_1 + AD_WRAP_LITERAL(1.0), pre_y_1);
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            __sampleItr_1_4 = COND_EXP_EQ(LOG_EXP_AND(_temp_1_3, LOG_EXP_NOT(pre_temp_1_3)), JMI_TRUE, pre__sampleItr_1_4 + AD_WRAP_LITERAL(1.0), pre__sampleItr_1_4);
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
        }
    }
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    JMI_DYNAMIC_INIT()
    if (jmi->atInitial || jmi->atEvent) {
        _sw(1) = jmi_turn_switch_time(jmi, _time - ((pre__sampleItr_1_12 + AD_WRAP_LITERAL(1.0)) * _h_11), _sw(1), JMI_REL_LT);
    }
    if (jmi->atInitial || jmi->atEvent) {
...
int model_ode_initialize_base(jmi_t* jmi) {
    ...
    __sampleItr_1_12 = COND_EXP_EQ(_sw_init(0), JMI_TRUE, AD_WRAP_LITERAL(0.0), ceil(jmi_divide_equation(jmi, _time, _h_11, \"time / h\")));
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_SOLVED_REAL_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            __sampleItr_1_12 = COND_EXP_EQ(LOG_EXP_AND(_sampleTrigger_0, LOG_EXP_NOT(pre_sampleTrigger_0)), JMI_TRUE, pre__sampleItr_1_12 + AD_WRAP_LITERAL(1.0), pre__sampleItr_1_12);
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
        }
    }
...
static int dae_init_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        (*res)[0] = 1.0;
        (*res)[1] = jmi_max(AD_WRAP_LITERAL(1.0), jmi_max(jmi_abs(_a_c_8), jmi_abs(_b_c_9)));
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_SOLVED_REAL_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            _sw(1) = jmi_turn_switch_time(jmi, _time - ((pre__sampleItr_1_13 + AD_WRAP_LITERAL(1.0)) * _h_11), _sw(1), JMI_REL_LT);
        }
        if (_sw(1) == JMI_FALSE) {
            jmi_assert_failed(\"Too long time steps relative to sample interval.\", JMI_ASSERT_ERROR);
        }
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            __sampleItr_1_13 = COND_EXP_EQ(LOG_EXP_AND(_sampleTrigger_0, LOG_EXP_NOT(pre_sampleTrigger_0)), JMI_TRUE, pre__sampleItr_1_13 + AD_WRAP_LITERAL(1.0), pre__sampleItr_1_13);
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
        }
    }
...
int model_ode_initialize_base(jmi_t* jmi) {
    ...
    __sampleItr_1_13 = COND_EXP_EQ(_sw_init(0), JMI_TRUE, AD_WRAP_LITERAL(0.0), ceil(jmi_divide_equation(jmi, _time, _h_11, \"time / h\")));
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            _sw(1) = jmi_turn_switch_time(jmi, _time - (pre__sampleItr_1_3 + AD_WRAP_LITERAL(1.0)), _sw(1), JMI_REL_LT);
        }
        if (_sw(1) == JMI_FALSE) {
            jmi_assert_failed(\"Too long time steps relative to sample interval.\", JMI_ASSERT_ERROR);
        }
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            __sampleItr_1_3 = COND_EXP_EQ(LOG_EXP_AND(_temp_1_2, LOG_EXP_NOT(pre_temp_1_2)), JMI_TRUE, pre__sampleItr_1_3 + AD_WRAP_LITERAL(1.0), pre__sampleItr_1_3);
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            if (LOG_EXP_AND(_temp_1_2, LOG_EXP_NOT(pre_temp_1_2))) {
                (*res)[0] = tmp_1 - (_x_0);
...
int model_ode_initialize_base(jmi_t* jmi) {
    ...
    __sampleItr_1_3 = COND_EXP_EQ(_sw_init(0), JMI_TRUE, AD_WRAP_LITERAL(0.0), ceil(_time));
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    JMI_DYNAMIC_INIT()
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(jmi, _time - (3.0), _sw(0), JMI_REL_GT);
    }
    ef |= jmi_solve_block_residual(jmi->dae_block_residuals[0]);
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(jmi, _time - (3.0), _sw(0), JMI_REL_GT);
...
static int dae_block_1(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = COND_EXP_EQ(LOG_EXP_AND(_temp_1_6, LOG_EXP_NOT(pre_temp_1_6)), JMI_TRUE, sin(_x_0) + AD_WRAP_LITERAL(3.0), pre_x_0) - (_x_0);
        }
    }
    JMI_DYNAMIC_FREE()
    return ef;
...
static int dae_block_2(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        residual[0] = 1.0;
        residual[1] = 1.0;
        residual[2] = - COND_EXP_EQ(LOG_EXP_AND(_temp_2_7, LOG_EXP_NOT(pre_temp_2_7)), JMI_TRUE, AD_WRAP_LITERAL(-2.0), AD_WRAP_LITERAL(0.0));
        residual[3] = 1.0;
    } else if (evaluation_mode & JMI_BLOCK_EVALUATE || evaluation_mode & JMI_BLOCK_WRITE_BACK) {
        if ((evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) == 0) {
            _y1_1 = x[0];
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = COND_EXP_EQ(LOG_EXP_AND(_temp_2_7, LOG_EXP_NOT(pre_temp_2_7)), JMI_TRUE, AD_WRAP_LITERAL(7.0) - AD_WRAP_LITERAL(2.0) * _y2_2, pre_y1_1) - (_y1_1);
            (*res)[1] = 5 - (_y1_1 + _y2_2);
        }
    }
    JMI_DYNAMIC_FREE()
...
static int dae_block_3(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        residual[4] = 1.0;
        residual[5] = 1.0;
        residual[6] = - COND_EXP_EQ(LOG_EXP_AND(_temp_3_8, LOG_EXP_NOT(pre_temp_3_8)), JMI_TRUE, AD_WRAP_LITERAL(-2.0), AD_WRAP_LITERAL(0.0));
        residual[7] = - COND_EXP_EQ(LOG_EXP_AND(_temp_3_8, LOG_EXP_NOT(pre_temp_3_8)), JMI_TRUE, AD_WRAP_LITERAL(-2.0), AD_WRAP_LITERAL(0.0));
        residual[8] = 1.0;
    } else if (evaluation_mode & JMI_BLOCK_EVALUATE || evaluation_mode & JMI_BLOCK_WRITE_BACK) {
        if ((evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) == 0) {
            _z3_5 = x[0];
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = COND_EXP_EQ(LOG_EXP_AND(_temp_3_8, LOG_EXP_NOT(pre_temp_3_8)), JMI_TRUE, AD_WRAP_LITERAL(7.0) - AD_WRAP_LITERAL(2.0) * _z2_4, pre_z3_5) - (_z3_5);
            (*res)[1] = COND_EXP_EQ(LOG_EXP_AND(_temp_3_8, LOG_EXP_NOT(pre_temp_3_8)), JMI_TRUE, AD_WRAP_LITERAL(7.0) - AD_WRAP_LITERAL(2.0) * _z2_4, pre_z1_3) - (_z1_3);
...
int model_ode_initialize_base(jmi_t* jmi) {
    ...
    _der_x_5 = 1;
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch_time(jmi, _time - (4.0), _sw(0), jmi->eventPhase ? (JMI_REL_GEQ) : (JMI_REL_GT));
    }
    _temp_1_1 = _sw(0);
    if (jmi->atInitial || jmi->atEvent) {
...
int model_ode_initialize_base(jmi_t* jmi) {
    ...
    _x_0 = 0.0;
    if (jmi->atInitial || jmi->atEvent) {
        _sw(1) = jmi_turn_switch_time(jmi, _time - (AD_WRAP_LITERAL(1.0)), _sw(1), JMI_REL_LT);
    }
    _y_1 = COND_EXP_EQ(_sw(1), JMI_TRUE, _x_0 + AD_WRAP_LITERAL(1.0), _x_0 - AD_WRAP_LITERAL(1.0));
    pre_temp_1_2 = JMI_FALSE;
    if (jmi->atInitial || jmi->atEvent) {
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    JMI_DEF(REA, tmp_6)
    if (_sw(0)) {
        func_CCodeGenTests_dummyFunc_def0(jmi_divide_equation(jmi, _time * _time * _time, AD_WRAP_LITERAL(2.0), \"time * time * time / 2\"), &tmp_1, &tmp_2);
        _x_0 = (tmp_1);
        _y_1 = (tmp_2);
    } else {
        if (_sw(1)) {
...
int model_ode_initialize_base(jmi_t* jmi) {
    ...
    _temp_1_2 = _sw(0);
    if (_sw_init(0)) {
        func_CCodeGenTests_dummyFunc_def0(AD_WRAP_LITERAL(1.0), &tmp_1, NULL);
        _x_0 = (tmp_1);
    } else {
        func_CCodeGenTests_dummyFunc_def0(AD_WRAP_LITERAL(2.0), &tmp_2, NULL);
        _x_0 = (tmp_2);
    }
    pre_x_0 = _x_0;
    pre_temp_1_2 = JMI_FALSE;
...
int model_init_eval_parameters_base(jmi_t* jmi) {
    ...
    if (COND_EXP_GT(_x_1_0, 0.0, JMI_TRUE, JMI_FALSE)) {
    ...
    _y_1_2 = (COND_EXP_EQ(COND_EXP_GT(_x_1_0, AD_WRAP_LITERAL(0.0), JMI_TRUE, JMI_FALSE), JMI_TRUE, _temp_2_1_1, AD_WRAP_LITERAL(0.0)));
    JMI_DYNAMIC_FREE()
    return ef;
}
")})));
...
static int dae_block_1(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = 5 - (3.0 * _z2_1_3 + 4.0 * _z2_2_4);
            (*res)[1] = 4 - (_z2_1_3 + 2.0 * _z2_2_4);
        }
    }
    JMI_DYNAMIC_FREE()
    return ef;
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        (*res)[0] = 1.0;
        (*res)[1] = 1.0;
        (*res)[2] = jmi_max(AD_WRAP_LITERAL(1.0), jmi_max(jmi_max(jmi_abs(_f0_1), jmi_abs(_f1_2)), jmi_max(jmi_max(jmi_abs(_f0_1), jmi_abs(_f1_2)), jmi_abs(_f0_1))));
        (*res)[3] = jmi_max(jmi_abs(_m_0), jmi_max(AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(1.0)));
    } else if (evaluation_mode == JMI_BLOCK_INITIALIZE) {
        x[0] = _a_4;
        x[1] = _sa_7;
        x[2] = _f_5;
        ...
        residual[0] = -1.0;
        residual[1] = 1.0;
        residual[5] = - COND_EXP_EQ(LOG_EXP_OR(COND_EXP_EQ(pre_mode_10, AD_WRAP_LITERAL(1.0), JMI_TRUE, JMI_FALSE), _startFor_8), JMI_TRUE, AD_WRAP_LITERAL(1.0), COND_EXP_EQ(LOG_EXP_OR(COND_EXP_EQ(pre_mode_10, AD_WRAP_LITERAL(3.0), JMI_TRUE, JMI_FALSE), _startBack_9), JMI_TRUE, AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(0.0)));
        residual[6] = - COND_EXP_EQ(LOG_EXP_OR(COND_EXP_EQ(pre_mode_10, AD_WRAP_LITERAL(1.0), JMI_TRUE, JMI_FALSE), _startFor_8), JMI_TRUE, AD_WRAP_LITERAL(0.0), COND_EXP_EQ(LOG_EXP_OR(COND_EXP_EQ(pre_mode_10, AD_WRAP_LITERAL(3.0), JMI_TRUE, JMI_FALSE), _startBack_9), JMI_TRUE, AD_WRAP_LITERAL(0.0), _f0_1));
        residual[10] = 1.0;
        residual[11] = 1.0;
        residual[12] = 1.0;
        residual[15] = _m_0;
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
                _sw(0) = jmi_turn_switch(jmi, _sa_7 - (1.0), _sw(0), JMI_REL_GT);
            }
            _startFor_8 = LOG_EXP_AND(COND_EXP_EQ(pre_mode_10, 2.0, JMI_TRUE, JMI_FALSE), _sw(0));
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
                _sw(1) = jmi_turn_switch(jmi, _sa_7 - (-1.0), _sw(1), JMI_REL_LT);
            }
            _startBack_9 = LOG_EXP_AND(COND_EXP_EQ(pre_mode_10, 2.0, JMI_TRUE, JMI_FALSE), _sw(1));
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
                _sw(2) = jmi_turn_switch(jmi, _v_3 - (AD_WRAP_LITERAL(0.0)), _sw(2), JMI_REL_GT);
            }
            if (LOG_EXP_AND(LOG_EXP_OR(COND_EXP_EQ(pre_mode_10, AD_WRAP_LITERAL(1.0), JMI_TRUE, JMI_FALSE), _startFor_8), _sw(2))) {
            } else {
                if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
                    _sw(3) = jmi_turn_switch(jmi, _v_3 - (AD_WRAP_LITERAL(0.0)), _sw(3), JMI_REL_LT);
                }
            }
            _mode_10 = COND_EXP_EQ(LOG_EXP_AND(LOG_EXP_OR(COND_EXP_EQ(pre_mode_10, AD_WRAP_LITERAL(1.0), JMI_TRUE, JMI_FALSE), _startFor_8), _sw(2)), JMI_TRUE, AD_WRAP_LITERAL(1.0), COND_EXP_EQ(LOG_EXP_AND(LOG_EXP_OR(COND_EXP_EQ(pre_mode_10, AD_WRAP_LITERAL(3.0), JMI_TRUE, JMI_FALSE), _startBack_9), _sw(3)), JMI_TRUE, AD_WRAP_LITERAL(3.0), AD_WRAP_LITERAL(2.0)));
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = _a_4 + 1.0 - (_der_v_16);
            (*res)[1] = COND_EXP_EQ(LOG_EXP_OR(COND_EXP_EQ(pre_mode_10, AD_WRAP_LITERAL(1.0), JMI_TRUE, JMI_FALSE), _startFor_8), JMI_TRUE, _sa_7 - AD_WRAP_LITERAL(1.0), COND_EXP_EQ(LOG_EXP_OR(COND_EXP_EQ(pre_mode_10, AD_WRAP_LITERAL(3.0), JMI_TRUE, JMI_FALSE), _startBack_9), JMI_TRUE, _sa_7 + AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(0.0))) - (_a_4);
            (*res)[2] = COND_EXP_EQ(LOG_EXP_OR(COND_EXP_EQ(pre_mode_10, AD_WRAP_LITERAL(1.0), JMI_TRUE, JMI_FALSE), _startFor_8), JMI_TRUE, _f0_1 + _f1_2 * _v_3, COND_EXP_EQ(LOG_EXP_OR(COND_EXP_EQ(pre_mode_10, AD_WRAP_LITERAL(3.0), JMI_TRUE, JMI_FALSE), _startBack_9), JMI_TRUE, - _f0_1 + _f1_2 * _v_3, _f0_1 * _sa_7)) - (_f_5);
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_NOMINAL) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = _x_2_2 + -4.0 * _y_3 + 2.0 - (0);
            (*res)[1] = -5.0 * _y_3 + 5.0 - (_x_1_1);
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_NOMINAL) {
        ...
        x[1] = - func_CCodeGenTests_BlockTest6_f1_exp1(AD_WRAP_LITERAL(2.0));
    } else if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        x[0] = 4;
        x[1] = 5;
        x[2] = 3;
...
static int dae_block_1(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = 4 - (3.0 * _x_1_4 + 4.0 * _x_2_5);
            (*res)[1] = 3 - (_x_1_4 + 2.0 * _x_2_5);
        }
    }
    JMI_DYNAMIC_FREE()
    return ef;
...
static int dae_block_2(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        (*res)[0] = jmi_max(jmi_max(jmi_abs(_p_12) * jmi_abs(_A_2_1_2), jmi_abs(_p_12) * jmi_abs(_A_2_2_3)), AD_WRAP_LITERAL(1.0));
        (*res)[1] = jmi_max(jmi_max(jmi_abs(_p_12) * jmi_abs(_A_1_1_0), jmi_abs(_p_12) * jmi_abs(_A_1_2_1)), AD_WRAP_LITERAL(1.0));
    } else if (evaluation_mode == JMI_BLOCK_INITIALIZE) {
        x[0] = _y_2_7;
        x[1] = _y_1_6;
    } else if (evaluation_mode == JMI_BLOCK_EVALUATE_JACOBIAN) {
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_SOLVED_REAL_VALUE_REFERENCE) {
        ...
        _d_13 = COND_EXP_EQ(LOG_EXP_AND(_temp_1_14, LOG_EXP_NOT(pre_temp_1_14)), JMI_TRUE, pre_d_13 + AD_WRAP_LITERAL(1.0), pre_d_13);
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
        }
    }
    JMI_DYNAMIC_FREE()
...
static int dae_block_3(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        (*res)[0] = jmi_max(jmi_max(jmi_max(AD_WRAP_LITERAL(1.0), jmi_abs(AD_WRAP_LITERAL(1.0))) * jmi_abs(_A_2_1_2), jmi_max(AD_WRAP_LITERAL(1.0), jmi_abs(AD_WRAP_LITERAL(1.0))) * jmi_abs(_A_2_2_3)), jmi_max(AD_WRAP_LITERAL(1.0), jmi_abs(AD_WRAP_LITERAL(2.0))));
        (*res)[1] = jmi_max(jmi_max(jmi_max(AD_WRAP_LITERAL(1.0), jmi_abs(AD_WRAP_LITERAL(1.0))) * jmi_abs(_A_1_1_0), jmi_max(AD_WRAP_LITERAL(1.0), jmi_abs(AD_WRAP_LITERAL(1.0))) * jmi_abs(_A_1_2_1)), jmi_max(AD_WRAP_LITERAL(1.0), jmi_abs(AD_WRAP_LITERAL(2.0))));
    } else if (evaluation_mode == JMI_BLOCK_INITIALIZE) {
        x[0] = _z_2_9;
        x[1] = _z_1_8;
    } else if (evaluation_mode == JMI_BLOCK_EVALUATE_JACOBIAN) {
        memset(residual, 0, 4 * sizeof(jmi_real_t));
        residual[0] = (_d_13 + 1.0) * _A_2_2_3 - 1.0;
        residual[1] = (_d_13 + 1.0) * _A_1_2_1;
        residual[2] = (_d_13 + 1.0) * _A_2_1_2;
        residual[3] = (_d_13 + 1.0) * _A_1_1_0 - 1.0;
    } else if (evaluation_mode & JMI_BLOCK_EVALUATE || evaluation_mode & JMI_BLOCK_WRITE_BACK) {
        if ((evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) == 0) {
            _z_2_9 = x[0];
            _z_1_8 = x[1];
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = _z_2_9 + 2.0 - ((_d_13 + 1.0) * _A_2_1_2 * _z_1_8 + (_d_13 + 1.0) * _A_2_2_3 * _z_2_9);
            (*res)[1] = _z_1_8 + 2.0 - ((_d_13 + 1.0) * _A_1_1_0 * _z_1_8 + (_d_13 + 1.0) * _A_1_2_1 * _z_2_9);
        }
    }
    JMI_DYNAMIC_FREE()
    return ef;
...
static int dae_block_4(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        (*res)[0] = jmi_max(jmi_max(jmi_max(AD_WRAP_LITERAL(1.0), jmi_abs(AD_WRAP_LITERAL(1.0))) * jmi_abs(_A_2_1_2), jmi_max(AD_WRAP_LITERAL(1.0), jmi_abs(AD_WRAP_LITERAL(1.0))) * jmi_abs(_A_2_2_3)), jmi_max(AD_WRAP_LITERAL(1.0), jmi_abs(AD_WRAP_LITERAL(3.0))));
        (*res)[1] = jmi_max(jmi_max(jmi_max(AD_WRAP_LITERAL(1.0), jmi_abs(AD_WRAP_LITERAL(1.0))) * jmi_abs(_A_1_1_0), jmi_max(AD_WRAP_LITERAL(1.0), jmi_abs(AD_WRAP_LITERAL(1.0))) * jmi_abs(_A_1_2_1)), jmi_max(AD_WRAP_LITERAL(1.0), jmi_abs(AD_WRAP_LITERAL(3.0))));
    } else if (evaluation_mode == JMI_BLOCK_INITIALIZE) {
        x[0] = _w_2_11;
        x[1] = _w_1_10;
    } else if (evaluation_mode == JMI_BLOCK_EVALUATE_JACOBIAN) {
        memset(residual, 0, 4 * sizeof(jmi_real_t));
        residual[0] = (_x_1_4 + 1.0) * _A_2_2_3 - 1.0;
        residual[1] = (_x_1_4 + 1.0) * _A_1_2_1;
        residual[2] = (_x_1_4 + 1.0) * _A_2_1_2;
        residual[3] = (_x_1_4 + 1.0) * _A_1_1_0 - 1.0;
    } else if (evaluation_mode & JMI_BLOCK_EVALUATE || evaluation_mode & JMI_BLOCK_WRITE_BACK) {
        if ((evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) == 0) {
            _w_2_11 = x[0];
            _w_1_10 = x[1];
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = _w_2_11 + 3.0 - ((_x_1_4 + 1.0) * _A_2_1_2 * _w_1_10 + (_x_1_4 + 1.0) * _A_2_2_3 * _w_2_11);
            (*res)[1] = _w_1_10 + 3.0 - ((_x_1_4 + 1.0) * _A_1_1_0 * _w_1_10 + (_x_1_4 + 1.0) * _A_1_2_1 * _w_2_11);
        }
    }
    JMI_DYNAMIC_FREE()
    return ef;
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
                _sw(0) = jmi_turn_switch(jmi, _b_1 - (0.0), _sw(0), JMI_REL_LT);
            }
            _d_2 = _sw(0);
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = sin(_b_1) * COND_EXP_EQ(_d_2, JMI_TRUE, AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(2.0)) - (_a_0);
            (*res)[1] = 1.0 - _b_1 - (_a_0);
        }
    }
    JMI_DYNAMIC_FREE()
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        residual[0] = - COND_EXP_EQ(_b_1, JMI_TRUE, func_CCodeGenTests_BlockTest10_F_exp0(tmp_2), AD_WRAP_LITERAL(0.0));
    } else if (evaluation_mode & JMI_BLOCK_EVALUATE || evaluation_mode & JMI_BLOCK_WRITE_BACK) {
        if ((evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) == 0) {
            _x_0 = x[0];
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
                _sw(0) = jmi_turn_switch(jmi, _x_0 - (0.0), _sw(0), JMI_REL_GT);
            }
            _b_1 = _sw(0);
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            ...
            (*res)[0] = COND_EXP_EQ(_b_1, JMI_TRUE, _x_0 * func_CCodeGenTests_BlockTest10_F_exp0(tmp_1), AD_WRAP_LITERAL(-1.0)) - (0);
        }
    }
    JMI_DYNAMIC_FREE()
    return ef;
...
static int dae_init_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        residual[0] = - COND_EXP_EQ(_b_1, JMI_TRUE, func_CCodeGenTests_BlockTest10_F_exp0(tmp_3), AD_WRAP_LITERAL(0.0));
    } else if (evaluation_mode & JMI_BLOCK_EVALUATE || evaluation_mode & JMI_BLOCK_WRITE_BACK) {
        if ((evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) == 0) {
            _x_0 = x[0];
        }
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = 42 - (_a_0 + _b_1);
            if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
                _sw(0) = jmi_turn_switch(jmi, _time - (AD_WRAP_LITERAL(1.0)), _sw(0), JMI_REL_GT);
            }
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_NOMINAL) {
        ...
        JMI_RECORD_STATIC(R_0_r, tmp_2)
        tmp_2->y = _p_y_0;
        (*res)[0] = jmi_max(jmi_abs(func_CCodeGenTests_BlockTest22_f_exp0(tmp_2)), AD_WRAP_LITERAL(1.0));
    } else if (evaluation_mode == JMI_BLOCK_INITIALIZE) {
        x[0] = _x_1;
    } else if (evaluation_mode & JMI_BLOCK_EVALUATE || evaluation_mode & JMI_BLOCK_WRITE_BACK) {
        if ((evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) == 0) {
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    if (jmi->atInitial || jmi->atEvent) {
        ...
        jmi_array_ref_1(tmp_1, 2) = AD_WRAP_LITERAL(1.0);
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            ...
            jmi_array_ref_1(tmp_2, 2) = AD_WRAP_LITERAL(1.0);
...
static int dae_init_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = COND_EXP_EQ(_p2_1, JMI_TRUE, AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(2.0)) - (_p1_0);
        }
    }
    JMI_DYNAMIC_FREE()
    return ef;
...
annotation(__JModelica(UnitTesting(tests={
    CCodeGenTestCase(
        ...
        template="$C_DAE_equation_residuals$",
        generatedCode="
    (*res)[0] = _time - 2.0 - (_y_0);
    (*res)[1] = (COND_EXP_EQ(_sw(0), JMI_TRUE, AD_WRAP_LITERAL(0.0), (1.0 * (_y_0) * (_y_0) * (_y_0)))) - (_x_1);
")})));
end Smooth1;
...
annotation(__JModelica(UnitTesting(tests={
    CCodeGenTestCase(
        ...
        generatedCode="
    (*res)[0] = _time - 2.0 - (_y_0);
    (*res)[1] = (COND_EXP_EQ(COND_EXP_LT(_y_0, AD_WRAP_LITERAL(0.0), JMI_TRUE, JMI_FALSE), JMI_TRUE, AD_WRAP_LITERAL(0.0), (1.0 * (_y_0) * (_y_0) * (_y_0)))) - (_x_1);
")})));
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        (*res)[0] = jmi_max(AD_WRAP_LITERAL(1.0), jmi_abs(_R3_10));
        (*res)[1] = jmi_max(AD_WRAP_LITERAL(1.0), jmi_abs(_R2_9));
    } else if (evaluation_mode == JMI_BLOCK_INITIALIZE) {
        x[0] = _i2_5;
        x[1] = _i3_6;
    } else if (evaluation_mode == JMI_BLOCK_EVALUATE_JACOBIAN) {
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        (*res)[0] = jmi_max(jmi_abs(_m_0), jmi_max(AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(1.0)));
    } else if (evaluation_mode == JMI_BLOCK_INITIALIZE) {
        x[0] = _sa_7;
    } else if (evaluation_mode == JMI_BLOCK_EVALUATE_JACOBIAN) {
            ...
            int n1 = 3;
            int n2 = 1;
            Q1[0] = - COND_EXP_EQ(LOG_EXP_OR(COND_EXP_EQ(pre_mode_10, AD_WRAP_LITERAL(1.0), JMI_TRUE, JMI_FALSE), _startFor_8), JMI_TRUE, AD_WRAP_LITERAL(1.0), COND_EXP_EQ(LOG_EXP_OR(COND_EXP_EQ(pre_mode_10, AD_WRAP_LITERAL(3.0), JMI_TRUE, JMI_FALSE), _startBack_9), JMI_TRUE, AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(0.0)));
            Q1[2] = - COND_EXP_EQ(LOG_EXP_OR(COND_EXP_EQ(pre_mode_10, AD_WRAP_LITERAL(1.0), JMI_TRUE, JMI_FALSE), _startFor_8), JMI_TRUE, AD_WRAP_LITERAL(0.0), COND_EXP_EQ(LOG_EXP_OR(COND_EXP_EQ(pre_mode_10, AD_WRAP_LITERAL(3.0), JMI_TRUE, JMI_FALSE), _startBack_9), JMI_TRUE, AD_WRAP_LITERAL(0.0), _f0_1));
            for (i = 0; i < 3; i += 3) {
                Q1[i + 0] = (Q1[i + 0]) / (1.0);
        ...
        _a_4 = COND_EXP_EQ(LOG_EXP_OR(COND_EXP_EQ(pre_mode_10, AD_WRAP_LITERAL(1.0), JMI_TRUE, JMI_FALSE), _startFor_8), JMI_TRUE, _sa_7 - AD_WRAP_LITERAL(1.0), COND_EXP_EQ(LOG_EXP_OR(COND_EXP_EQ(pre_mode_10, AD_WRAP_LITERAL(3.0), JMI_TRUE, JMI_FALSE), _startBack_9), JMI_TRUE, _sa_7 + AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(0.0)));
        _der_v_16 = _a_4 + 1.0;
        _f_5 = COND_EXP_EQ(LOG_EXP_OR(COND_EXP_EQ(pre_mode_10, AD_WRAP_LITERAL(1.0), JMI_TRUE, JMI_FALSE), _startFor_8), JMI_TRUE, _f0_1 + _f1_2 * _v_3, COND_EXP_EQ(LOG_EXP_OR(COND_EXP_EQ(pre_mode_10, AD_WRAP_LITERAL(3.0), JMI_TRUE, JMI_FALSE), _startBack_9), JMI_TRUE, - _f0_1 + _f1_2 * _v_3, _f0_1 * _sa_7));
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        memset(residual, 0, 4 * sizeof(jmi_real_t));
        residual[0] = 1.0;
        residual[1] = - COND_EXP_EQ(_b_2, JMI_TRUE, AD_WRAP_LITERAL(0.0), AD_WRAP_LITERAL(1.0));
        residual[2] = -1.0;
        residual[3] = 1.0;
    } else if (evaluation_mode & JMI_BLOCK_EVALUATE || evaluation_mode & JMI_BLOCK_WRITE_BACK) {
        if ((evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) == 0) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = _x_0 + 1.0 - (_y_1);
            (*res)[1] = COND_EXP_EQ(_b_2, JMI_TRUE, AD_WRAP_LITERAL(0.0), _y_1) - (_x_0);
        }
    }
    JMI_DYNAMIC_FREE()
    return ef;
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_START) {
        ...
        JMI_ARR(STAT, jmi_real_t, jmi_array_t, tmp_4, 1, 1)
            ...
            Q1[0] = - COND_EXP_EQ(_b1_5, JMI_TRUE, jmi_array_val_1(tmp_4, _i1_6), AD_WRAP_LITERAL(0.0));
            Q1[3] = -1.0;
            for (i = 0; i < 4; i += 2) {
                if (_b1_5) {
                    JMI_ARRAY_INIT_1(STAT, jmi_real_t, jmi_array_t, tmp_3, 1, 1, 1)
                ...
                Q1[i + 0] = (Q1[i + 0]) / (AD_WRAP_LITERAL(1.0) - COND_EXP_EQ(_b1_5, JMI_TRUE, jmi_array_val_1(tmp_3, _i1_6), AD_WRAP_LITERAL(0.0)));
                Q1[i + 1] = (Q1[i + 1] - (-2.0) * Q1[i + 0]) / (1.0);
            }
            Q2[3] = -1.1;
            memset(Q3, 0, 4 * sizeof(jmi_real_t));
            Q3[0] = 1.0;
        ...
        _x1_1 = COND_EXP_EQ(_b1_5, JMI_TRUE, (&_x4_1_4)[(int)(_i1_6 - 1)], AD_WRAP_LITERAL(0.0));
        _x2_2 = _x1_1 * 2.0 + _x3_3;
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
...
void func_Modelica_Math_Matrices_solve_def0(jmi_array_t* A_a, jmi_array_t* b_a, jmi_array_t* x_a) {
    ...
    if (COND_EXP_EQ(info_v, AD_WRAP_LITERAL(0.0), JMI_TRUE, JMI_FALSE) == JMI_FALSE) {
...
void func_Modelica_Math_Matrices_LAPACK_dgesv_vec_def1(jmi_array_t* A_a, jmi_array_t* b_a, jmi_array_t* x_a, jmi_real_t* info_o) {
    ...
    for (i1_1i = 1.0; i1_1i < i1_1ie; i1_1i += 1) {
        ...
        for (i2_2i = 1.0; i2_2i < i2_2ie; i2_2i += 1) {
            jmi_array_ref_2(Awork_a, i1_1i, i2_2i) = jmi_array_val_2(A_a, i1_1i, i2_2i);
        }
    }
    lda_v = jmi_max(AD_WRAP_LITERAL(1.0), jmi_array_size(A_a, 0));
    ldb_v = jmi_max(AD_WRAP_LITERAL(1.0), jmi_array_size(b_a, 0));
...
void func_Modelica_Math_Matrices_LAPACK_dgesv_def1(jmi_array_t* A_a, jmi_array_t* B_a, jmi_array_t* X_a, jmi_real_t* info_o) {
    ...
    for (i1_2i = 1.0; i1_2i < i1_2ie; i1_2i += 1) {
        ...
        for (i2_3i = 1.0; i2_3i < i2_3ie; i2_3i += 1) {
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    _i_2 = COND_EXP_EQ(_sw(0), JMI_TRUE, AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(2.0));
    pre_i_2 = _i_2;
    JMI_ARRAY_INIT_1(STAT, jmi_real_t, jmi_array_t, tmp_1, 2, 1, 2)
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            ...
            if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
                _sw(1) = jmi_turn_switch(jmi, _y_3 - (pre_temp_1_5 + AD_WRAP_LITERAL(1.0)), _sw(1), JMI_REL_GEQ);
            }
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            ...
            if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
                _sw(1) = jmi_turn_switch(jmi, _y_4 - (pre_temp_1_6 + AD_WRAP_LITERAL(1.0)), _sw(1), JMI_REL_GEQ);
            }
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            ...
            if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
                _sw(3) = jmi_turn_switch_time(jmi, _time - (pre_t_0 + AD_WRAP_LITERAL(1.0)), _sw(3), JMI_REL_GEQ);
            }
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    if (jmi->atInitial || jmi->atEvent) {
        _sw(1) = jmi_turn_switch_time(jmi, _time - (pre_i_4 + AD_WRAP_LITERAL(1.0)), _sw(1), JMI_REL_GEQ);
    }
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    JMI_DYNAMIC_INIT()
    if (jmi->atInitial || jmi->atEvent) {
        _sw(3) = jmi_turn_switch_time(jmi, _time - ((pre__sampleItr_1_19 + AD_WRAP_LITERAL(1.0)) * AD_WRAP_LITERAL(0.01)), _sw(3), JMI_REL_LT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(2) = jmi_turn_switch_time(jmi, _time - (pre__sampleItr_1_19 * 0.01), _sw(2), JMI_REL_GEQ);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(jmi, jmi_divide_equation(jmi, (pre_j_17 + AD_WRAP_LITERAL(1.0)), AD_WRAP_LITERAL(4.0), \"(pre(j) + 1) / 4\") - (pre_temp_2_20), _sw(0), JMI_REL_LT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(1) = jmi_turn_switch(jmi, jmi_divide_equation(jmi, (pre_j_17 + AD_WRAP_LITERAL(1.0)), AD_WRAP_LITERAL(4.0), \"(pre(j) + 1) / 4\") - (pre_temp_2_20 + AD_WRAP_LITERAL(1.0)), _sw(1), JMI_REL_GEQ);
    }
    ef |= jmi_solve_block_residual(jmi->dae_block_residuals[0]);
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(jmi, jmi_divide_equation(jmi, (pre_j_16 + AD_WRAP_LITERAL(1.0)), AD_WRAP_LITERAL(4.0), \"(pre(j) + 1) / 4\") - (pre_temp_2_20), _sw(0), JMI_REL_LT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(1) = jmi_turn_switch(jmi, jmi_divide_equation(jmi, (pre_j_16 + AD_WRAP_LITERAL(1.0)), AD_WRAP_LITERAL(4.0), \"(pre(j) + 1) / 4\") - (pre_temp_2_20 + AD_WRAP_LITERAL(1.0)), _sw(1), JMI_REL_GEQ);
    }
    ef |= jmi_solve_block_residual(jmi->dae_block_residuals[0]);
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    JMI_ARRAY_INIT_1(STAT, jmi_real_t, jmi_array_t, tmp_2, 2, 1, 2)
    jmi_array_ref_1(tmp_2, 1) = 42.0;
    jmi_array_ref_1(tmp_2, 2) = 3.0;
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    JMI_DYNAMIC_INIT()
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(jmi, _x_0 - (AD_WRAP_LITERAL(0.0)), _sw(0), JMI_REL_GEQ);
    }
    _der_x_3 = (COND_EXP_EQ(_sw(0), JMI_TRUE, _x_0, AD_WRAP_LITERAL(0.0)));
    _der_y_4 = (COND_EXP_EQ(COND_EXP_GE(_y_1, AD_WRAP_LITERAL(0.0), JMI_TRUE, JMI_FALSE), JMI_TRUE, (1.0 * (_y_1) * (_y_1)), AD_WRAP_LITERAL(0.0)));
    _der_z_5 = (COND_EXP_EQ(COND_EXP_GE(_z_2, AD_WRAP_LITERAL(0.0), JMI_TRUE, JMI_FALSE), JMI_TRUE, (1.0 * (_z_2) * (_z_2) * (_z_2)), AD_WRAP_LITERAL(0.0)));
    JMI_DYNAMIC_FREE()
    return ef;
}
")})));
...
C_ode_time_events
    ...
    if (SURELY_LT_ZERO(COND_EXP_EQ(_sw(0), JMI_TRUE, AD_WRAP_LITERAL(1.0) - (_time), AD_WRAP_LITERAL(1))) || (!jmi->eventPhase && ALMOST_ZERO(COND_EXP_EQ(_sw(0), JMI_TRUE, AD_WRAP_LITERAL(1.0) - (_time), AD_WRAP_LITERAL(1))))) {
        jmi_min_time_event(nextTimeEvent, 1, 1, AD_WRAP_LITERAL(1.0));
    }
    if (SURELY_LT_ZERO(COND_EXP_EQ(LOG_EXP_NOT(LOG_EXP_AND(_sw(0), _sw(1))), JMI_TRUE, _time - (AD_WRAP_LITERAL(1.0)), AD_WRAP_LITERAL(1))) || (!jmi->eventPhase && ALMOST_ZERO(COND_EXP_EQ(LOG_EXP_NOT(LOG_EXP_AND(_sw(0), _sw(1))), JMI_TRUE, _time - (AD_WRAP_LITERAL(1.0)), AD_WRAP_LITERAL(1))))) {
        jmi_min_time_event(nextTimeEvent, 1, 1, AD_WRAP_LITERAL(1.0));
    }
    if (SURELY_LT_ZERO(COND_EXP_EQ(LOG_EXP_AND(LOG_EXP_NOT(LOG_EXP_AND(_sw(0), _sw(1))), _sw(2)), JMI_TRUE, AD_WRAP_LITERAL(1.0) - (_time), AD_WRAP_LITERAL(1)))) {
        jmi_min_time_event(nextTimeEvent, 1, 0, AD_WRAP_LITERAL(1.0));
    }
    if (SURELY_LT_ZERO(COND_EXP_EQ(LOG_EXP_NOT(LOG_EXP_OR(LOG_EXP_AND(_sw(0), _sw(1)), LOG_EXP_AND(_sw(2), _sw(3)))), JMI_TRUE, _time - (AD_WRAP_LITERAL(1.0)), AD_WRAP_LITERAL(1))) || (!jmi->eventPhase && ALMOST_ZERO(COND_EXP_EQ(LOG_EXP_NOT(LOG_EXP_OR(LOG_EXP_AND(_sw(0), _sw(1)), LOG_EXP_AND(_sw(2), _sw(3)))), JMI_TRUE, _time - (AD_WRAP_LITERAL(1.0)), AD_WRAP_LITERAL(1))))) {
        jmi_min_time_event(nextTimeEvent, 1, 1, AD_WRAP_LITERAL(1.0));
    }
    if (SURELY_LT_ZERO(COND_EXP_EQ(LOG_EXP_AND(LOG_EXP_NOT(LOG_EXP_OR(LOG_EXP_AND(_sw(0), _sw(1)), LOG_EXP_AND(_sw(2), _sw(3)))), _sw(4)), JMI_TRUE, AD_WRAP_LITERAL(1.0) - (_time), AD_WRAP_LITERAL(1)))) {
        jmi_min_time_event(nextTimeEvent, 1, 0, AD_WRAP_LITERAL(1.0));
    }
    if (SURELY_LT_ZERO(COND_EXP_EQ(LOG_EXP_NOT(LOG_EXP_OR(LOG_EXP_OR(LOG_EXP_AND(_sw(0), _sw(1)), LOG_EXP_AND(_sw(2), _sw(3))), LOG_EXP_AND(_sw(4), _sw(5)))), JMI_TRUE, _time - (AD_WRAP_LITERAL(1.0)), AD_WRAP_LITERAL(1)))) {
        jmi_min_time_event(nextTimeEvent, 1, 0, AD_WRAP_LITERAL(1.0));
    }
    if (SURELY_LT_ZERO(COND_EXP_EQ(LOG_EXP_AND(LOG_EXP_NOT(LOG_EXP_OR(LOG_EXP_OR(LOG_EXP_AND(_sw(0), _sw(1)), LOG_EXP_AND(_sw(2), _sw(3))), LOG_EXP_AND(_sw(4), _sw(5)))), _sw(6)), JMI_TRUE, AD_WRAP_LITERAL(1.0) - (_time), AD_WRAP_LITERAL(1))) || (!jmi->eventPhase && ALMOST_ZERO(COND_EXP_EQ(LOG_EXP_AND(LOG_EXP_NOT(LOG_EXP_OR(LOG_EXP_OR(LOG_EXP_AND(_sw(0), _sw(1)), LOG_EXP_AND(_sw(2), _sw(3))), LOG_EXP_AND(_sw(4), _sw(5)))), _sw(6)), JMI_TRUE, AD_WRAP_LITERAL(1.0) - (_time), AD_WRAP_LITERAL(1))))) {
        jmi_min_time_event(nextTimeEvent, 1, 1, AD_WRAP_LITERAL(1.0));
    }
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    JMI_DYNAMIC_INIT()
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch_time(jmi, _time - (AD_WRAP_LITERAL(1.0)), _sw(0), JMI_REL_GEQ);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(1) = jmi_turn_switch_time(jmi, AD_WRAP_LITERAL(1.0) - (_time), _sw(1), jmi->eventPhase ? (JMI_REL_GT) : (JMI_REL_GEQ));
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(2) = jmi_turn_switch_time(jmi, _time - (AD_WRAP_LITERAL(1.0)), _sw(2), jmi->eventPhase ? (JMI_REL_GEQ) : (JMI_REL_GT));
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(3) = jmi_turn_switch_time(jmi, AD_WRAP_LITERAL(1.0) - (_time), _sw(3), JMI_REL_GT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(4) = jmi_turn_switch_time(jmi, _time - (AD_WRAP_LITERAL(1.0)), _sw(4), jmi->eventPhase ? (JMI_REL_LT) : (JMI_REL_LEQ));
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(5) = jmi_turn_switch_time(jmi, AD_WRAP_LITERAL(1.0) - (_time), _sw(5), JMI_REL_LEQ);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(6) = jmi_turn_switch_time(jmi, _time - (AD_WRAP_LITERAL(1.0)), _sw(6), JMI_REL_LT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(7) = jmi_turn_switch_time(jmi, AD_WRAP_LITERAL(1.0) - (_time), _sw(7), jmi->eventPhase ? (JMI_REL_LEQ) : (JMI_REL_LT));
    }
    _x_0 = COND_EXP_EQ(LOG_EXP_OR(LOG_EXP_OR(LOG_EXP_OR(LOG_EXP_AND(_sw(0), _sw(1)), LOG_EXP_AND(_sw(2), _sw(3))), LOG_EXP_AND(_sw(4), _sw(5))), LOG_EXP_AND(_sw(6), _sw(7))), JMI_TRUE, AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(0.0));
    JMI_DYNAMIC_FREE()
    return ef;
}
")})));
...
C_ode_time_events
    ...
    jmi_array_ref_1(tmp_2, 1) = AD_WRAP_LITERAL(1.0);
    jmi_array_ref_1(tmp_2, 2) = AD_WRAP_LITERAL(2.0);
    jmi_array_ref_1(tmp_2, 3) = AD_WRAP_LITERAL(3.0);
    if (SURELY_LT_ZERO(COND_EXP_EQ(LOG_EXP_NOT(_atInitial), JMI_TRUE, _time - (1.0 + pre__sampleItr_1_2 * func_CCodeGenTests_TestRelationalOp9_f_exp0(tmp_2)), AD_WRAP_LITERAL(1)))) {
        jmi_min_time_event(nextTimeEvent, 1, 0, 1.0 + pre__sampleItr_1_2 * func_CCodeGenTests_TestRelationalOp9_f_exp0(tmp_2));
    }
    JMI_ARRAY_INIT_1(STAT, jmi_real_t, jmi_array_t, tmp_3, 3, 1, 3)
    jmi_array_ref_1(tmp_3, 1) = AD_WRAP_LITERAL(1.0);
    jmi_array_ref_1(tmp_3, 2) = AD_WRAP_LITERAL(2.0);
    jmi_array_ref_1(tmp_3, 3) = AD_WRAP_LITERAL(3.0);
    if (SURELY_LT_ZERO(_time - (AD_WRAP_LITERAL(1.0) + (pre__sampleItr_1_2 + AD_WRAP_LITERAL(1.0)) * func_CCodeGenTests_TestRelationalOp9_f_exp0(tmp_3)))) {
        jmi_min_time_event(nextTimeEvent, 1, 0, AD_WRAP_LITERAL(1.0) + (pre__sampleItr_1_2 + AD_WRAP_LITERAL(1.0)) * func_CCodeGenTests_TestRelationalOp9_f_exp0(tmp_3));
    }
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    if (jmi->atInitial || jmi->atEvent) {
        ...
        JMI_ARRAY_INIT_1(STAT, jmi_real_t, jmi_array_t, tmp_4, 3, 1, 3)
        jmi_array_ref_1(tmp_4, 1) = AD_WRAP_LITERAL(1.0);
        jmi_array_ref_1(tmp_4, 2) = AD_WRAP_LITERAL(2.0);
        jmi_array_ref_1(tmp_4, 3) = AD_WRAP_LITERAL(3.0);
    ...
    if (jmi->atInitial || jmi->atEvent) {
        ...
        jmi_array_ref_1(tmp_3, 2) = AD_WRAP_LITERAL(2.0);
        jmi_array_ref_1(tmp_3, 3) = AD_WRAP_LITERAL(3.0);
        _sw(2) = jmi_turn_switch_time(jmi, _time - (AD_WRAP_LITERAL(1.0) + (pre__sampleItr_1_2 + AD_WRAP_LITERAL(1.0)) * func_CCodeGenTests_TestRelationalOp9_f_exp0(tmp_3)), _sw(2), JMI_REL_LT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        JMI_ARR(STAT, jmi_real_t, jmi_array_t, tmp_2, 3, 1)
        JMI_ARRAY_INIT_1(STAT, jmi_real_t, jmi_array_t, tmp_2, 3, 1, 3)
        ...
        jmi_array_ref_1(tmp_2, 2) = AD_WRAP_LITERAL(2.0);
        jmi_array_ref_1(tmp_2, 3) = AD_WRAP_LITERAL(3.0);
        _sw(1) = jmi_turn_switch_time(jmi, _time - (1.0 + pre__sampleItr_1_2 * func_CCodeGenTests_TestRelationalOp9_f_exp0(tmp_2)), _sw(1), JMI_REL_GEQ);
    }
    ef |= jmi_solve_block_residual(jmi->dae_block_residuals[0]);
    JMI_DYNAMIC_FREE()
    return ef;
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    if (jmi->atInitial || jmi->atEvent) {
        ...
        _sw(0) = jmi_turn_switch(jmi, (_time + _p_0 - (_x_1)) / jmi_max(jmi_max(AD_WRAP_LITERAL(1.0), jmi_abs(_p_0)), jmi_abs(func_CCodeGenTests_TestRelationalOp10_f_exp0(tmp_1))), _sw(0), JMI_REL_GT);
    }
    _b1_2 = _sw(0);
    pre_b1_2 = _b1_2;
    JMI_DYNAMIC_FREE()
...
annotation(__JModelica(UnitTesting(tests={
    ...
    int ef = 0;
    JMI_DYNAMIC_INIT()
    (*res)[0] = _x_0 - (AD_WRAP_LITERAL(1.0));
    (*res)[1] = COND_EXP_EQ(_sw(0), JMI_TRUE, _x_0 - (AD_WRAP_LITERAL(2.0)), AD_WRAP_LITERAL(1));
    (*res)[2] = COND_EXP_EQ(LOG_EXP_NOT(_sw(0)), JMI_TRUE, _x_0 - (AD_WRAP_LITERAL(3.0)), AD_WRAP_LITERAL(1));
    (*res)[3] = COND_EXP_EQ(LOG_EXP_AND(LOG_EXP_NOT(_sw(0)), LOG_EXP_NOT(_sw(2))), JMI_TRUE, _x_0 - (AD_WRAP_LITERAL(4.0)), AD_WRAP_LITERAL(1));
    (*res)[4] = COND_EXP_EQ(LOG_EXP_AND(LOG_EXP_AND(LOG_EXP_NOT(_sw(0)), LOG_EXP_NOT(_sw(2))), _sw(3)), JMI_TRUE, _x_0 - (AD_WRAP_LITERAL(5.0)), AD_WRAP_LITERAL(1));
    JMI_DYNAMIC_FREE()
    return ef;
")})));
...
",
    ...
    JMI_DYNAMIC_INIT()
    JMI_ARR(STAT, jmi_real_t, jmi_array_t, tmp_1, 2, 1)
    (*res)[0] = _x_0 - (AD_WRAP_LITERAL(4.0));
    (*res)[1] = _x_0 - (AD_WRAP_LITERAL(4.0));
    JMI_ARRAY_INIT_1(STAT, jmi_real_t, jmi_array_t, tmp_1, 2, 1, 2)
    jmi_array_ref_1(tmp_1, 1) = _sw(0);
    jmi_array_ref_1(tmp_1, 2) = _sw(1);
    (*res)[2] = COND_EXP_EQ(func_CCodeGenTests_TestRelationalOp12_f_exp0(tmp_1), JMI_TRUE, _x_0 - (5.0), AD_WRAP_LITERAL(1));
    JMI_DYNAMIC_FREE()
    return ef;
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    _x_0 = _time + 1.0;
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(jmi, _x_0 - (AD_WRAP_LITERAL(4.0)), _sw(0), JMI_REL_GT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(1) = jmi_turn_switch(jmi, _x_0 - (AD_WRAP_LITERAL(4.0)), _sw(1), JMI_REL_GT);
    }
    JMI_ARRAY_INIT_1(STAT, jmi_real_t, jmi_array_t, tmp_2, 2, 1, 2)
    jmi_array_ref_1(tmp_2, 1) = _sw(0);
    jmi_array_ref_1(tmp_2, 2) = _sw(1);
    if (jmi->atInitial || jmi->atEvent) {
        _sw(2) = jmi_turn_switch(jmi, _x_0 - (5.0), _sw(2), JMI_REL_GT);
    }
...
",
        generatedCode="
    jmi_real_t nSamp;
    if (SURELY_LT_ZERO(COND_EXP_EQ(_sw(2), JMI_TRUE, _time - (3.0), AD_WRAP_LITERAL(1))) || (!jmi->eventPhase && ALMOST_ZERO(COND_EXP_EQ(_sw(2), JMI_TRUE, _time - (3.0), AD_WRAP_LITERAL(1))))) {
        jmi_min_time_event(nextTimeEvent, 1, 1, 3.0);
    }
    if (SURELY_LT_ZERO(COND_EXP_EQ(_b1_2, JMI_TRUE, _time - (2.0), AD_WRAP_LITERAL(1))) || (!jmi->eventPhase && ALMOST_ZERO(COND_EXP_EQ(_b1_2, JMI_TRUE, _time - (2.0), AD_WRAP_LITERAL(1))))) {
        jmi_min_time_event(nextTimeEvent, 1, 1, 2.0);
    }
    if (SURELY_LT_ZERO(_time - (1.0)) || (!jmi->eventPhase && ALMOST_ZERO(_time - (1.0)))) {
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    JMI_DYNAMIC_INIT()
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch_time(jmi, _time - (3.0), _sw(0), jmi->eventPhase ? (JMI_REL_GEQ) : (JMI_REL_GT));
    }
    if (jmi->atInitial || jmi->atEvent) {
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    JMI_DYNAMIC_INIT()
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(jmi, sin(_time) - (AD_WRAP_LITERAL(0.0)), _sw(0), JMI_REL_GT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(1) = jmi_turn_switch(jmi, cos(_time) - (AD_WRAP_LITERAL(0.0)), _sw(1), JMI_REL_GT);
    }
    _a_0 = COND_EXP_EQ(LOG_EXP_AND(_sw(0), _sw(1)), JMI_TRUE, AD_WRAP_LITERAL(1.0), _time);
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(jmi, sin(_time) - (AD_WRAP_LITERAL(0.0)), _sw(0), JMI_REL_GT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(2) = jmi_turn_switch(jmi, cos(_time) - (AD_WRAP_LITERAL(0.0)), _sw(2), JMI_REL_GT);
    }
    _b_1 = COND_EXP_EQ(LOG_EXP_AND(_sw(0), _sw(2)), JMI_TRUE, _time, AD_WRAP_LITERAL(1.0));
    JMI_DYNAMIC_FREE()
    return ef;
}
    ...
    int ef = 0;
    JMI_DYNAMIC_INIT()
    (*res)[0] = sin(_time) - (AD_WRAP_LITERAL(0.0));
    (*res)[1] = COND_EXP_EQ(_sw(0), JMI_TRUE, cos(_time) - (AD_WRAP_LITERAL(0.0)), AD_WRAP_LITERAL(1));
    (*res)[2] = COND_EXP_EQ(_sw(0), JMI_TRUE, cos(_time) - (AD_WRAP_LITERAL(0.0)), AD_WRAP_LITERAL(1));
    JMI_DYNAMIC_FREE()
    return ef;
")})));
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    if (jmi->atInitial || jmi->atEvent) {
        _sw(2) = jmi_turn_switch(jmi, cos(_time + AD_WRAP_LITERAL(0.5)) - (AD_WRAP_LITERAL(0.0)), _sw(2), JMI_REL_GT);
    }
    _a_0 = COND_EXP_EQ(LOG_EXP_AND(LOG_EXP_AND(_sw(0), _sw(1)), _sw(2)), JMI_TRUE, AD_WRAP_LITERAL(1.0), _time);
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(jmi, sin(_time) - (AD_WRAP_LITERAL(0.0)), _sw(0), JMI_REL_GT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(3) = jmi_turn_switch(jmi, cos(_time) - (AD_WRAP_LITERAL(0.0)), _sw(3), JMI_REL_GT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(4) = jmi_turn_switch(jmi, cos(_time + AD_WRAP_LITERAL(0.5)) - (AD_WRAP_LITERAL(0.0)), _sw(4), JMI_REL_GT);
    }
    _b_1 = COND_EXP_EQ(LOG_EXP_AND(LOG_EXP_AND(_sw(0), _sw(3)), _sw(4)), JMI_TRUE, _time, AD_WRAP_LITERAL(1.0));
    JMI_DYNAMIC_FREE()
    return ef;
}
    ...
    (*res)[0] = sin(_time) - (AD_WRAP_LITERAL(0.0));
    (*res)[1] = COND_EXP_EQ(_sw(0), JMI_TRUE, cos(_time) - (AD_WRAP_LITERAL(0.0)), AD_WRAP_LITERAL(1));
    (*res)[2] = COND_EXP_EQ(LOG_EXP_AND(_sw(0), _sw(1)), JMI_TRUE, cos(_time + AD_WRAP_LITERAL(0.5)) - (AD_WRAP_LITERAL(0.0)), AD_WRAP_LITERAL(1));
    (*res)[3] = COND_EXP_EQ(_sw(0), JMI_TRUE, cos(_time) - (AD_WRAP_LITERAL(0.0)), AD_WRAP_LITERAL(1));
    (*res)[4] = COND_EXP_EQ(LOG_EXP_AND(_sw(0), _sw(3)), JMI_TRUE, cos(_time + AD_WRAP_LITERAL(0.5)) - (AD_WRAP_LITERAL(0.0)), AD_WRAP_LITERAL(1));
    JMI_DYNAMIC_FREE()
    return ef;
")})));
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    _r_0 = _time;
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(jmi, _r_0 - (2.0), _sw(0), JMI_REL_LT);
    }
    _b_1 = _sw(0);
    pre_b_1 = _b_1;
...
void func_CCodeGenTests_StringOperations9_f_def0(jmi_real_t x_v, jmi_real_t i_v, jmi_real_t b_v, jmi_string_t fmt_v, jmi_real_t* y_o) {
    ...
    JMI_DEF_STR_DYNA(tmp_1)
    JMI_INI(STR, s_v)
    JMI_INI_STR_DYNA(tmp_1, jmi_max(7 + AD_WRAP_LITERAL(1.0), i_v) + jmi_max(7 + i_v, AD_WRAP_LITERAL(2.0)) + jmi_max(7 + i_v, i_v) + jmi_max(7 + i_v, i_v) + 7 + i_v + 7 + 6 + 16 + jmi_max(10, AD_WRAP_LITERAL(2.0)) + jmi_max(10, i_v) + jmi_max(10, i_v) + 16 + jmi_max(5, AD_WRAP_LITERAL(2.0)) + jmi_max(5, i_v) + jmi_max(5, i_v))
    snprintf(JMI_STR_END(tmp_1), JMI_STR_LEFT(tmp_1), COND_EXP_EQ(b_v, JMI_TRUE, \"%-*.*g\", \"%*.*g\"), (int) i_v, (int) AD_WRAP_LITERAL(1.0), x_v);
    snprintf(JMI_STR_END(tmp_1), JMI_STR_LEFT(tmp_1), COND_EXP_EQ(b_v, JMI_TRUE, \"%-*.*g\", \"%*.*g\"), (int) AD_WRAP_LITERAL(2.0), (int) i_v, x_v);
    ...
    snprintf(JMI_STR_END(tmp_1), JMI_STR_LEFT(tmp_1), COND_EXP_EQ(b_v, JMI_TRUE, \"%-*d\", \"%*d\"), (int) AD_WRAP_LITERAL(2.0), (int) i_v);
    ...
    snprintf(JMI_STR_END(tmp_1), JMI_STR_LEFT(tmp_1), COND_EXP_EQ(b_v, JMI_TRUE, \"%-*s\", \"%*s\"), (int) AD_WRAP_LITERAL(2.0), COND_EXP_EQ(b_v, JMI_TRUE, \"true\", \"false\"));
...
void func_CCodeGenTests_StringOperations10_f2_def0(jmi_real_t x_v, jmi_real_t* y_o) {
    ...
    y_v = x_v;
    JMI_ASG(STR, jmi_array_ref_1(s_a, 1.0), \"str\")
    JMI_ASG(STR, jmi_array_ref_1(s_a, 2.0), \"str\")
...
void func_CCodeGenTests_StringOperations11_f2_def0(jmi_real_t x_v, jmi_real_t n_v, jmi_real_t* y_o) {
    ...
    y_v = x_v;
    JMI_ARRAY_INIT_1(DYNA, jmi_string_t, jmi_string_array_t, temp_1_a, jmi_max(n_v, AD_WRAP_LITERAL(0.0)), 1, jmi_max(n_v, AD_WRAP_LITERAL(0.0)))
    i1_0ie = jmi_max(n_v, AD_WRAP_LITERAL(0.0)) + 1 / 2.0;
    for (i1_0i = 1.0; i1_0i < i1_0ie; i1_0i += 1) {
        JMI_ASG(STR, jmi_array_ref_1(temp_1_a, i1_0i), \"str\")
    }
    i1_1ie = jmi_max(n_v, AD_WRAP_LITERAL(0.0)) + 1 / 2.0;
    for (i1_1i = 1.0; i1_1i < i1_1ie; i1_1i += 1) {
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    _der_x_3 = _time;
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(jmi, _x_0 - (2.0), _sw(0), JMI_REL_GEQ);
    }
    ef |= jmi_solve_block_residual(jmi->dae_block_residuals[0]);
    JMI_DYNAMIC_FREE()
    return ef;
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_SOLVED_NON_REAL_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
                _sw(0) = jmi_turn_switch(jmi, _x_1 - (2.0), _sw(0), JMI_REL_GEQ);
            }
            _temp_1_2 = _sw(0);
        }
        if (LOG_EXP_AND(_temp_1_2, LOG_EXP_NOT(pre_temp_1_2))) {
...
void func_CCodeGenTests_TestAssert1_f_def0(jmi_real_t x_v, jmi_real_t* y_o) {
    ...
    JMI_DEF(REA, y_v)
    y_v = x_v + 1.0;
    if (COND_EXP_LT(x_v, AD_WRAP_LITERAL(3.0), JMI_TRUE, JMI_FALSE) == JMI_FALSE) {
        jmi_assert_failed(\"x is too high.\", JMI_ASSERT_ERROR);
    }
    if (COND_EXP_LT(y_v, AD_WRAP_LITERAL(4.0), JMI_TRUE, JMI_FALSE) == JMI_FALSE) {
        jmi_assert_failed(\"y is too high.\", JMI_ASSERT_ERROR);
    }
    if (COND_EXP_LT(x_v + y_v, AD_WRAP_LITERAL(5.0), JMI_TRUE, JMI_FALSE) == JMI_FALSE) {
...
int model_ode_initialize_base(jmi_t* jmi) {
    ...
    _x_0 = _time + 1.0;
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(jmi, _x_0 - (AD_WRAP_LITERAL(3.0)), _sw(0), JMI_REL_LT);
    }
    if (_sw(0) == JMI_FALSE) {
        jmi_assert_failed(\"x is too high.\", JMI_ASSERT_ERROR);
    }
    _y_1 = _x_0 + 1.0;
    if (jmi->atInitial || jmi->atEvent) {
        _sw(1) = jmi_turn_switch(jmi, _y_1 - (AD_WRAP_LITERAL(4.0)), _sw(1), JMI_REL_LT);
    }
    if (_sw(1) == JMI_FALSE) {
        jmi_assert_failed(\"y is too high.\", JMI_ASSERT_ERROR);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(2) = jmi_turn_switch(jmi, _x_0 + _y_1 - (AD_WRAP_LITERAL(5.0)), _sw(2), JMI_REL_LT);
    }
    if (_sw(2) == JMI_FALSE) {
        jmi_assert_failed(\"sum is a bit high.\", JMI_ASSERT_WARNING);
    }
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    _x_0 = _time + 1.0;
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(jmi, _x_0 - (AD_WRAP_LITERAL(5.0)), _sw(0), JMI_REL_LT);
    }
    if (_sw(0) == JMI_FALSE) {
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    _x_1 = _time + 1.0;
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(jmi, _x_1 - (AD_WRAP_LITERAL(5.0)), _sw(0), JMI_REL_LT);
    }
    if (_sw(0) == JMI_FALSE) {
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
                _sw(0) = jmi_turn_switch(jmi, _f_0 - (10.0), _sw(0), JMI_REL_GT);
            }
            _s_1 = _sw(0);
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = COND_EXP_EQ(_s_1, JMI_TRUE, _time, AD_WRAP_LITERAL(-1.0)) - (_f_0);
        }
    }
    JMI_DYNAMIC_FREE()
    return ef;
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            ...
            (*res)[0] = COND_EXP_EQ(_sw(0), JMI_TRUE, _time, AD_WRAP_LITERAL(-1.0)) - (_a_0);
        }
    }
    JMI_DYNAMIC_FREE()
    return ef;
...
static int dae_block_1(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
                _sw(1) = jmi_turn_switch(jmi, _a_0 - (AD_WRAP_LITERAL(10.0)), _sw(1), JMI_REL_GT);
            }
...
static int dae_init_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            _sw_init(0) = jmi_turn_switch(jmi, _a_0 - (AD_WRAP_LITERAL(42.0)), _sw_init(0), JMI_REL_GT);
        }
...
static int dae_init_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        _x_0 = COND_EXP_EQ(_sw_init(0), JMI_TRUE, _p_1 - AD_WRAP_LITERAL(42.0), _p_1 + _time);
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
...
int model_ode_derivatives_base(jmi_t* jmi) {
    int ef = 0;
    JMI_DYNAMIC_INIT()
    _x_0 = COND_EXP_EQ(COND_EXP_GT(_p_1, AD_WRAP_LITERAL(3.14), JMI_TRUE, JMI_FALSE), JMI_TRUE, _p_1 - AD_WRAP_LITERAL(42.0), _p_1 + _time);
    JMI_DYNAMIC_FREE()
    return ef;
}
...
int model_ode_initialize_base(jmi_t* jmi) {
    ...
    ef |= jmi_solve_block_residual(jmi->dae_init_block_residuals[0]);
    if (jmi->atInitial || jmi->atEvent) {
        _sw_init(0) = jmi_turn_switch(jmi, _p1_0 - (AD_WRAP_LITERAL(0.0)), _sw_init(0), JMI_REL_GT);
    }
    _a_2 = COND_EXP_EQ(_sw_init(0), JMI_TRUE, AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(2.0));
    JMI_DYNAMIC_FREE()
    return ef;
}
...
C_DAE_initial_event_indicator_residuals
    int ef = 0;
    JMI_DYNAMIC_INIT()
    (*res)[0] = _p1_0 - (AD_WRAP_LITERAL(0.0));
    JMI_DYNAMIC_FREE()
    return ef;
...
int model_ode_derivatives_base(jmi_t* jmi) {
    int ef = 0;
    JMI_DYNAMIC_INIT()
    _x_0 = (COND_EXP_EQ(COND_EXP_GT(_time, AD_WRAP_LITERAL(1.0), JMI_TRUE, JMI_FALSE), JMI_TRUE, _time * AD_WRAP_LITERAL(1.2), AD_WRAP_LITERAL(1.0)));
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(jmi, _time - (AD_WRAP_LITERAL(1.0)), _sw(0), JMI_REL_GT);
    }
    _y_1 = (COND_EXP_EQ(_sw(0), JMI_TRUE, AD_WRAP_LITERAL(1.2), AD_WRAP_LITERAL(0.0)));
    JMI_DYNAMIC_FREE()
    return ef;
}
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            _sw(0) = jmi_turn_switch(jmi, _x_2 - (AD_WRAP_LITERAL(0.0)), _sw(0), JMI_REL_GT);
        }
        if (_sw(0)) {
        } else {
            if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
                _sw(1) = jmi_turn_switch(jmi, _a_3 - (AD_WRAP_LITERAL(0.0)), _sw(1), JMI_REL_GT);
            }
        }
        _y_4 = COND_EXP_EQ(_sw(0), JMI_TRUE, _x_2, COND_EXP_EQ(_sw(1), JMI_TRUE, _x_2 * AD_WRAP_LITERAL(2.0), - _x_2));
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
                _sw(2) = jmi_turn_switch(jmi, _y_4 - (1.0), _sw(2), JMI_REL_LT);
            }
...
void func_CCodeGenTests_Functional2_usePartFunc_def0(func_CCodeGenTests_Functional2_partFunc_fp1* pf_v, jmi_real_t x_v, jmi_real_t* y_o) {
    ...
    tmp_1.n = 2;
    pf_v->fpcl(pf_v, &tmp_1, (jmi_real_t)(x_v), (jmi_real_t)(x_v + AD_WRAP_LITERAL(1.0)));
    y1_v = tmp_1.y1_v;
    y2_v = tmp_1.y2_v;
    y_v = y1_v + y2_v;
    JMI_RET(GEN, y_o, y_v)
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    tmp_1->x = _time;
    tmp_1->y = AD_WRAP_LITERAL(1.0);
    tmp_1->s = \"string\";
    _y_0 = func_CCodeGenTests_Functional2_usePartFunc_exp0((func_CCodeGenTests_Functional2_partFunc_fp1*)func_CCodeGenTests_Functional2_fullFunc_fpcr2(NULL, &tmp_2, 0, 0, 1, (R_0_r*)(tmp_1), 1, (jmi_real_t)(_time + AD_WRAP_LITERAL(1.0))), _time);
    JMI_DYNAMIC_FREE()
    return ef;
}
")})));
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    func_CCodeGenTests_Functional4_usePartFunc_def0((func_CCodeGenTests_Functional4_partFunc_fp1*)func_CCodeGenTests_Functional4_fullFunc_fpcr2(NULL, &tmp_1, 0, 1, (jmi_real_t)(_time + AD_WRAP_LITERAL(1.0))), _time);
    JMI_DYNAMIC_FREE()
    return ef;
}
")})));
...
void func_CCodeGenTests_Functional5_usePartFunc_def0(func_CCodeGenTests_Functional5_partFunc_fp1* pf_v, jmi_real_t* y_o) {
    JMI_DYNAMIC_INIT()
    JMI_DEF(REA, y_v)
    y_v = pf_v->fpcl(pf_v, NULL, (jmi_real_t)(AD_WRAP_LITERAL(1.0)), (jmi_real_t)(AD_WRAP_LITERAL(3.0)), (jmi_real_t)(AD_WRAP_LITERAL(5.0)));
    JMI_RET(GEN, y_o, y_v)
    JMI_DYNAMIC_FREE()
    return;
}
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    _y1_0 = func_CCodeGenTests_Functional5_usePartFunc_exp0((func_CCodeGenTests_Functional5_partFunc_fp1*)func_CCodeGenTests_Functional5_fullFunc_fpcr2(NULL, &tmp_1, 0, 1, (jmi_real_t)(_time), 0, 1, (jmi_real_t)(AD_WRAP_LITERAL(4.0)), 0));
    JMI_DYNAMIC_FREE()
    return ef;
}
")})));
...
static const int DAE_relations[] = { -1 };
    ...
    jmi_delay_init(jmi, 0, JMI_TRUE, JMI_FALSE, AD_WRAP_LITERAL(1.0), _time);
    jmi_delay_init(jmi, 1, JMI_TRUE, JMI_TRUE, AD_WRAP_LITERAL(1.0), _time);
...
int model_ode_derivatives_base(jmi_t* jmi) {
    int ef = 0;
    JMI_DYNAMIC_INIT()
    _x1_0 = jmi_delay_evaluate(jmi, 0, _time, AD_WRAP_LITERAL(1.0));
    _x2_1 = (jmi_delay_evaluate(jmi, 1, _time, AD_WRAP_LITERAL(1.0)));
    JMI_DYNAMIC_FREE()
    return ef;
}
...
static const int DAE_relations[] = { JMI_REL_GEQ, JMI_REL_GEQ };
    ...
    jmi_delay_init(jmi, 0, JMI_TRUE, JMI_FALSE, AD_WRAP_LITERAL(1.0), _time);
    jmi_delay_init(jmi, 1, JMI_TRUE, JMI_FALSE, AD_WRAP_LITERAL(2.0), _time);
    jmi_delay_init(jmi, 2, JMI_TRUE, JMI_FALSE, AD_WRAP_LITERAL(3.0), _x1_0);
...
int model_ode_derivatives_base(jmi_t* jmi) {
    int ef = 0;
    JMI_DYNAMIC_INIT()
    _x1_0 = jmi_delay_evaluate(jmi, 0, _time, AD_WRAP_LITERAL(1.0)) + jmi_delay_evaluate(jmi, 1, _time, AD_WRAP_LITERAL(2.0));
    _x2_1 = jmi_delay_evaluate(jmi, 2, _x1_0, AD_WRAP_LITERAL(3.0));
...
static const int DAE_relations[] = { JMI_REL_GT, JMI_REL_GEQ, JMI_REL_GEQ };
    ...
    jmi_delay_init(jmi, 0, JMI_FALSE, JMI_FALSE, AD_WRAP_LITERAL(10.0), COND_EXP_EQ(_sw(0), JMI_TRUE, _time, _time + AD_WRAP_LITERAL(1.0)));

    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(jmi, _time - (AD_WRAP_LITERAL(1.0)), _sw(0), JMI_REL_GT);
    }
    jmi_delay_record_sample(jmi, 0, COND_EXP_EQ(_sw(0), JMI_TRUE, _time, _time + AD_WRAP_LITERAL(1.0)));
...
int model_ode_initialize_base(jmi_t* jmi) {
    ...
    _x_0 = COND_EXP_EQ(_sw(0), JMI_TRUE, _time, _time + AD_WRAP_LITERAL(1.0));
    JMI_DYNAMIC_FREE()
    return ef;
}
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    _x_0 = jmi_delay_evaluate(jmi, 0, COND_EXP_EQ(_sw(0), JMI_TRUE, _time, _time + AD_WRAP_LITERAL(1.0)), _y_1);
    JMI_DYNAMIC_FREE()
    return ef;
}
...
static const int DAE_relations[] = { JMI_REL_GEQ, JMI_REL_GEQ };
    ...
    jmi_array_ref_1(tmp_1, 2) = AD_WRAP_LITERAL(2.0);
    JMI_ARRAY_INIT_1(STAT, jmi_real_t, jmi_array_t, tmp_2, 2, 1, 2)
    jmi_array_ref_1(tmp_2, 1) = AD_WRAP_LITERAL(3.0);
    jmi_array_ref_1(tmp_2, 2) = AD_WRAP_LITERAL(4.0);
    jmi_spatialdist_init(jmi, 0, JMI_FALSE, _time + AD_WRAP_LITERAL(3.0), tmp_1, tmp_2);
    JMI_ARRAY_INIT_1(STAT, jmi_real_t, jmi_array_t, tmp_3, 2, 1, 2)
    jmi_array_ref_1(tmp_3, 1) = AD_WRAP_LITERAL(1.0);
    jmi_array_ref_1(tmp_3, 2) = AD_WRAP_LITERAL(2.0);
    JMI_ARRAY_INIT_1(STAT, jmi_real_t, jmi_array_t, tmp_4, 2, 1, 2)
    jmi_array_ref_1(tmp_4, 1) = AD_WRAP_LITERAL(3.0);
    jmi_array_ref_1(tmp_4, 2) = AD_WRAP_LITERAL(4.0);
    jmi_spatialdist_init(jmi, 1, JMI_FALSE, _time + AD_WRAP_LITERAL(3.0), tmp_3, tmp_4);
    JMI_ARRAY_INIT_1(STAT, jmi_real_t, jmi_array_t, tmp_5, 2, 1, 2)
    ...
    jmi_spatialdist_init(jmi, 2, JMI_TRUE, _time + AD_WRAP_LITERAL(3.0), tmp_5, tmp_6);

    jmi_spatialdist_record_sample(jmi, 0, _time + AD_WRAP_LITERAL(1.0), _time + AD_WRAP_LITERAL(2.0), _time + AD_WRAP_LITERAL(3.0), JMI_TRUE);
    jmi_spatialdist_record_sample(jmi, 1, _time + AD_WRAP_LITERAL(1.0), _time + AD_WRAP_LITERAL(2.0), _time + AD_WRAP_LITERAL(3.0), JMI_FALSE);
    jmi_spatialdist_record_sample(jmi, 2, _time + AD_WRAP_LITERAL(1.0), _time + AD_WRAP_LITERAL(2.0), _time + AD_WRAP_LITERAL(3.0), JMI_TRUE);


int model_ode_initialize_base(jmi_t* jmi) {
    int ef = 0;
    JMI_DYNAMIC_INIT()
    _x1_0 = COND_EXP_EQ(JMI_TRUE, JMI_TRUE, AD_WRAP_LITERAL(3.0), AD_WRAP_LITERAL(4.0));
    _x2_1 = COND_EXP_EQ(JMI_TRUE, JMI_TRUE, AD_WRAP_LITERAL(4.0), AD_WRAP_LITERAL(3.0));
    _x3_2 = COND_EXP_EQ(JMI_FALSE, JMI_TRUE, AD_WRAP_LITERAL(4.0), AD_WRAP_LITERAL(3.0));
    _x4_3 = 0.0;
    JMI_DYNAMIC_FREE()
    return ef;
}
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    JMI_DEF(REA, tmp_8)
    JMI_DEF(REA, tmp_9)
    jmi_spatialdist_evaluate(jmi, 0, &tmp_7, &tmp_8, _time + AD_WRAP_LITERAL(1.0), _time + AD_WRAP_LITERAL(2.0), _time + AD_WRAP_LITERAL(3.0), JMI_TRUE);
    _x1_0 = (tmp_7);
    _x2_1 = (tmp_8);
    jmi_spatialdist_evaluate(jmi, 1, NULL, &tmp_9, _time + AD_WRAP_LITERAL(1.0), _time + AD_WRAP_LITERAL(2.0), _time + AD_WRAP_LITERAL(3.0), JMI_FALSE);
    _x3_2 = (tmp_9);
    _x4_3 = (jmi_spatialdist_evaluate(jmi, 2, NULL, NULL, _time + AD_WRAP_LITERAL(1.0), _time + AD_WRAP_LITERAL(2.0), _time + AD_WRAP_LITERAL(3.0), JMI_TRUE));
    JMI_DYNAMIC_FREE()
    return ef;
}
    ...
    int ef = 0;
    JMI_DYNAMIC_INIT()
    ef = jmi_spatialdist_event_indicator(jmi, 0, _time + AD_WRAP_LITERAL(3.0), JMI_TRUE, &(*res)[0]);
    ef = jmi_spatialdist_event_indicator(jmi, 1, _time + AD_WRAP_LITERAL(3.0), JMI_FALSE, &(*res)[1]);
    JMI_DYNAMIC_FREE()
    return ef;
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            jmi_spatialdist_evaluate(jmi, 0, &tmp_1, &tmp_2, _x1_0, _x2_1, _time + AD_WRAP_LITERAL(3.0), JMI_TRUE);
            (*res)[0] = tmp_1 - (_x3_2);
            (*res)[1] = tmp_2 - (_x4_3);
        }
    }
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    if (jmi_dynamic_state_check_is_state(jmi, 0, 6, 4)) {
        _a3_2 = __ds_1_s1_5;
        _a1_0 = __ds_1_s2_6;
        _a2_1 = jmi_divide_equation(jmi, 1.0, (_a1_0 * _a3_2), \"1 / (ds(1, a1) * ds(1, a3))\");
        __ds_1_a1_4 = _a2_1;
    } else if (jmi_dynamic_state_check_is_state(jmi, 0, 5, 4)) {
        _a2_1 = __ds_1_s1_5;
        _a1_0 = __ds_1_s2_6;
        _a3_2 = jmi_divide_equation(jmi, 1.0, (_a1_0 * _a2_1), \"1 / (ds(1, a1) * ds(1, a2))\");
        __ds_1_a1_4 = _a3_2;
    } else if (jmi_dynamic_state_check_is_state(jmi, 0, 5, 6)) {
        _a2_1 = __ds_1_s1_5;
        _a3_2 = __ds_1_s2_6;
        _a1_0 = jmi_divide_equation(jmi, 1.0, (_a2_1 * _a3_2), \"1 / (ds(1, a2) * ds(1, a3))\");
        __ds_1_a1_4 = _a1_0;
    }
    ef |= jmi_solve_block_residual(jmi->dae_block_residuals[0]);
    if (jmi_dynamic_state_check_is_state(jmi, 0, 6, 4)) {
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        _a3_2 = - (1.0 * (_a1_0) * (_a1_0)) + (- (1.0 * (_a2_1) * (_a2_1))) + 1.0;
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
...
static int dae_block_1(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        _a1_0 = - (1.0 * (_a2_1) * (_a2_1)) + (- (1.0 * (_a3_2) * (_a3_2))) + 1.0;
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
...
static int dae_block_3(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        _der_a3_10 = - 2.0 * _a1_0 * _der_a1_8 + (- 2.0 * _a2_1 * _der_a2_9);
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = _der_a1_8 - (_der_a2_9 + _der_a3_10);
            (*res)[1] = 0 - (_der_a1_8 + 2.0 * _a2_1 * _der_a2_9 + 2.0 * _a3_2 * _der_a3_10);
        }
    }
    JMI_DYNAMIC_FREE()
    return ef;
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    if (jmi_dynamic_state_check_is_state(jmi, 0, 14)) {
        ...
        _der_x_17 = jmi_divide_equation(jmi, (- 2.0 * _y_3 * _der_y_18), (2.0 * _x_2), \"(- 2 * ds(2, y) * dynDer(y)) / (2 * ds(2, x))\");
        __der_x_9 = _der_x_17;
        __ds_1_a1_11 = __der_x_9;
    } else if (jmi_dynamic_state_check_is_state(jmi, 0, 13)) {
        __der_x_9 = __ds_1_s1_12;
        _der_x_17 = __der_x_9;
        _der_y_18 = jmi_divide_equation(jmi, (- 2.0 * _x_2 * _der_x_17), (2.0 * _y_3), \"(- 2 * ds(2, x) * dynDer(x)) / (2 * ds(2, y))\");
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        (*res)[0] = jmi_max(jmi_max(AD_WRAP_LITERAL(1.0), AD_WRAP_LITERAL(1.0)), jmi_abs(_L_0));
    } else if (evaluation_mode == JMI_BLOCK_INITIALIZE) {
        x[0] = _y_3;
    } else if (evaluation_mode & JMI_BLOCK_EVALUATE || evaluation_mode & JMI_BLOCK_WRITE_BACK) {
        if ((evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) == 0) {
...
static int dae_block_2(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = 0.0 - (2.0 * _x_2 * _der__der_x_19 + 2.0 * _der_x_17 * _der_x_17 + (2.0 * _y_3 * _der__der_y_20 + 2.0 * _der_y_18 * _der_y_18));
        }
    }
    JMI_DYNAMIC_FREE()
    return ef;
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        _a9_8 = _a1_0 * _a2_1 - 1.0 - _a5_4 - (_a7_6 + 1.0);
        _a8_7 = _a6_5 - _time;
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = _a6_5 + _a8_7 + _a9_8 + 4.0 - (_a3_2 * _a4_3 + 1.0);
            (*res)[1] = _a5_4 + _a7_6 + _a9_8 + 2.0 - (_a3_2 * _a4_3 - 1.0);
            (*res)[2] = _a6_5 + _a8_7 + _a9_8 + 3.0 - (_a1_0 * _a2_1 + 1.0);
        }
    }
    JMI_DYNAMIC_FREE()
    return ef;
...
model ForOfUnknownSize1
    ...
    annotation(__JModelica(UnitTesting(tests={
        CCodeGenTestCase(
            ...
            template="$C_functions$",
            generatedCode="
void func_CCodeGenTests_ForOfUnknownSize1_f_def0(jmi_array_t* y_a, jmi_real_t* x_o) {
    JMI_DYNAMIC_INIT()
    JMI_DEF(REA, x_v)
    jmi_real_t v_0i;
    int v_0ii;
...
jmi_real_t func_CCodeGenTests_ForOfUnknownSize1_f_exp0(jmi_array_t* y_a) {
    JMI_DEF(REA, x_v)
...
jmi_real_t func_CCodeGenTests_ForOfUnknownSize2_f_exp0(jmi_real_t n_v) {
    JMI_DEF(REA, x_v)
...
void func_CCodeGenTests_ForOfUnknownSize3_f_def0(jmi_real_t n_v, jmi_real_t* x_o) {
    ...
    int i_1ii;
    x_v = 0;
    JMI_ARRAY_INIT_1(DYNA, jmi_real_t, jmi_array_t, temp_1_a, jmi_max(n_v, AD_WRAP_LITERAL(0.0)), 1, jmi_max(n_v, AD_WRAP_LITERAL(0.0)))
    i1_0ie = jmi_max(n_v, AD_WRAP_LITERAL(0.0)) + 1 / 2.0;
    for (i1_0i = 1.0; i1_0i < i1_0ie; i1_0i += 1) {
...
jmi_real_t func_CCodeGenTests_ForOfUnknownSize3_f_exp0(jmi_real_t n_v) {
    JMI_DEF(REA, x_v)
