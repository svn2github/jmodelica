...
model IfEq22
 annotation(JModelica(unitTesting = JModelica.UnitTesting(testCase={
     JModelica.UnitTesting.TransformCanonicalTestCase(
         ...
         flatModel="
fclass TransformCanonicalTests.IfEq22
 discrete Boolean b;
...
equation
 ...
 ({temp_1[1],temp_1[2]}) = TransformCanonicalTests.IfEq22.f({1,2});
 b = true;

 function TransformCanonicalTests.IfEq22.f
  input Real[2] u;
  output Real[2] y;
 algorithm
  u[1] := ( 2 ) * ( y[1] );
  u[2] := ( 2 ) * ( y[2] );
  return;
 end TransformCanonicalTests.IfEq22.f;
end TransformCanonicalTests.IfEq22;
")})));
