...
public class IDEConstants {
	...
	public static final String CONTENT_TYPE_ID = PLUGIN_ID
			+ ".content.modelica";
	...
	public static final String ERROR_MARKER_SYNTACTIC_ID = ERROR_MARKER_ID
			+ ".syntactic";
	public static final String ERROR_MARKER_SEMANTIC_ID = ERROR_MARKER_ID
			+ ".semantic";
	public static final String ERROR_MARKER_WARNING_ID = ERROR_MARKER_ID
			+ ".warning";
	...
	public static final String ACTION_COLLAPSE_ALL_ID = ACTION_ID
			+ ".collapse-all";
	public static final String ACTION_ERROR_CHECK_ID = ACTION_ID
			+ ".error.check";
	public static final String COMMAND_ERROR_CHECK_ID = "JModelicaIDE.ErrorCheckCommand";
	public static final String ACTION_COMPILE_FMU_ID = ACTION_ID
			+ ".compile.fmu";
	public static final String COMMAND_COMPILE_FMU_ID = COMMAND_ID
			+ ".compile.fmu";
	public static final String ACTION_TOGGLE_ANNOTATIONS_ID = ACTION_ID
			+ ".annotation";
	public static final String ACTION_FORMAT_REGION_ID = ACTION_ID
			+ ".format-region";
	public static final String ACTION_TOGGLE_COMMENT_ID = ACTION_ID
			+ ".toggle-comment";
	public static final String ACTION_FOLLOW_REFERENCE_ID = ACTION_ID
			+ ".gotodecl";

	public static final String ACTION_CLASS_TEXT = "%s \n(Select a class to %s in the Class Outline view.)";
	public static final String ACTION_ERROR_CHECK_TEXT = String.format(
			ACTION_CLASS_TEXT, "Check for &errors", "check");
	public static final String ACTION_COMPILE_FMU_TEXT = String.format(
			ACTION_CLASS_TEXT, "&Compile to FMU", "compile");
	...
	public static final String KEY_BRACE_MATCHING = PREFERENCE_ID
			+ ".brace-match";
	public static final String KEY_BRACE_MATCHING_COLOR = KEY_BRACE_MATCHING
			+ ".color";
	...
	public static final String PREFERENCE_ANNO_BG_ID = PREFERENCE_COLOR_PREFIX
			+ "default.anno.bg";
	...
	public static final String[] ALLOWED_SORT_ORDERS = new String[] {
			SORT_ALPHA, SORT_DECLARED };
	...
	public static final String INSTANCE_OUTLINE_VIEW_ID = OUTLINE_ID
			+ ".instance";
	...
	static {
		...
		String[] b = new String[] { IDocument.DEFAULT_CONTENT_TYPE,
				CONTENT_TYPE_ID };
	...
	public static final String PLUGIN_URL_PREFIX = "platform:/plugin/"
			+ PLUGIN_ID;
	...
	public static final String DEF_OPTIONS_PATH = "/resources/"
			+ DEF_OPTIONS_NAME;
	public static final String DEF_OPTIONS_URL = PLUGIN_URL_PREFIX
			+ DEF_OPTIONS_PATH;
