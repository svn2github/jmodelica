...
public class LoadedLibraries implements ICachedOutlineNode {
	...
	private AbstractOutlineCache cache;
	...
	@Override
	public AbstractOutlineCache getCache() {
		return cache;
	}

	@Override
	public void setCache(AbstractOutlineCache cache) {
		this.cache = cache;
	}
	...
	public void setASTPath(Stack<String> path) {
		astPath = path;
	}
}