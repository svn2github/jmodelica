...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    tmp_2->y1 = tmp_3;
    tmp_1->r2 = tmp_2;
    func_VariabilityPropagationTests_PartiallyKnownComposite8_f_def0(AD_WRAP_LITERAL(1.0), _time, tmp_1);
    _r_y2_2 = (tmp_1->y2);
    JMI_DYNAMIC_FREE()
    return ef;
}
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    tmp_1->z = tmp_2;
    func_VariabilityPropagationTests_PartiallyKnownComposite11_f_def0(_time, AD_WRAP_LITERAL(3.0), tmp_1);
    _r_x_0 = (tmp_1->x);
    JMI_DYNAMIC_FREE()
    return ef;
}
