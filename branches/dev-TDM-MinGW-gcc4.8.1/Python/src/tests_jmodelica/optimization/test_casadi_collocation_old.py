...
class TestLocalDAECollocatorOld:
    
    """
    Tests pyjmi.optimization.casadi_collocation.LocalDAECollocatorOld.
    ...
    def setUp(self):
        ...
        self.algorithm = "LocalDAECollocationAlgOld"
    ...
    def test_init_traj_sim(self):
        ...
        col = LocalDAECollocatorOld(model_opt, opts)
