...
package FSubscriptedExp
    ...
    jmi_ad_var_t v_3;
    jmi_ad_var_t v_4;
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_0, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_0, 2, 1)
    jmi_real_t** dz = jmi->dz;
    /*********** ODE section ***********/
    /*********** Real outputs **********/
    /*** Integer and boolean outputs ***/
    ...
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_0, 2, 1, 2)
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_0, 2, 1, 2)
...
void func_CADCodeGenTests_CADFunction8_f2_der_AD0(jmi_array_t* x_var_a, jmi_array_t* x_der_a, jmi_array_t* y_var_a, jmi_array_t* y_der_a) {
    JMI_DYNAMIC_INIT()
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, y_var_an, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, y_der_an, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, temp_1_var_a, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, temp_1_der_a, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, temp_2_var_a, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, temp_2_der_a, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, temp_3_var_a, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, temp_3_der_a, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, temp_4_var_a, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, temp_4_der_a, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_0, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_0, 2, 1)
    if (y_var_a == NULL) {
        JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, y_var_an, 2, 1, 2)
        y_var_a = y_var_an;
    }
    if (y_der_a == NULL) {
        JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, y_der_an, 2, 1, 2)
        y_der_a = y_der_an;
    }
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, temp_1_var_a, 2, 1, 2)
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, temp_1_der_a, 2, 1, 2)
    func_CADCodeGenTests_CADFunction8_f1_der_AD1(x_var_a, x_der_a, temp_1_var_a, temp_1_der_a);
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, temp_2_var_a, 2, 1, 2)
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, temp_2_der_a, 2, 1, 2)
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_0, 2, 1, 2)
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_0, 2, 1, 2)
    ...
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, temp_3_var_a, 2, 1, 2)
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, temp_3_der_a, 2, 1, 2)
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, temp_4_var_a, 2, 1, 2)
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, temp_4_der_a, 2, 1, 2)
...
void func_CADCodeGenTests_CADFunction8_f1_der_AD1(jmi_array_t* x_var_a, jmi_array_t* x_der_a, jmi_array_t* y_var_a, jmi_array_t* y_der_a) {
    ...
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_1, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_1, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_2, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_2, 2, 1)
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_1, 2, 1, 2)
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_1, 2, 1, 2)
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_2, 2, 1, 2)
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_2, 2, 1, 2)
...
void func_CADCodeGenTests_CADFunction9_f1_der_AD1(jmi_array_t* x_var_a, jmi_array_t* x_der_a, jmi_ad_var_t* y1_var_o, jmi_ad_var_t* y2_var_o, jmi_ad_var_t* y1_der_o, jmi_ad_var_t* y2_der_o) {
    ...
    JMI_DEF(REA, y2_var_v)
    JMI_DEF(REA, y2_der_v)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_a, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_a, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, temp_1_var_a, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, temp_1_der_a, 2, 1)
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_a, 2, 1, 2)
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_a, 2, 1, 2)
...
model CADFunction10
    ...
    annotation(__JModelica(UnitTesting(tests={
        CADCodeGenTestCase(
            ...
            generatedCode="
void func_CADCodeGenTests_CADFunction10_F1_der_AD0(jmi_ad_var_t x_var_v, jmi_ad_var_t x_der_v, jmi_ad_var_t* y_var_o, jmi_ad_var_t* y_der_o) {
    JMI_DYNAMIC_INIT()
    JMI_DEF(REA, y_var_v)
    JMI_DEF(REA, y_der_v)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, m_var_a, 8, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, m_der_a, 8, 1)
    jmi_ad_var_t v_0;
    jmi_ad_var_t i_0i;
    jmi_ad_var_t i_0ie;
    jmi_ad_var_t v_1;
    ...
    jmi_ad_var_t v_2;
    jmi_ad_var_t d_2;
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, m_var_a, 8, 1, 8)
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, m_der_a, 8, 1, 8)
...
void func_CADCodeGenTests_CADFunction11_F2_der_AD2(jmi_array_t* X_var_a, jmi_array_t* MMX_var_a, jmi_array_t* X_der_a, jmi_array_t* MMX_der_a, jmi_array_t* moleFractions_var_a, jmi_array_t* moleFractions_der_a) {
    JMI_DYNAMIC_INIT()
    jmi_ad_var_t v_2;
    JMI_ARR(DYNA, jmi_ad_var_t, jmi_array_t, moleFractions_var_an, -1, 1)
    JMI_ARR(DYNA, jmi_ad_var_t, jmi_array_t, moleFractions_der_an, -1, 1)
    jmi_ad_var_t v_3;
    jmi_ad_var_t i_1i;
    jmi_ad_var_t i_1ie;
    if (moleFractions_var_a == NULL) {
        v_2 = jmi_array_size(X_var_a, 0);
        JMI_ARRAY_INIT_1(DYNA, jmi_ad_var_t, jmi_array_t, moleFractions_var_an, v_2, 1, jmi_array_size(X_var_a, 0))
        moleFractions_var_a = moleFractions_var_an;
    }
    if (moleFractions_der_a == NULL) {
        v_2 = jmi_array_size(X_var_a, 0);
        JMI_ARRAY_INIT_1(DYNA, jmi_ad_var_t, jmi_array_t, moleFractions_der_an, v_2, 1, jmi_array_size(X_var_a, 0))
...
void func_CADCodeGenTests_FunctionUnknownArraySizeTest1_F_der_AD0(jmi_array_t* x_var_a, jmi_array_t* x_der_a, jmi_ad_var_t* y_var_o, jmi_ad_var_t* y_der_o) {
    ...
    JMI_DEF(REA, y_der_v)
    jmi_ad_var_t v_0;
    JMI_ARR(DYNA, jmi_ad_var_t, jmi_array_t, t_var_a, -1, 1)
    JMI_ARR(DYNA, jmi_ad_var_t, jmi_array_t, t_der_a, -1, 1)
    ...
    JMI_ARRAY_INIT_1(DYNA, jmi_ad_var_t, jmi_array_t, t_var_a, v_0, 1, jmi_array_size(x_var_a, 0))
    v_0 = jmi_array_size(x_var_a, 0);
    JMI_ARRAY_INIT_1(DYNA, jmi_ad_var_t, jmi_array_t, t_der_a, v_0, 1, jmi_array_size(x_var_a, 0))
    v_1 = jmi_array_size(x_var_a, 0);
    i1_0ie = v_1 + 1 / 2.0;
...
void func_CADCodeGenTests_FunctionUnknownArraySizeTest2_F1_der_AD0(jmi_array_t* x_var_a, jmi_ad_var_t num_v, jmi_array_t* x_der_a, jmi_array_t* y_var_a, jmi_array_t* y_der_a) {
    ...
    jmi_ad_var_t v_0;
    jmi_ad_var_t v_1;
    JMI_ARR(DYNA, jmi_ad_var_t, jmi_array_t, y_var_an, -1, 1)
    JMI_ARR(DYNA, jmi_ad_var_t, jmi_array_t, y_der_an, -1, 1)
    jmi_ad_var_t v_2;
    jmi_ad_var_t i_0i;
    jmi_ad_var_t i_0ie;
    if (y_var_a == NULL) {
        v_1 = num_v * num_v;
        v_0 = 2 + v_1;
        JMI_ARRAY_INIT_1(DYNA, jmi_ad_var_t, jmi_array_t, y_var_an, (v_0), 1, 2 + v_1)
        y_var_a = y_var_an;
    }
    if (y_der_a == NULL) {
        v_1 = num_v * num_v;
        v_0 = 2 + v_1;
        JMI_ARRAY_INIT_1(DYNA, jmi_ad_var_t, jmi_array_t, y_der_an, (v_0), 1, 2 + v_1)
        y_der_a = y_der_an;
    }
...
void func_CADCodeGenTests_CADForStmtTest1_f_der_AD0(jmi_ad_var_t x_var_v, jmi_ad_var_t n_v, jmi_ad_var_t x_der_v, jmi_ad_var_t* y_var_o, jmi_ad_var_t* y_der_o) {
    ...
    JMI_DEF(REA, y_var_v)
    JMI_DEF(REA, y_der_v)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, temp_1_var_a, 3, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, temp_1_der_a, 3, 1)
    jmi_ad_var_t i_0i;
    int i_0ii;
    jmi_ad_var_t v_0;
    jmi_ad_var_t d_0;
    ...
    jmi_ad_var_t d_1;
    jmi_ad_var_t v_2;
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, temp_1_var_a, 3, 1, 3)
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, temp_1_der_a, 3, 1, 3)
...
static int dae_block_dir_der_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* dx,jmi_real_t* residual, jmi_real_t* dRes, int evaluation_mode) {
    ...
    func_CADCodeGenTests_CADRes5_F_der_AD0(_x_0, AD_WRAP_LITERAL(2), (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx], AD_WRAP_LITERAL(0), tmp_var_0, tmp_der_0);
    _y_a2_2 = tmp_var_0->a2;
    (*dz)[jmi_get_index_from_value_ref(2)-jmi->offs_real_dx] = tmp_der_0->a2;
    if (evaluation_mode == JMI_BLOCK_EVALUATE_INACTIVE || evaluation_mode == JMI_BLOCK_EVALUATE) {
        (*res)[0] = 2.0 + _y_a2_2 - (_x_0);
        (*dF)[0] = AD_WRAP_LITERAL(0) + (*dz)[jmi_get_index_from_value_ref(2)-jmi->offs_real_dx] - ((*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx]);
        (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx] = 0;
    }
        JMI_DYNAMIC_FREE()
    return ef;
...
static int dae_block_dir_der_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* dx,jmi_real_t* residual, jmi_real_t* dRes, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_EVALUATE_INACTIVE || evaluation_mode == JMI_BLOCK_EVALUATE) {
        func_CADCodeGenTests_CADRes6_F1_der_AD1(_x_0, AD_WRAP_LITERAL(2), (*dz)[jmi_get_index_from_value_ref(0)-jmi->offs_real_dx], AD_WRAP_LITERAL(0), tmp_var_0, tmp_der_0);
...
/******** Declarations *******/
    ...
    d_6 = AD_WRAP_LITERAL(0) * _w_ode_1_2_2 + -2.51 * (*dz)[jmi_get_index_from_value_ref(6)-jmi->offs_real_dx];
    ...
    d_1 = d_2 + d_5;
    v_10 = 2.15 * _x_1_0;
    d_10 = AD_WRAP_LITERAL(0) * _x_1_0 + 2.15 * (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx];
    v_11 = sin(_x_1_0);
    d_11 = (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx] * cos(_x_1_0);
    v_9 = v_10 + v_11;
    d_9 = d_10 + d_11;
    v_13 = 2.19 * _x_1_0;
    d_13 = AD_WRAP_LITERAL(0) * _x_1_0 + 2.19 * (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx];
    v_12 = (- v_13);
    d_12 = - (d_13);
    v_8 = (v_9 + v_12);
    d_8 = d_9 + d_12;
    ...
    d_17 = - (d_18);
    v_20 = -2.89 * _x_1_0;
    d_20 = AD_WRAP_LITERAL(0) * _x_1_0 + -2.89 * (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx];
    v_19 = (- v_20);
    d_19 = - (d_20);
    v_16 = v_17 + v_19;
    d_16 = d_17 + d_19;
    v_22 = 2.99 * _ur_1_3;
    d_22 = AD_WRAP_LITERAL(0) * _ur_1_3 + 2.99 * (*dz)[jmi_get_index_from_value_ref(2)-jmi->offs_real_dx];
    v_23 = sin(_ur_1_3);
...
static int dae_block_dir_der_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* dx,jmi_real_t* residual, jmi_real_t* dRes, int evaluation_mode) {
    ...
    d_34 = AD_WRAP_LITERAL(0) * _w_ode_1_2_2 + 1.3 * (*dz)[jmi_get_index_from_value_ref(6)-jmi->offs_real_dx];
    v_33 = - v_34;
    d_33 = - (d_34);
    ...
    d_32 = d_33 + d_35;
    v_38 = -2.01 * _x_1_0;
    d_38 = AD_WRAP_LITERAL(0) * _x_1_0 + -2.01 * (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx];
    v_37 = (- v_38);
    d_37 = - (d_38);
    v_31 = v_32 + v_37;
    d_31 = d_32 + d_37;
    ...
    d_41 = - (d_42);
    v_44 = -1.18 * _x_1_0;
    d_44 = AD_WRAP_LITERAL(0) * _x_1_0 + -1.18 * (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx];
    v_43 = (- v_44);
    d_43 = - (d_44);
    v_40 = v_41 + v_43;
    d_40 = d_41 + d_43;
    v_46 = 1.45 * _x_1_0;
    d_46 = AD_WRAP_LITERAL(0) * _x_1_0 + 1.45 * (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx];
    v_45 = (- v_46);
    d_45 = - (d_46);
    v_39 = (v_40 + v_45);
    d_39 = d_40 + d_45;
    ...
    d_30 = d_31 + d_39;
    v_51 = 1.09 * _ur_2_4;
    d_51 = AD_WRAP_LITERAL(0) * _ur_2_4 + 1.09 * (*dz)[jmi_get_index_from_value_ref(3)-jmi->offs_real_dx];
    v_50 = - v_51;
    d_50 = - (d_51);
    v_53 = sin(_ur_2_4);
    ...
    d_49 = d_50 + d_52;
    v_55 = -1.24 * _ur_2_4;
    d_55 = AD_WRAP_LITERAL(0) * _ur_2_4 + -1.24 * (*dz)[jmi_get_index_from_value_ref(3)-jmi->offs_real_dx];
    v_54 = (- v_55);
    d_54 = - (d_55);
    v_48 = v_49 + v_54;
    d_48 = d_49 + d_54;
...
static int dae_block_dir_der_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* dx,jmi_real_t* residual, jmi_real_t* dRes, int evaluation_mode) {
    /***** Block: 1 *****/
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_0, 4, 2)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_0, 4, 2)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_1, 4, 2)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_1, 4, 2)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_2, 4, 2)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_2, 4, 2)
    jmi_real_t** res = &residual;
    int ef = 0;
    JMI_DYNAMIC_INIT()
    jmi_real_t** dF = &dRes;
    ...
    if (evaluation_mode == JMI_BLOCK_EVALUATE_INACTIVE || evaluation_mode == JMI_BLOCK_EVALUATE) {
        JMI_ARRAY_INIT_2(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_0, 4, 2, 2, 2)
        JMI_ARRAY_INIT_2(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_0, 4, 2, 2, 2)
        JMI_ARRAY_INIT_2(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_1, 4, 2, 2, 2)
        JMI_ARRAY_INIT_2(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_1, 4, 2, 2, 2)
        ...
        JMI_ARRAY_INIT_2(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_2, 4, 2, 2, 2)
        JMI_ARRAY_INIT_2(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_2, 4, 2, 2, 2)
...
void func_CADCodeGenTests_CADArray1_f_der_AD0(jmi_array_t* A_var_a, jmi_array_t* X_var_a, jmi_array_t* A_der_a, jmi_array_t* X_der_a, jmi_array_t* B_var_a, jmi_array_t* B_der_a) {
    JMI_DYNAMIC_INIT()
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, B_var_an, 4, 2)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, B_der_an, 4, 2)
    if (B_var_a == NULL) {
        JMI_ARRAY_INIT_2(STAT, jmi_ad_var_t, jmi_array_t, B_var_an, 4, 2, 2, 2)
        B_var_a = B_var_an;
    }
    if (B_der_a == NULL) {
        JMI_ARRAY_INIT_2(STAT, jmi_ad_var_t, jmi_array_t, B_der_an, 4, 2, 2, 2)
        B_der_a = B_der_an;
    }
...
equation
    ...
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_2, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_2, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_3, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_3, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_4, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_4, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_5, 2, 1)
    JMI_ARR(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_5, 2, 1)
    if (_sw(0)) {
        JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_0, 2, 1, 2)
        JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_0, 2, 1, 2)
        JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_1, 2, 1, 2)
        ...
        JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_3, 2, 1, 2)
        JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_3, 2, 1, 2)
        JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_4, 2, 1, 2)
        JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_4, 2, 1, 2)
        JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_var_5, 2, 1, 2)
        JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_der_5, 2, 1, 2)
