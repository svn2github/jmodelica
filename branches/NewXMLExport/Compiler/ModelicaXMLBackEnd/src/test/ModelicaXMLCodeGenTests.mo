...
initial algorithm
    ...
    annotation(__JModelica(UnitTesting(tests={
        ModelicaXMLCodeGenTestCase(
            name="TestInitialAlgorithm",
            description="Test declaration of initial algorithm section",
            template="",
            generatedCode="<?xml version=\"1.0\" encoding=\"UTF-8\"?>
<class kind=\"model\">
	...
	<algorithm kind=\"initial\">
			<operator name=\"assert\">
				<local name=\"p\"/>
				<string value=\"p should not be false\"/>
			</operator>
	</algorithm>
