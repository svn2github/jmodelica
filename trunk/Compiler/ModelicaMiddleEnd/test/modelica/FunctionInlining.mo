...
equation
 x1 = ((_stream_s_1 * max(- a2.c[1].f, 0) + (1 - _stream_s_1) * _inStreamEpsilon) * 4.0 + (_stream_s_1 * max(- a3.c[1].f, 0) + (1 - _stream_s_1) * _inStreamEpsilon) * 5.0) / (_stream_s_1 * max(- a2.c[1].f, 0) + (1 - _stream_s_1) * _inStreamEpsilon + (_stream_s_1 * max(- a3.c[1].f, 0) + (1 - _stream_s_1) * _inStreamEpsilon));
