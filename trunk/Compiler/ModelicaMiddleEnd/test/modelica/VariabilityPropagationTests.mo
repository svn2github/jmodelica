...
model IfMinMax1
    Real x(min=0) = 2 * time;
    Real y(max=0) = -time;
    Real z = if x >= y then time + 1 else 2;

    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            name="IfMinMax1",
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax1
 Real x(min = 0);
 Real y(max = 0);
 Real z;
equation
 ...
 y = 1 / -2 * x;
 z = time + 1;
end VariabilityPropagationTests.IfMinMax1;
")})));
end IfMinMax1;
...
model IfMinMax2
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax2
 Real x(max = 0);
 Real y(min = 2);
 constant Real z = 2;
equation
 x = - time;
 y = time + 2;
end VariabilityPropagationTests.IfMinMax2;
")})));
end IfMinMax2;
...
model IfMinMax3
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax3
 Real x(max = 0);
 Real y(min = 0);
 Real z;
equation
 x = - time;
 y = -2 * x;
 z = if x >= y then time + 1 else 2;
end VariabilityPropagationTests.IfMinMax3;
")})));
end IfMinMax3;
...
model IfMinMax4
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax4
 Real x(min = 2);
 Real y(max = 0);
 Real z;
equation
 ...
 y = - time;
 z = x + -1;
end VariabilityPropagationTests.IfMinMax4;
")})));
end IfMinMax4;
...
model IfMinMax5
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax5
 Real x(max = 0);
 Real y(min = 0);
 constant Real z = 2;
equation
 x = - time;
 y = -2 * x;
end VariabilityPropagationTests.IfMinMax5;
")})));
end IfMinMax5;
...
model IfMinMax6
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax6
 Real x(min = 0);
 Real y(max = 0);
 Real z;
equation
 ...
 y = 1 / -2 * x;
 z = if x > y then time + 1 else 2;
end VariabilityPropagationTests.IfMinMax6;
")})));
end IfMinMax6;
...
model IfMinMax7
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax7
 Real x(max = 0);
 Real y(min = 0);
 Real z;
equation
 ...
 y = -2 * x;
 z = time + 1;
end VariabilityPropagationTests.IfMinMax7;
")})));
end IfMinMax7;
...
model IfMinMax8
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax8
 Real x(min = 2);
 Real y(max = 0);
 constant Real z = 2;
equation
 x = time + 2;
 y = - time;
end VariabilityPropagationTests.IfMinMax8;
")})));
end IfMinMax8;
...
model IfMinMax9
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax9
 Real x(min = 0);
 Real y(max = 0);
 Real z;
equation
 ...
 y = 1 / -2 * x;
 z = if x <= y then time + 1 else 2;
end VariabilityPropagationTests.IfMinMax9;
")})));
end IfMinMax9;
...
model IfMinMax10
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax10
 Real x(max = 0);
 Real y(min = 2);
 Real z;
equation
 ...
 y = time + 2;
 z = y + -1;
end VariabilityPropagationTests.IfMinMax10;
")})));
end IfMinMax10;
...
model IfMinMax11
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax11
 Real x(min = 0);
 Real y(max = 0);
 constant Real z = 2;
equation
 x = 2 * time;
 y = 1 / -2 * x;
end VariabilityPropagationTests.IfMinMax11;
")})));
end IfMinMax11;
...
model IfMinMax12
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax12
 Real x(min = 0);
 Real y(max = 2);
 Real z;
equation
 ...
 y = - time + 2;
 z = if x < y then time + 1 else 2;
end VariabilityPropagationTests.IfMinMax12;
")})));
end IfMinMax12;


model IfMinMax13
    Integer x(min=0) = integer(2 * time);
    Integer y(max=0) = -integer(time);
    Real z = if x <> y then time + 1 else 2;
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax13
 discrete Integer x(min = 0);
 discrete Integer y(max = 0);
 Real z;
initial equation
 - pre(y) = 0;
 pre(x) = 0;
equation
 z = if x <> y then time + 1 else 2;
 - y = if time < - pre(y) or time >= - pre(y) + 1 or initial() then integer(time) else - pre(y);
 x = if 2 * time < pre(x) or 2 * time >= pre(x) + 1 or initial() then integer(2 * time) else pre(x);
end VariabilityPropagationTests.IfMinMax13;
")})));
end IfMinMax13;


model IfMinMax14
    Integer x(max=2) = -integer(time) + 2;
    Integer y(min=0) = integer(time);
    Real z = if x <> y then time + 1 else 2;
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax14
 discrete Integer x(max = 2);
 discrete Integer y(min = 0);
 Real z;
...
end VariabilityPropagationTests.IfMinMax14;
")})));
end IfMinMax14;


model IfMinMax15
    Integer x(min=2) = integer(time) + 2;
    Integer y(max=0) = -integer(time);
    Real z = if x <> y then time + 1 else 2;
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax15
 discrete Integer x(min = 2);
 discrete Integer y(max = 0);
 Real z;
 discrete Integer temp_2;
initial equation
...
equation
 ...
 - y = if time < - pre(y) or time >= - pre(y) + 1 or initial() then integer(time) else - pre(y);
 temp_2 = if time < pre(temp_2) or time >= pre(temp_2) + 1 or initial() then integer(time) else pre(temp_2);
end VariabilityPropagationTests.IfMinMax15;
")})));
end IfMinMax15;


model IfMinMax16
    Integer x(max=0) = -integer(time);
    Integer y(min=2) = integer(time) + 2;
    Real z = if x <> y then time + 1 else 2;
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax16
 discrete Integer x(max = 0);
 discrete Integer y(min = 2);
 Real z;
...
equation
 ...
 - x = if time < - pre(x) or time >= - pre(x) + 1 or initial() then integer(time) else - pre(x);
end VariabilityPropagationTests.IfMinMax16;
")})));
end IfMinMax16;
...
model IfMinMax17
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax17
 discrete Integer x(min = 0);
 discrete Integer y(max = 0);
 Real z;
initial equation
...
equation
 ...
 - y = if time < - pre(y) or time >= - pre(y) + 1 or initial() then integer(time) else - pre(y);
 x = if 2 * time < pre(x) or 2 * time >= pre(x) + 1 or initial() then integer(2 * time) else pre(x);
end VariabilityPropagationTests.IfMinMax17;
")})));
end IfMinMax17;
...
model IfMinMax18
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax18
 discrete Integer x(max = 2);
 discrete Integer y(min = 0);
 Real z;
 discrete Integer temp_2;
...
equation
 ...
 y = if time < pre(y) or time >= pre(y) + 1 or initial() then integer(time) else pre(y);
 temp_2 = if time < pre(temp_2) or time >= pre(temp_2) + 1 or initial() then integer(time) else pre(temp_2);
end VariabilityPropagationTests.IfMinMax18;
")})));
end IfMinMax18;
...
model IfMinMax19
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax19
 discrete Integer x(min = 2);
 discrete Integer y(max = 0);
 constant Real z = 2;
 discrete Integer temp_2;
...
equation
 ...
 - y = if time < - pre(y) or time >= - pre(y) + 1 or initial() then integer(time) else - pre(y);
 temp_2 = if time < pre(temp_2) or time >= pre(temp_2) + 1 or initial() then integer(time) else pre(temp_2);
end VariabilityPropagationTests.IfMinMax19;
")})));
end IfMinMax19;
...
model IfMinMax20
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax20
 discrete Integer x(max = 0);
 discrete Integer y(min = 2);
 constant Real z = 2;
 discrete Integer temp_1;
...
equation
 ...
 temp_1 = if time < pre(temp_1) or time >= pre(temp_1) + 1 or initial() then integer(time) else pre(temp_1);
 - x = if time < - pre(x) or time >= - pre(x) + 1 or initial() then integer(time) else - pre(x);
end VariabilityPropagationTests.IfMinMax20;
")})));
end IfMinMax20;
...
model IfMinMax21
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax21
 Real x(max = 0);
 Real y(max = 0);
 Real z;
equation
 ...
 y = 1 / -2 * x;
 z = time + 1;
end VariabilityPropagationTests.IfMinMax21;
")})));
end IfMinMax21;
...
model IfMinMax22
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax22
 Real x(min = 0);
 Real y(min = 2);
 constant Real z = 2;
equation
 x = time;
 y = time + 2;
end VariabilityPropagationTests.IfMinMax22;
")})));
end IfMinMax22;
...
model IfMinMax23
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions based on min/max",
            flatModel="
fclass VariabilityPropagationTests.IfMinMax23
 Real x(max = 2);
 Real y(min = 0);
 Real z;
equation
 ...
 y = time;
 z = if - x >= y then time + 1 else 2;
end VariabilityPropagationTests.IfMinMax23;
")})));
end IfMinMax23;


model SemiLinearMinMax1
    Real x1(max=0) = -time;
    Real x2 = x1;
    Real y = 2 * time;
    Real z = 3 * time;
    Real w = semiLinear(x2, y, z);

    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            name="SemiLinearMinMax1",
            description="Evaluation of relation expressions from semiLinear based on min/max",
            flatModel="
fclass VariabilityPropagationTests.SemiLinearMinMax1
 Real x2(max = 0);
 Real y;
 Real z;
 Real w;
equation
 ...
 z = -3 * x2;
 w = x2 * z;
end VariabilityPropagationTests.SemiLinearMinMax1;
")})));
end SemiLinearMinMax1;


model SemiLinearMinMax2
    Real x1(min=0) = time;
    Real x2 = x1;
    Real y = 2 * time;
    Real z = 3 * time;
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            name="SemiLinearMinMax2",
            description="Evaluation of relation expressions from semiLinear based on min/max",
            flatModel="
fclass VariabilityPropagationTests.SemiLinearMinMax2
 Real x2(min = 0);
 Real y;
 Real z;
 Real w;
equation
 ...
 z = 3 * x2;
 w = x2 * y;
end VariabilityPropagationTests.SemiLinearMinMax2;
")})));
end SemiLinearMinMax2;


model SemiLinearMinMax3
    Real x1(max=2) = -time + 2;
    Real x2 = x1;
    Real y = 2 * time;
    Real z = 3 * time;
    Real w = semiLinear(x2, y, z);
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            name="SemiLinearMinMax3",
            description="Evaluation of relation expressions from semiLinear based on min/max",
            flatModel="
fclass VariabilityPropagationTests.SemiLinearMinMax3
 Real x2(max = 2);
 Real y;
 Real z;
 Real w;
equation
 ...
 y = 2 * time;
 z = -3 / -2 * y;
 w = noEvent(if x2 >= 0 then x2 * y else x2 * z);
end VariabilityPropagationTests.SemiLinearMinMax3;
")})));
end SemiLinearMinMax3;
...
model StreamMinMax1
    ...
    M m1(c(p = time ^ 2, f = x, s = time ^ 3)), m2(c(s = time ^4));
    Real x(max = 0) = -time;
    Real y = m1.c.f * actualStream(m1.c.s);
equation
    connect(m1.c, m2.c);
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            name="StreamMinMax1",
            description="Evaluation of relation expressions from actualStream based on min/max",
            flatModel="
fclass VariabilityPropagationTests.StreamMinMax1
 Real m1.c.p;
 Real m1.c.s;
 Real m2.c.s;
 Real x(max = 0);
...
equation
 ...
 x = - time;
 y = x * m1.c.s;
end VariabilityPropagationTests.StreamMinMax1;
")})));
end StreamMinMax1;
...
equation
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions from actualStream based on min/max",
            flatModel="
fclass VariabilityPropagationTests.StreamMinMax2
 Real m1.c.p;
 Real m1.c.s;
 Real m2.c.s;
 Real x(min = 0);
...
equation
 ...
 x = time;
 y = x * m2.c.s;
end VariabilityPropagationTests.StreamMinMax2;
")})));
end StreamMinMax2;
...
equation
    ...
    annotation(__JModelica(UnitTesting(tests={
        TransformCanonicalTestCase(
            ...
            description="Evaluation of relation expressions from actualStream based on min/max",
            flatModel="
fclass VariabilityPropagationTests.StreamMinMax3
 Real m1.c.p;
 Real m1.c.s;
 Real m2.c.s;
 Real x(max = 2);
...
equation
 ...
 m2.c.s = time ^ 4;
 x = - time + 2;
 y = x * smooth(0, if x > 0.0 then m2.c.s else m1.c.s);
end VariabilityPropagationTests.StreamMinMax3;
")})));
end StreamMinMax3;
