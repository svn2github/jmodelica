...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    __stream_s_1_23 = jmi_max(_a_c3_f_7, AD_WRAP_LITERAL(0)) + jmi_max(_a_c2_f_4, AD_WRAP_LITERAL(0));
    __stream_alpha_1_21 = (COND_EXP_EQ(COND_EXP_GT(__stream_s_1_23, jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1), JMI_TRUE, JMI_FALSE), JMI_TRUE, AD_WRAP_LITERAL(1), COND_EXP_EQ(COND_EXP_GT(__stream_s_1_23, AD_WRAP_LITERAL(0), JMI_TRUE, JMI_FALSE), JMI_TRUE, jmi_divide_equation(jmi, __stream_s_1_23,(jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1)),\"_stream_s_1 / (_inStreamEpsilon * 0.1)\") * (jmi_divide_equation(jmi, __stream_s_1_23,(jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1)),\"_stream_s_1 / (_inStreamEpsilon * 0.1)\") * (AD_WRAP_LITERAL(3) - AD_WRAP_LITERAL(2) * __stream_s_1_23)), AD_WRAP_LITERAL(0))));
    _b_c5_s_17 = 5;
    __stream_alpha_2_22 = (COND_EXP_EQ(COND_EXP_GT(__stream_s_1_23, jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1), JMI_TRUE, JMI_FALSE), JMI_TRUE, AD_WRAP_LITERAL(1), COND_EXP_EQ(COND_EXP_GT(__stream_s_1_23, AD_WRAP_LITERAL(0), JMI_TRUE, JMI_FALSE), JMI_TRUE, jmi_divide_equation(jmi, __stream_s_1_23,(jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1)),\"_stream_s_1 / (_inStreamEpsilon * 0.1)\") * (jmi_divide_equation(jmi, __stream_s_1_23,(jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1)),\"_stream_s_1 / (_inStreamEpsilon * 0.1)\") * (AD_WRAP_LITERAL(3) - AD_WRAP_LITERAL(2) * __stream_s_1_23)), AD_WRAP_LITERAL(0))));
    _b_c6_s_20 = 6;
    _a_c1_s_2 = jmi_divide_equation(jmi, ((__stream_alpha_1_21 * jmi_max(_a_c2_f_4, AD_WRAP_LITERAL(0)) + (1 - __stream_alpha_1_21) * (jmi_in_stream_eps(jmi) * 0.1)) * _b_c5_s_17 + (__stream_alpha_2_22 * jmi_max(_a_c3_f_7, AD_WRAP_LITERAL(0)) + (1 - __stream_alpha_2_22) * (jmi_in_stream_eps(jmi) * 0.1)) * _b_c6_s_20),(__stream_alpha_1_21 * jmi_max(_a_c2_f_4, AD_WRAP_LITERAL(0)) + (1 - __stream_alpha_1_21) * (jmi_in_stream_eps(jmi) * 0.1) + (__stream_alpha_2_22 * jmi_max(_a_c3_f_7, AD_WRAP_LITERAL(0)) + (1 - __stream_alpha_2_22) * (jmi_in_stream_eps(jmi) * 0.1))),\"((_stream_alpha_1 * max(a.c2.f, 0) + (1 - _stream_alpha_1) * (_inStreamEpsilon * 0.1)) * b.c5.s + (_stream_alpha_2 * max(a.c3.f, 0) + (1 - _stream_alpha_2) * (_inStreamEpsilon * 0.1)) * b.c6.s) / (_stream_alpha_1 * max(a.c2.f, 0) + (1 - _stream_alpha_1) * (_inStreamEpsilon * 0.1) + (_stream_alpha_2 * max(a.c3.f, 0) + (1 - _stream_alpha_2) * (_inStreamEpsilon * 0.1)))\");
    _a_c2_p_3 = _a_c1_p_0;
    __stream_s_2_26 = jmi_max(_a_c3_f_7, AD_WRAP_LITERAL(0)) + jmi_max(_a_c1_f_1, AD_WRAP_LITERAL(0));
    __stream_alpha_3_24 = (COND_EXP_EQ(COND_EXP_GT(__stream_s_2_26, jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1), JMI_TRUE, JMI_FALSE), JMI_TRUE, AD_WRAP_LITERAL(1), COND_EXP_EQ(COND_EXP_GT(__stream_s_2_26, AD_WRAP_LITERAL(0), JMI_TRUE, JMI_FALSE), JMI_TRUE, jmi_divide_equation(jmi, __stream_s_2_26,(jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1)),\"_stream_s_2 / (_inStreamEpsilon * 0.1)\") * (jmi_divide_equation(jmi, __stream_s_2_26,(jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1)),\"_stream_s_2 / (_inStreamEpsilon * 0.1)\") * (AD_WRAP_LITERAL(3) - AD_WRAP_LITERAL(2) * __stream_s_2_26)), AD_WRAP_LITERAL(0))));
    _b_c4_s_14 = 4;
    __stream_alpha_4_25 = (COND_EXP_EQ(COND_EXP_GT(__stream_s_2_26, jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1), JMI_TRUE, JMI_FALSE), JMI_TRUE, AD_WRAP_LITERAL(1), COND_EXP_EQ(COND_EXP_GT(__stream_s_2_26, AD_WRAP_LITERAL(0), JMI_TRUE, JMI_FALSE), JMI_TRUE, jmi_divide_equation(jmi, __stream_s_2_26,(jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1)),\"_stream_s_2 / (_inStreamEpsilon * 0.1)\") * (jmi_divide_equation(jmi, __stream_s_2_26,(jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1)),\"_stream_s_2 / (_inStreamEpsilon * 0.1)\") * (AD_WRAP_LITERAL(3) - AD_WRAP_LITERAL(2) * __stream_s_2_26)), AD_WRAP_LITERAL(0))));
    _a_c2_s_5 = jmi_divide_equation(jmi, ((__stream_alpha_3_24 * jmi_max(_a_c1_f_1, AD_WRAP_LITERAL(0)) + (1 - __stream_alpha_3_24) * (jmi_in_stream_eps(jmi) * 0.1)) * _b_c4_s_14 + (__stream_alpha_4_25 * jmi_max(_a_c3_f_7, AD_WRAP_LITERAL(0)) + (1 - __stream_alpha_4_25) * (jmi_in_stream_eps(jmi) * 0.1)) * _b_c6_s_20),(__stream_alpha_3_24 * jmi_max(_a_c1_f_1, AD_WRAP_LITERAL(0)) + (1 - __stream_alpha_3_24) * (jmi_in_stream_eps(jmi) * 0.1) + (__stream_alpha_4_25 * jmi_max(_a_c3_f_7, AD_WRAP_LITERAL(0)) + (1 - __stream_alpha_4_25) * (jmi_in_stream_eps(jmi) * 0.1))),\"((_stream_alpha_3 * max(a.c1.f, 0) + (1 - _stream_alpha_3) * (_inStreamEpsilon * 0.1)) * b.c4.s + (_stream_alpha_4 * max(a.c3.f, 0) + (1 - _stream_alpha_4) * (_inStreamEpsilon * 0.1)) * b.c6.s) / (_stream_alpha_3 * max(a.c1.f, 0) + (1 - _stream_alpha_3) * (_inStreamEpsilon * 0.1) + (_stream_alpha_4 * max(a.c3.f, 0) + (1 - _stream_alpha_4) * (_inStreamEpsilon * 0.1)))\");
    _a_c3_p_6 = _a_c2_p_3;
    __stream_s_3_29 = jmi_max(_a_c2_f_4, AD_WRAP_LITERAL(0)) + jmi_max(_a_c1_f_1, AD_WRAP_LITERAL(0));
    ...
    __stream_alpha_6_28 = (COND_EXP_EQ(COND_EXP_GT(__stream_s_3_29, jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1), JMI_TRUE, JMI_FALSE), JMI_TRUE, AD_WRAP_LITERAL(1), COND_EXP_EQ(COND_EXP_GT(__stream_s_3_29, AD_WRAP_LITERAL(0), JMI_TRUE, JMI_FALSE), JMI_TRUE, jmi_divide_equation(jmi, __stream_s_3_29,(jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1)),\"_stream_s_3 / (_inStreamEpsilon * 0.1)\") * (jmi_divide_equation(jmi, __stream_s_3_29,(jmi_in_stream_eps(jmi) * AD_WRAP_LITERAL(0.1)),\"_stream_s_3 / (_inStreamEpsilon * 0.1)\") * (AD_WRAP_LITERAL(3) - AD_WRAP_LITERAL(2) * __stream_s_3_29)), AD_WRAP_LITERAL(0))));
    _a_c3_s_8 = jmi_divide_equation(jmi, ((__stream_alpha_5_27 * jmi_max(_a_c1_f_1, AD_WRAP_LITERAL(0)) + (1 - __stream_alpha_5_27) * (jmi_in_stream_eps(jmi) * 0.1)) * _b_c4_s_14 + (__stream_alpha_6_28 * jmi_max(_a_c2_f_4, AD_WRAP_LITERAL(0)) + (1 - __stream_alpha_6_28) * (jmi_in_stream_eps(jmi) * 0.1)) * _b_c5_s_17),(__stream_alpha_5_27 * jmi_max(_a_c1_f_1, AD_WRAP_LITERAL(0)) + (1 - __stream_alpha_5_27) * (jmi_in_stream_eps(jmi) * 0.1) + (__stream_alpha_6_28 * jmi_max(_a_c2_f_4, AD_WRAP_LITERAL(0)) + (1 - __stream_alpha_6_28) * (jmi_in_stream_eps(jmi) * 0.1))),\"((_stream_alpha_5 * max(a.c1.f, 0) + (1 - _stream_alpha_5) * (_inStreamEpsilon * 0.1)) * b.c4.s + (_stream_alpha_6 * max(a.c2.f, 0) + (1 - _stream_alpha_6) * (_inStreamEpsilon * 0.1)) * b.c5.s) / (_stream_alpha_5 * max(a.c1.f, 0) + (1 - _stream_alpha_5) * (_inStreamEpsilon * 0.1) + (_stream_alpha_6 * max(a.c2.f, 0) + (1 - _stream_alpha_6) * (_inStreamEpsilon * 0.1)))\");
    _a_x1_9 = _b_c4_s_14;
    _a_x2_10 = _b_c5_s_17;
    _a_x3_11 = _b_c6_s_20;
