...
#define _temp_1_2 ((*(jmi->z))[jmi->offs_boolean_d+0])
#define pre_a_0 ((*(jmi->z))[jmi->offs_pre_integer_d+0])
#define pre_temp_1_2 ((*(jmi->z))[jmi->offs_pre_boolean_d+0])
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    if (COND_EXP_LT(_index_4, 4, JMI_TRUE, JMI_FALSE)) {
        ...
        memcpy(&jmi_array_ref_1(tmp_1, 1), &_table_1_0, 3 * sizeof(jmi_real_t));
...
int model_ode_derivatives_base(jmi_t* jmi) {
    int ef = 0;
    JMI_ARR(STATREAL, jmi_ad_var_t, jmi_array_t, tmp_1, 6, 1)
    JMI_ARR(STATREAL, jmi_ad_var_t, jmi_array_t, tmp_2, 6, 1)
    _e_3 = _time;
    ...
    _h_11 = - cos(_time);
    JMI_ARRAY_INIT_1(STATREAL, jmi_ad_var_t, jmi_array_t, tmp_1, 6, 1, 6)
    JMI_ARRAY_INIT_1(STATREAL, jmi_ad_var_t, jmi_array_t, tmp_2, 6, 1, 6)
...
void func_CCodeGenTests_CUnknownArray3_f1_def0(jmi_array_t* x1_a, jmi_ad_var_t* y1_o) {
    ...
    JMI_ARRAY_INIT_1(DYNAREAL, jmi_ad_var_t, jmi_array_t, tmp_1, jmi_array_size(x1_a, 0), 1, jmi_array_size(x1_a, 0))
...
int model_ode_initialize_base(jmi_t* jmi) {
    ...
    _temp_1_12 = LOG_EXP_AND(_sw(0), pre_z_5);
    _z_5 = pre_z_5;
    if (jmi->atInitial || jmi->atEvent) {
        _sw(1) = jmi_turn_switch(jmi, _y_2 - (2), _sw(1), JMI_REL_GT);
    }
    _temp_2_13 = LOG_EXP_AND(_sw(1), _z_5);
    if (jmi->atInitial || jmi->atEvent) {
        _sw(2) = jmi_turn_switch(jmi, _x_1 - (2), _sw(2), JMI_REL_GT);
    }
    _temp_3_14 = _sw(2);
    ...
    _temp_4_15 = LOG_EXP_OR(LOG_EXP_OR(LOG_EXP_AND(_sw(3), _sw(4)), LOG_EXP_AND(_sw(5), _sw(6))), LOG_EXP_AND(_sw(7), _sw(8)));
    pre_w_3 = JMI_TRUE;
    _w_3 = pre_w_3;
    pre_v_4 = JMI_TRUE;
    _v_4 = pre_v_4;
    _xx_0 = 2;
    pre_temp_1_12 = JMI_FALSE;
    pre_temp_2_13 = JMI_FALSE;
    pre_temp_3_14 = JMI_FALSE;
    pre_temp_4_15 = JMI_FALSE;
    return ef;
}
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_SOLVED_REAL_VALUE_REFERENCE) {
        ...
        _temp_4_15 = LOG_EXP_OR(LOG_EXP_OR(LOG_EXP_AND(_sw(3), _sw(4)), LOG_EXP_AND(_sw(5), _sw(6))), LOG_EXP_AND(_sw(7), _sw(8)));
        _y_2 = COND_EXP_EQ(LOG_EXP_AND(_temp_4_15, LOG_EXP_NOT(pre_temp_4_15)), JMI_TRUE, pre_y_2 + AD_WRAP_LITERAL(1.1), pre_y_2);
        _x_1 = COND_EXP_EQ(LOG_EXP_AND(_temp_4_15, LOG_EXP_NOT(pre_temp_4_15)), JMI_TRUE, pre_x_1 + AD_WRAP_LITERAL(1.1), pre_x_1);
...
static int dae_block_1(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_SOLVED_NON_REAL_VALUE_REFERENCE) {
        ...
        _temp_1_12 = LOG_EXP_AND(_sw(0), pre_z_5);
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            _w_3 = COND_EXP_EQ(LOG_EXP_AND(_temp_1_12, LOG_EXP_NOT(pre_temp_1_12)), JMI_TRUE, JMI_FALSE, pre_w_3);
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            _sw(2) = jmi_turn_switch(jmi, _x_1 - (2), _sw(2), JMI_REL_GT);
        }
        _temp_3_14 = _sw(2);
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            _z_5 = COND_EXP_EQ(LOG_EXP_AND(_temp_3_14, LOG_EXP_NOT(pre_temp_3_14)), JMI_TRUE, JMI_FALSE, pre_z_5);
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
        }
    }
...
static int dae_block_2(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_SOLVED_NON_REAL_VALUE_REFERENCE) {
        ...
        _temp_2_13 = LOG_EXP_AND(_sw(1), _z_5);
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            _v_4 = COND_EXP_EQ(LOG_EXP_AND(_temp_2_13, LOG_EXP_NOT(pre_temp_2_13)), JMI_TRUE, JMI_FALSE, pre_v_4);
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
        }
    }
...
",
  ...
  }  else if (ALMOST_ZERO(jmi_dremainder(jmi, _t - (AD_WRAP_LITERAL(0)), _h_6))) {
    nSamp = jmi_dround((_t - (AD_WRAP_LITERAL(0))) / (_h_6));
    jmi_min_time_event(&nextEvent, 1, 0, (nSamp + 1.0) * (_h_6) + (AD_WRAP_LITERAL(0)));
  }  else if (SURELY_GT_ZERO(jmi_dremainder(jmi, _t - (AD_WRAP_LITERAL(0)), _h_6))) {
...
",
  ...
  if (SURELY_LT_ZERO(_t - (AD_WRAP_LITERAL(0)))) {
    jmi_min_time_event(&nextEvent, 1, 0, AD_WRAP_LITERAL(0));
  }  else if (ALMOST_ZERO(jmi_dremainder(jmi, _t - (AD_WRAP_LITERAL(0)), jmi_divide_equation(jmi, AD_WRAP_LITERAL(1),AD_WRAP_LITERAL(3),\"1 / 3\")))) {
  ...
  }  else if (SURELY_GT_ZERO(jmi_dremainder(jmi, _t - (AD_WRAP_LITERAL(0)), jmi_divide_equation(jmi, AD_WRAP_LITERAL(1),AD_WRAP_LITERAL(3),\"1 / 3\")))) {
    nSamp = floor((_t - (AD_WRAP_LITERAL(0))) / (jmi_divide_equation(jmi, AD_WRAP_LITERAL(1),AD_WRAP_LITERAL(3),\"1 / 3\")));
    jmi_min_time_event(&nextEvent, 1, 0, (nSamp + 1.0) * (jmi_divide_equation(jmi, AD_WRAP_LITERAL(1),AD_WRAP_LITERAL(3),\"1 / 3\")) + (AD_WRAP_LITERAL(0)));
  }
  if (SURELY_LT_ZERO(_t - (AD_WRAP_LITERAL(0)))) {
    jmi_min_time_event(&nextEvent, 1, 0, AD_WRAP_LITERAL(0));
  }  else if (ALMOST_ZERO(jmi_dremainder(jmi, _t - (AD_WRAP_LITERAL(0)), jmi_divide_equation(jmi, AD_WRAP_LITERAL(2),AD_WRAP_LITERAL(3),\"2 / 3\")))) {
  ...
  }  else if (SURELY_GT_ZERO(jmi_dremainder(jmi, _t - (AD_WRAP_LITERAL(0)), jmi_divide_equation(jmi, AD_WRAP_LITERAL(2),AD_WRAP_LITERAL(3),\"2 / 3\")))) {
...
int model_ode_initialize_base(jmi_t* jmi) {
    int ef = 0;
    _der_dummy_5 = 0;
    _temp_1_6 = jmi_sample(jmi,AD_WRAP_LITERAL(0),jmi_divide_equation(jmi, AD_WRAP_LITERAL(1),AD_WRAP_LITERAL(3),\"1 / 3\"));
    _temp_2_7 = jmi_sample(jmi,AD_WRAP_LITERAL(0),jmi_divide_equation(jmi, AD_WRAP_LITERAL(2),AD_WRAP_LITERAL(3),\"2 / 3\"));
    pre_x_0 = 0.0;
    _x_0 = pre_x_0;
    pre_y_1 = 0.0;
    _y_1 = pre_y_1;
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_SOLVED_REAL_VALUE_REFERENCE) {
        ...
        _temp_1_6 = jmi_sample(jmi,AD_WRAP_LITERAL(0),jmi_divide_equation(jmi, AD_WRAP_LITERAL(1),AD_WRAP_LITERAL(3),\"1 / 3\"));
        _x_0 = COND_EXP_EQ(LOG_EXP_AND(_temp_1_6, LOG_EXP_NOT(pre_temp_1_6)), JMI_TRUE, pre_x_0 + AD_WRAP_LITERAL(1), pre_x_0);
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
        }
    }
    return ef;
...
static int dae_block_1(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_SOLVED_REAL_VALUE_REFERENCE) {
        ...
        _temp_2_7 = jmi_sample(jmi,AD_WRAP_LITERAL(0),jmi_divide_equation(jmi, AD_WRAP_LITERAL(2),AD_WRAP_LITERAL(3),\"2 / 3\"));
        _y_1 = COND_EXP_EQ(LOG_EXP_AND(_temp_2_7, LOG_EXP_NOT(pre_temp_2_7)), JMI_TRUE, pre_y_1 + AD_WRAP_LITERAL(1), pre_y_1);
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
        }
    }
    return ef;
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_SOLVED_REAL_VALUE_REFERENCE) {
        ...
        _temp_1_4 = jmi_sample(jmi,AD_WRAP_LITERAL(0),AD_WRAP_LITERAL(1));
...
int model_ode_initialize_base(jmi_t* jmi) {
    ...
    pre_x_0 = 0.0;
    _x_0 = pre_x_0;
    pre_temp_1_10 = JMI_FALSE;
    pre_temp_2_11 = JMI_FALSE;
    pre_temp_3_12 = JMI_FALSE;
    return ef;
}
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        _temp_1_10 = _sw(0);
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = COND_EXP_EQ(LOG_EXP_AND(_temp_1_10, LOG_EXP_NOT(pre_temp_1_10)), JMI_TRUE, sin(_x_0) + AD_WRAP_LITERAL(3), pre_x_0) - (_x_0);
        }
    }
    return ef;
}
...
static int dae_block_1(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        residual[0] = 1.0;
        residual[1] = 1.0;
        residual[2] = - COND_EXP_EQ(LOG_EXP_AND(_temp_2_11, LOG_EXP_NOT(pre_temp_2_11)), JMI_TRUE, AD_WRAP_LITERAL(-2), AD_WRAP_LITERAL(0.0));
        residual[3] = 1.0;
    } else if (evaluation_mode & JMI_BLOCK_EVALUATE || evaluation_mode & JMI_BLOCK_WRITE_BACK) {
        if ((evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) == 0) {
            _y1_1 = x[0];
        ...
        _temp_2_11 = _sw(0);
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = COND_EXP_EQ(LOG_EXP_AND(_temp_2_11, LOG_EXP_NOT(pre_temp_2_11)), JMI_TRUE, AD_WRAP_LITERAL(7) - AD_WRAP_LITERAL(2) * _y2_2, pre_y1_1) - (_y1_1);
            (*res)[1] = 5 - (_y1_1 + _y2_2);
        }
    }
    return ef;
...
static int dae_block_2(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        residual[4] = 1.0;
        residual[5] = 1.0;
        residual[6] = - COND_EXP_EQ(LOG_EXP_AND(_temp_3_12, LOG_EXP_NOT(pre_temp_3_12)), JMI_TRUE, AD_WRAP_LITERAL(-2), AD_WRAP_LITERAL(0.0));
        residual[7] = - COND_EXP_EQ(LOG_EXP_AND(_temp_3_12, LOG_EXP_NOT(pre_temp_3_12)), JMI_TRUE, AD_WRAP_LITERAL(-2), AD_WRAP_LITERAL(0.0));
        residual[8] = 1.0;
    } else if (evaluation_mode & JMI_BLOCK_EVALUATE || evaluation_mode & JMI_BLOCK_WRITE_BACK) {
        if ((evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) == 0) {
            _z3_5 = x[0];
        ...
        _temp_3_12 = _sw(0);
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = COND_EXP_EQ(LOG_EXP_AND(_temp_3_12, LOG_EXP_NOT(pre_temp_3_12)), JMI_TRUE, AD_WRAP_LITERAL(7) - AD_WRAP_LITERAL(2) * _z2_4, pre_z3_5) - (_z3_5);
            (*res)[1] = COND_EXP_EQ(LOG_EXP_AND(_temp_3_12, LOG_EXP_NOT(pre_temp_3_12)), JMI_TRUE, AD_WRAP_LITERAL(7) - AD_WRAP_LITERAL(2) * _z2_4, pre_z1_3) - (_z1_3);
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_SOLVED_REAL_VALUE_REFERENCE) {
        ...
        _temp_1_6 = _sw(0);
        if (LOG_EXP_OR(_atInitial, LOG_EXP_AND(_temp_1_6, LOG_EXP_NOT(pre_temp_1_6)))) {
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        _temp_1_6 = _sw(0);
        if (LOG_EXP_AND(_temp_1_6, LOG_EXP_NOT(pre_temp_1_6))) {
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        _temp_1_8 = _sw(0);
        if (LOG_EXP_AND(_temp_1_8, LOG_EXP_NOT(pre_temp_1_8))) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            if (LOG_EXP_OR(_atInitial, LOG_EXP_AND(_temp_2_9, LOG_EXP_NOT(pre_temp_2_9)))) {
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_SOLVED_REAL_VALUE_REFERENCE) {
        ...
        _temp_1_3 = _sw(0);
        _z_1 = COND_EXP_EQ(LOG_EXP_AND(_temp_1_3, LOG_EXP_NOT(pre_temp_1_3)), JMI_TRUE, pre_x_0, pre_z_1);
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
        }
    }
    return ef;
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    int ef = 0;
    JMI_DEF_STR_STAT(tmp_1, 63)
    if (evaluation_mode == JMI_BLOCK_NON_REAL_TEMP_VALUE_REFERENCE) {
        x[0] = 536870915;
    } else if (evaluation_mode & JMI_BLOCK_EVALUATE || evaluation_mode & JMI_BLOCK_WRITE_BACK) {
        if ((evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) == 0) {
        }
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    _der_x_1 = func_CCodeGenTests_ReinitCTest4_f_exp0(tmp_2);
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(jmi, _time - (2), _sw(0), JMI_REL_GT);
    }
    ef |= jmi_solve_block_residual(jmi->dae_block_residuals[0]);
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_NON_REAL_TEMP_VALUE_REFERENCE) {
        ...
        _temp_1_2 = _sw(0);
        if (LOG_EXP_OR(_atInitial, LOG_EXP_AND(_temp_1_2, LOG_EXP_NOT(pre_temp_1_2)))) {
            tmp_2 = AD_WRAP_LITERAL(1);
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
        }
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_SOLVED_REAL_VALUE_REFERENCE) {
        ...
        _temp_1_15 = _sw(0);
        _d_13 = COND_EXP_EQ(LOG_EXP_AND(_temp_1_15, LOG_EXP_NOT(pre_temp_1_15)), JMI_TRUE, pre_d_13 + AD_WRAP_LITERAL(1), pre_d_13);
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
        }
    }
    return ef;
...
static int dae_init_block_3(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    jmi_dae_add_equation_block(*jmi, dae_block_1, NULL, 2, 0, 0, 0, 0, 0, 0, 0, JMI_CONSTANT_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 1, \"2\", -1);
    jmi_dae_add_equation_block(*jmi, dae_block_2, NULL, 2, 0, 0, 0, 0, 0, 0, 0, JMI_PARAMETER_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 2, \"3\", -1);
    jmi_dae_add_equation_block(*jmi, dae_block_0, NULL, 0, 1, 1, 0, 0, 1, 0, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);
    jmi_dae_add_equation_block(*jmi, dae_block_3, NULL, 2, 0, 0, 0, 0, 0, 0, 0, JMI_DISCRETE_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 3, \"4\", -1);
    jmi_dae_add_equation_block(*jmi, dae_block_4, NULL, 2, 0, 0, 0, 0, 0, 0, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 4, \"5\", -1);

    jmi_dae_init_add_equation_block(*jmi, dae_init_block_0, NULL, 2, 0, 0, 0, 0, 0, 0, 0, JMI_CONSTANT_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);
    jmi_dae_init_add_equation_block(*jmi, dae_init_block_1, NULL, 2, 0, 0, 0, 0, 0, 0, 0, JMI_PARAMETER_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 1, \"2\", -1);
    jmi_dae_init_add_equation_block(*jmi, dae_init_block_2, NULL, 2, 0, 0, 0, 0, 0, 0, 0, JMI_DISCRETE_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 2, \"3\", -1);
    jmi_dae_init_add_equation_block(*jmi, dae_init_block_3, NULL, 2, 0, 0, 0, 0, 0, 0, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 3, \"4\", -1);
")})));
end BlockTest7;
...
static int dae_init_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    jmi_dae_add_equation_block(*jmi, dae_block_0, NULL, 2, 0, 0, 1, 1, 0, 1, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_KINSOL_SOLVER, 0, \"1\", -1);

    jmi_dae_init_add_equation_block(*jmi, dae_init_block_0, NULL, 2, 0, 0, 1, 1, 0, 1, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_KINSOL_SOLVER, 0, \"1\", -1);
")})));
end BlockTest8;
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_SOLVED_REAL_VALUE_REFERENCE) {
        ...
        _temp_1_5 = _sw(0);
        _x_0 = COND_EXP_EQ(LOG_EXP_AND(_temp_1_5, LOG_EXP_NOT(pre_temp_1_5)), JMI_TRUE, AD_WRAP_LITERAL(2), pre_x_0);
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
        }
    }
    return ef;
...
",
            generatedCode="
    jmi_dae_add_equation_block(*jmi, dae_block_0, NULL, 1, 3, 0, 0, 0, 0, 0, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_KINSOL_SOLVER, 0, \"1\", -1);
    jmi_dae_add_equation_block(*jmi, dae_block_1, NULL, 1, 0, 0, 0, 0, 0, 0, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_KINSOL_SOLVER, 1, \"2\", -1);
...
int model_ode_initialize_base(jmi_t* jmi) {
    ...
    pre_temp_2_6 = JMI_FALSE;
    pre_temp_3_7 = JMI_FALSE;
    pre_temp_4_8 = JMI_FALSE;
    pre_temp_5_9 = JMI_FALSE;
    pre_temp_6_10 = JMI_FALSE;
    return ef;
}
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_SOLVED_REAL_VALUE_REFERENCE) {
        ...
        if (LOG_EXP_AND(_temp_1_5, LOG_EXP_NOT(pre_temp_1_5))) {
            _a_1 = _a_1 + 1;
        } else if (LOG_EXP_OR(_atInitial, LOG_EXP_AND(_temp_2_6, LOG_EXP_NOT(pre_temp_2_6)))) {
            _a_1 = _a_1 - 1;
        } else if (LOG_EXP_OR(LOG_EXP_OR(LOG_EXP_OR(LOG_EXP_AND(_temp_3_7, LOG_EXP_NOT(pre_temp_3_7)), LOG_EXP_AND(_temp_4_8, LOG_EXP_NOT(pre_temp_4_8))), LOG_EXP_AND(_temp_5_9, LOG_EXP_NOT(pre_temp_5_9))), LOG_EXP_AND(_temp_6_10, LOG_EXP_NOT(pre_temp_6_10)))) {
            _b_2 = _b_2 + 1;
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
        }
...
$C_ode_initialization$
",generatedCode="
    jmi_dae_add_equation_block(*jmi, dae_block_0, NULL, 1, 0, 0, 0, 0, 0, 0, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_KINSOL_SOLVER, 0, \"1\", -1);
    jmi_dae_add_equation_block(*jmi, dae_block_1, NULL, 1, 0, 0, 0, 0, 0, 0, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_KINSOL_SOLVER, 1, \"2\", -1);

    jmi_dae_init_add_equation_block(*jmi, dae_init_block_1, NULL, 2, 0, 0, 0, 0, 0, 0, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_KINSOL_SOLVER, 1, \"1(Homotopy).1\", 0);
    jmi_dae_init_add_equation_block(*jmi, dae_init_block_0, NULL, 0, 0, 0, 0, 0, 0, 0, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1(Homotopy)\", -1);
    jmi_dae_init_add_equation_block(*jmi, dae_init_block_2, NULL, 1, 0, 0, 0, 0, 0, 0, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_KINSOL_SOLVER, 2, \"1(Simplified).1\", -1);
    jmi_dae_init_add_equation_block(*jmi, dae_init_block_3, NULL, 1, 0, 0, 0, 0, 0, 0, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_KINSOL_SOLVER, 3, \"1(Simplified).2\", -1);
...
static int dae_init_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    jmi_dae_add_equation_block(*jmi, dae_block_0, NULL, 1, 3, 0, 3, 2, 0, 2, 0, JMI_DISCRETE_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);

    jmi_dae_init_add_equation_block(*jmi, dae_init_block_0, NULL, 1, 3, 0, 2, 2, 0, 2, 0, JMI_DISCRETE_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);
")})));
end TearingTest2;
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_START) {
        ...
        jmi_array_ref_1(tmp_5, 1) = AD_WRAP_LITERAL(1.0);
        Q1[0] = - COND_EXP_EQ(_b1_5, JMI_TRUE, jmi_array_val_1(tmp_5, _i1_6), AD_WRAP_LITERAL(0));
        Q1[3] = -1.0;
        for (i = 0; i < 4; i += 2) {
            JMI_ARRAY_INIT_1(STATREAL, jmi_ad_var_t, jmi_array_t, tmp_4, 1, 1, 1)
            jmi_array_ref_1(tmp_4, 1) = AD_WRAP_LITERAL(0.0);
            Q1[i + 0] = (Q1[i + 0]) / (AD_WRAP_LITERAL(1.0) - COND_EXP_EQ(_b1_5, JMI_TRUE, jmi_array_val_1(tmp_4, _i1_6), AD_WRAP_LITERAL(0)));
        ...
        JMI_ARRAY_INIT_1(STATREAL, jmi_ad_var_t, jmi_array_t, tmp_3, 1, 1, 1)
        jmi_array_ref_1(tmp_3, 1) = _x4_1_4;
        _x1_1 = COND_EXP_EQ(_b1_5, JMI_TRUE, jmi_array_val_1(tmp_3, _i1_6), AD_WRAP_LITERAL(0));
        _x2_2 = _x1_1 * 2 + _x3_3;
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
...
",
            generatedCode="
    jmi_dae_add_equation_block(*jmi, dae_block_0, NULL, 2, 1, 0, 1, 1, 1, 1, 0, JMI_CONSTANT_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        _temp_1_7 = LOG_EXP_AND(_b_4, LOG_EXP_NOT(pre_b_4));
        if (LOG_EXP_AND(_temp_1_7, LOG_EXP_NOT(pre_temp_1_7))) {
            tmp_1 = AD_WRAP_LITERAL(1);
        }
        _zz_3 = - _y_1 + 0.1;
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        memset(residual, 0, 1 * sizeof(jmi_real_t));
        JMI_ARRAY_INIT_1(STATREAL, jmi_ad_var_t, jmi_array_t, tmp_2, 3, 1, 3)
        jmi_array_ref_1(tmp_2, 1) = 0.0;
        jmi_array_ref_1(tmp_2, 2) = 0.0;
        jmi_array_ref_1(tmp_2, 3) = 0.0;
        residual[0] = 1.0 - jmi_array_val_1(tmp_2, _i_4);
    } else if (evaluation_mode & JMI_BLOCK_EVALUATE || evaluation_mode & JMI_BLOCK_WRITE_BACK) {
        if ((evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) == 0) {
            _y_3 = x[0];
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            _sw(0) = jmi_turn_switch(jmi, _y_3 - (pre_temp_1_6), _sw(0), JMI_REL_LT);
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            _sw(1) = jmi_turn_switch(jmi, _y_3 - (pre_temp_1_6 + AD_WRAP_LITERAL(1)), _sw(1), JMI_REL_GEQ);
        }
        _temp_1_6 = COND_EXP_EQ(LOG_EXP_OR(LOG_EXP_OR(_sw(0), _sw(1)), _atInitial), JMI_TRUE, floor(_y_3), pre_temp_1_6);
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            _i_4 = _temp_1_6 + 1;
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            JMI_ARRAY_INIT_1(STATREAL, jmi_ad_var_t, jmi_array_t, tmp_1, 3, 1, 3)
            memcpy(&jmi_array_ref_1(tmp_1, 1), &_x_1_0, 3 * sizeof(jmi_real_t));
            (*res)[0] = jmi_array_val_1(tmp_1, _i_4) - (_y_3);
        }
    }
    return ef;
}
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        memset(residual, 0, 1 * sizeof(jmi_real_t));
        JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_3, 3, 1, 3)
        memcpy(&jmi_array_ref_1(tmp_3, 1), &_x_1_1, 3 * sizeof(jmi_real_t));
        JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_4, 3, 1, 3)
        jmi_array_ref_1(tmp_4, 1) = 0;
        jmi_array_ref_1(tmp_4, 2) = 0;
        jmi_array_ref_1(tmp_4, 3) = 0;
        residual[0] = 1.0 - jmi_array_val_1(tmp_4, jmi_array_val_1(tmp_3, _i_5));
    } else if (evaluation_mode & JMI_BLOCK_EVALUATE || evaluation_mode & JMI_BLOCK_WRITE_BACK) {
        if ((evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) == 0) {
            _y_4 = x[0];
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            _sw(0) = jmi_turn_switch(jmi, _y_4 - (pre_temp_1_11), _sw(0), JMI_REL_LT);
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            _sw(1) = jmi_turn_switch(jmi, _y_4 - (pre_temp_1_11 + AD_WRAP_LITERAL(1)), _sw(1), JMI_REL_GEQ);
        }
        _temp_1_11 = COND_EXP_EQ(LOG_EXP_OR(LOG_EXP_OR(_sw(0), _sw(1)), _atInitial), JMI_TRUE, floor(_y_4), pre_temp_1_11);
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            _i_5 = _temp_1_11 + 1;
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_1, 3, 1, 3)
            memcpy(&jmi_array_ref_1(tmp_1, 1), &_x_1_1, 3 * sizeof(jmi_real_t));
            JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_2, 3, 1, 3)
            memcpy(&jmi_array_ref_1(tmp_2, 1), &_x_1_1, 3 * sizeof(jmi_real_t));
            (*res)[0] = jmi_array_val_1(tmp_2, jmi_array_val_1(tmp_1, _i_5)) - (_y_4);
        }
    }
    return ef;
}
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    _x_3 = _time;
    JMI_ARRAY_INIT_1(STATREAL, jmi_ad_var_t, jmi_array_t, tmp_1, 3, 1, 3)
    memcpy(&jmi_array_ref_1(tmp_1, 1), &_y_1_0, 3 * sizeof(jmi_real_t));
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(jmi, jmi_divide_equation(jmi, (pre_j_17 + AD_WRAP_LITERAL(1)),AD_WRAP_LITERAL(4),\"(pre(j) + 1) / 4\") - (pre_temp_1_20), _sw(0), JMI_REL_LT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(1) = jmi_turn_switch(jmi, jmi_divide_equation(jmi, (pre_j_17 + AD_WRAP_LITERAL(1)),AD_WRAP_LITERAL(4),\"(pre(j) + 1) / 4\") - (pre_temp_1_20 + AD_WRAP_LITERAL(1)), _sw(1), JMI_REL_GEQ);
    }
    ef |= jmi_solve_block_residual(jmi->dae_block_residuals[0]);
    JMI_ARRAY_INIT_2(STATREAL, jmi_ad_var_t, jmi_array_t, tmp_1, 16, 2, 4, 4)
    memcpy(&jmi_array_ref_2(tmp_1, 1,1), &_m_1_1_0, 16 * sizeof(jmi_real_t));
...
C_ode_time_events
  ...
  if (SURELY_LT_ZERO(_t - (AD_WRAP_LITERAL(1)))) {
    jmi_min_time_event(&nextEvent, 1, 0, AD_WRAP_LITERAL(1));
  }  else if (ALMOST_ZERO(jmi_dremainder(jmi, _t - (AD_WRAP_LITERAL(1)), func_CCodeGenTests_TestRelationalOp9_f_exp0(tmp_1)))) {
  ...
  }  else if (SURELY_GT_ZERO(jmi_dremainder(jmi, _t - (AD_WRAP_LITERAL(1)), func_CCodeGenTests_TestRelationalOp9_f_exp0(tmp_1)))) {
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    jmi_array_ref_1(tmp_3, 2) = AD_WRAP_LITERAL(2);
    jmi_array_ref_1(tmp_3, 3) = AD_WRAP_LITERAL(3);
    _b2_1 = jmi_sample(jmi,AD_WRAP_LITERAL(1),func_CCodeGenTests_TestRelationalOp9_f_exp0(tmp_3));
    pre_b2_1 = _b2_1;
    return ef;
}
")})));
...
static int dae_init_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    jmi_dae_add_equation_block(*jmi, dae_block_0, NULL, 1, 0, 0, 1, 1, 0, 1, 0, JMI_CONSTANT_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);

    jmi_dae_init_add_equation_block(*jmi, dae_init_block_0, NULL, 1, 0, 0, 1, 1, 0, 1, 0, JMI_CONSTANT_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);
")})));
end ActiveSwitches1;
...
static int dae_init_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    jmi_dae_add_equation_block(*jmi, dae_block_0, NULL, 1, 0, 0, 0, 0, 0, 1, 1, JMI_CONSTANT_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);
    jmi_dae_add_equation_block(*jmi, dae_block_1, NULL, 1, 0, 0, 0, 0, 0, 0, 0, JMI_DISCRETE_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 1, \"2\", -1);

    jmi_dae_init_add_equation_block(*jmi, dae_init_block_0, NULL, 1, 2, 0, 0, 0, 0, 3, 3, JMI_DISCRETE_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);
")})));
end ActiveSwitches2;
...
C_dae_init_add_blocks_residual_functions
    jmi_dae_init_add_equation_block(*jmi, dae_init_block_0, NULL, 1, 1, 0, 0, 0, 0, 1, 1, JMI_CONSTANT_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);
...
C_dae_init_add_blocks_residual_functions
    jmi_dae_init_add_equation_block(*jmi, dae_init_block_0, NULL, 1, 1, 0, 0, 0, 0, 0, 0, JMI_CONSTANT_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);
...
static int dae_init_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    jmi_dae_add_equation_block(*jmi, dae_block_0, NULL, 1, 1, 0, 2, 1, 0, 2, 1, JMI_CONSTANT_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);

    jmi_dae_init_add_equation_block(*jmi, dae_init_block_0, NULL, 1, 1, 0, 2, 1, 0, 2, 1, JMI_CONSTANT_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);
")})));
...
static int dae_init_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    jmi_dae_add_equation_block(*jmi, dae_block_0, NULL, 1, 0, 0, 0, 0, 0, 1, 1, JMI_DISCRETE_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);

    jmi_dae_init_add_equation_block(*jmi, dae_init_block_0, NULL, 1, 0, 0, 0, 0, 0, 1, 1, JMI_DISCRETE_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);
")})));
