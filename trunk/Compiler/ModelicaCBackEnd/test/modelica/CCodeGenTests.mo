  ...
  der(x) = y; 
    ...
    annotation(__JModelica(UnitTesting(tests={
        CCodeGenTestCase(
            ...
            generatedCode="
    (*res)[0] = _y_1 - (_der_x_2);
    (*res)[1] = (COND_EXP_EQ(COND_EXP_LE(_time, 3.141592653589793 / 2.0, JMI_TRUE, JMI_FALSE), JMI_TRUE, sin(_time), _x_0)) - (_der_x_2);
")})));
end CCodeGenTest4;
...
",
    ...
    (*res)[4] = 2.0 * (_z_2 + _x_0 + COND_EXP_EQ(COND_EXP_GE(_z_2, -1.5, JMI_TRUE, JMI_FALSE), JMI_TRUE, -3.0, 3.0)) - (_y_1);
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    __stream_positiveMax_1_23 = __stream_alpha_1_22 * jmi_max(_a_c2_f_4, 0.0) + (1.0 - __stream_alpha_1_22) * (jmi_in_stream_eps(jmi) * 0.1);
    _b_c5_s_17 = 5.0;
    __stream_positiveMax_2_24 = __stream_alpha_1_22 * jmi_max(_a_c3_f_7, 0.0) + (1.0 - __stream_alpha_1_22) * (jmi_in_stream_eps(jmi) * 0.1);
    _b_c6_s_20 = 6.0;
    ...
    __stream_positiveMax_3_27 = __stream_alpha_2_26 * jmi_max(_a_c1_f_1, 0.0) + (1.0 - __stream_alpha_2_26) * (jmi_in_stream_eps(jmi) * 0.1);
    _b_c4_s_14 = 4.0;
    __stream_positiveMax_4_28 = __stream_alpha_2_26 * jmi_max(_a_c3_f_7, 0.0) + (1.0 - __stream_alpha_2_26) * (jmi_in_stream_eps(jmi) * 0.1);
    ...
    __stream_positiveMax_5_31 = __stream_alpha_3_30 * jmi_max(_a_c1_f_1, 0.0) + (1.0 - __stream_alpha_3_30) * (jmi_in_stream_eps(jmi) * 0.1);
    __stream_positiveMax_6_32 = __stream_alpha_3_30 * jmi_max(_a_c2_f_4, 0.0) + (1.0 - __stream_alpha_3_30) * (jmi_in_stream_eps(jmi) * 0.1);
...
void func_CCodeGenTests_CFunctionTest12_f_def0(jmi_array_t* x_a, jmi_array_t* y_a) {
    ...
    (*res)[2] = 1.0 - ((_z_1_0*sf(0)));
    (*res)[3] = 1.0 - ((_z_2_1*sf(1)));
")})));
end CFunctionTest12;
...
void func_CCodeGenTests_CForLoop2_f_def0(jmi_real_t* o_o) {
    ...
    jmi_array_ref_1(temp_1_a, 1) = 2.0;
    jmi_array_ref_1(temp_1_a, 2) = 3.0;
    jmi_array_ref_1(temp_1_a, 3) = 5.0;
...
void func_CCodeGenTests_CForLoop3_f_def0(jmi_real_t* o_o) {
    ...
    x_v = 0.0;
    i_0ie = 1.0 + -1.0 / 2.0;
    for (i_0i = 3; i_0i > i_0ie; i_0i += -1.0) {
        x_v = x_v + i_0i;
    }
    JMI_RET(GEN, o_o, o_v)
    JMI_DYNAMIC_FREE()
...
model CArrayInput3
 ...
 Real x = f({f(1:3),f(4:6),f(7:9)});
    ...
    annotation(__JModelica(UnitTesting(tests={
        CCodeGenTestCase(
            name="CArrayInput3",
            description="C code generation: array inputs to functions: nested calls",
            variability_propagation=false,
            inline_functions="none",
            generate_ode=false,
            generate_dae=true,
...
void func_CCodeGenTests_CArrayInput6_f1_def0(jmi_real_t i_v, jmi_real_t* out_o) {
    ...
    i1_0ie = jmi_max(floor(2.0 - (i_v + 1.0)) + 1.0, 0.0) + 1 / 2.0;
    for (i1_0i = 1; i1_0i < i1_0ie; i1_0i += 1) {
    ...
    if (COND_EXP_LT(func_CCodeGenTests_CArrayInput6_f2_exp1(temp_1_a), 4.0, JMI_TRUE, JMI_FALSE)) {
        ...
        i1_1ie = jmi_max(floor(6.0 - (i_v + 5.0)) + 1.0, 0.0) + 1 / 2.0;
        ...
        i1_2ie = jmi_max(floor(8.0 - (i_v + 7.0)) + 1.0, 0.0) + 1 / 2.0;
...
void func_CCodeGenTests_CArrayOutputs1_f_def0(jmi_array_t* o_a) {
    ...
    jmi_array_ref_1(o_a, 1) = 1.0;
    jmi_array_ref_1(o_a, 2) = 2.0;
    JMI_DYNAMIC_FREE()
    return;
}
...
void func_CCodeGenTests_CArrayOutputs4_f2_def1(jmi_array_t* o1_a, jmi_real_t* o2_o) {
    ...
    jmi_array_ref_1(o1_a, 1) = 1.0;
    jmi_array_ref_1(o1_a, 2) = 2.0;
    o2_v = 3.0;
    JMI_RET(GEN, o2_o, o2_v)
    JMI_DYNAMIC_FREE()
    return;
...
void func_CCodeGenTests_CUnknownArray2_f_def0(jmi_array_t* x_a, jmi_array_t* y_a) {
    ...
    jmi_array_ref_2(temp_3_a, 1, 1) = 1.0;
    jmi_array_ref_2(temp_3_a, 1, 2) = 2.0;
    jmi_array_ref_2(temp_3_a, 2, 1) = 3.0;
    jmi_array_ref_2(temp_3_a, 2, 2) = 4.0;
    i1_0ie = jmi_array_size(x_a, 0) + 1 / 2.0;
    for (i1_0i = 1; i1_0i < i1_0ie; i1_0i += 1) {
        i2_1ie = 2.0 + 1 / 2.0;
        for (i2_1i = 1; i2_1i < i2_1ie; i2_1i += 1) {
...
void func_CCodeGenTests_CUnknownArray4_fw_def0(jmi_array_t* i_a, jmi_array_t* o_a, jmi_real_t* dummy_o) {
    ...
    dummy_v = 1.0;
    jmi_array_ref_1(o_a, 1.0) = 1.0;
    jmi_array_ref_1(o_a, 3.0) = 1.0;
    jmi_array_ref_1(o_a, 5.0) = 1.0;
...
void func_CCodeGenTests_CUnknownArray9_f_def0(jmi_real_t n_v, jmi_array_t* ab_a, jmi_array_t* ba_a) {
    ...
    i1_0ie = n_v + 1 / 2.0;
    for (i1_0i = 1; i1_0i < i1_0ie; i1_0i += 1) {
        jmi_array_ref_1(ba_a, i1_0i) = 1.0;
    }
    i1_1ie = n_v + 1 / 2.0;
    for (i1_1i = 1; i1_1i < i1_1ie; i1_1i += 1) {
...
void func_CCodeGenTests_CUnknownArray12_f_def0(jmi_real_t i_v, jmi_real_t* y_o) {
    ...
    jmi_array_ref_1(jmi_array_rec_1(c_a, 1)->a, 1) = 1.0;
    jmi_array_ref_1(jmi_array_rec_1(c_a, 1)->a, 2) = 2.0;
...
void func_CCodeGenTests_CUnknownArray13_f_def0(jmi_array_t* x_a, jmi_array_t* y_a) {
    ...
    for (i_0i = 1; i_0i < i_0ie; i_0i += 1) {
        ...
        i1_2ie = jmi_max(i_0i, 0.0) + 1 / 2.0;
        for (i1_2i = 1; i1_2i < i1_2ie; i1_2i += 1) {
            jmi_array_ref_1(temp_1_a, i1_2i + jmi_array_size(x_a, 0)) = i1_2i;
        }
        i1_3ie = jmi_array_size(x_a, 0) + jmi_max(i_0i, 0.0) + 1 / 2.0;
        for (i1_3i = 1; i1_3i < i1_3ie; i1_3i += 1) {
...
model CRecordDecl6
 ...
 Real x = f();
    ...
    annotation(__JModelica(UnitTesting(tests={
        CCodeGenTestCase(
            name="CRecordDecl6",
            description="C code generation for records: declarations: nested records",
            variability_propagation=false,
            inline_functions="none",
            generate_ode=false,
            generate_dae=true,
...
void func_CCodeGenTests_CRecordDecl7_f_def0(jmi_real_t* o_o) {
    ...
    JMI_ARRAY_INIT_1(STAT, jmi_real_t, jmi_array_t, tmp_1, 2, 1, 2)
    x_v->a = tmp_1;
    jmi_array_ref_1(x_v->a, 1) = 1.0;
    jmi_array_ref_1(x_v->a, 2) = 2.0;
...
void func_CCodeGenTests_CRecordDecl8_f_def0(jmi_real_t* o_o) {
    ...
    jmi_array_rec_1(x_a, 1)->a = 1.0;
    jmi_array_rec_1(jmi_array_rec_1(x_a, 1)->b, 1)->c = 2.0;
    jmi_array_rec_1(jmi_array_rec_1(x_a, 1)->b, 2)->c = 3.0;
    jmi_array_rec_1(x_a, 2)->a = 4.0;
    jmi_array_rec_1(jmi_array_rec_1(x_a, 2)->b, 1)->c = 5.0;
    jmi_array_rec_1(jmi_array_rec_1(x_a, 2)->b, 2)->c = 6.0;
    jmi_array_rec_1(x_a, 3)->a = 7.0;
    jmi_array_rec_1(jmi_array_rec_1(x_a, 3)->b, 1)->c = 8.0;
    jmi_array_rec_1(jmi_array_rec_1(x_a, 3)->b, 2)->c = 9.0;
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    int ef = 0;
    JMI_DYNAMIC_INIT()
    (*res)[0] = COND_EXP_EQ(pre_z_5, JMI_TRUE, _y_2 - (2.0), 1.0);
    (*res)[1] = COND_EXP_EQ(_z_5, JMI_TRUE, _y_2 - (2.0), 1.0);
    (*res)[2] = _x_1 - (2.0);
    (*res)[3] = _time - (1.0);
    (*res)[4] = COND_EXP_EQ(_sw(3), JMI_TRUE, _time - (1.1), 1.0);
    (*res)[5] = COND_EXP_EQ(LOG_EXP_NOT(LOG_EXP_AND(_sw(3), _sw(4))), JMI_TRUE, _time - (2.0), 1.0);
    (*res)[6] = COND_EXP_EQ(LOG_EXP_AND(LOG_EXP_NOT(LOG_EXP_AND(_sw(3), _sw(4))), _sw(5)), JMI_TRUE, _time - (2.1), 1.0);
    (*res)[7] = COND_EXP_EQ(LOG_EXP_NOT(LOG_EXP_OR(LOG_EXP_AND(_sw(3), _sw(4)), LOG_EXP_AND(_sw(5), _sw(6)))), JMI_TRUE, _time - (3.0), 1.0);
...
",
            generatedCode="
    jmi_real_t nSamp;
    if (SURELY_LT_ZERO(COND_EXP_EQ(LOG_EXP_NOT(_atInitial), JMI_TRUE, _time - (pre__sampleItr_1_4 * 2.0 / 3.0), 1.0))) {
        jmi_min_time_event(nextTimeEvent, 1, 0, pre__sampleItr_1_4 * 2.0 / 3.0);
    }
    if (SURELY_LT_ZERO(_time - ((pre__sampleItr_1_4 + 1.0) * 2.0 / 3.0))) {
        jmi_min_time_event(nextTimeEvent, 1, 0, (pre__sampleItr_1_4 + 1.0) * 2.0 / 3.0);
    }
    if (SURELY_LT_ZERO(COND_EXP_EQ(LOG_EXP_NOT(_atInitial), JMI_TRUE, _time - (pre__sampleItr_2_6 * 1.0 / 3.0), 1.0))) {
        jmi_min_time_event(nextTimeEvent, 1, 0, pre__sampleItr_2_6 * 1.0 / 3.0);
    }
    if (SURELY_LT_ZERO(_time - ((pre__sampleItr_2_6 + 1.0) * 1.0 / 3.0))) {
        jmi_min_time_event(nextTimeEvent, 1, 0, (pre__sampleItr_2_6 + 1.0) * 1.0 / 3.0);
    }
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    _der_dummy_13 = 0.0;
    if (jmi->atInitial || jmi->atEvent) {
        _sw(3) = jmi_turn_switch_time(jmi, _time - ((pre__sampleItr_2_6 + 1.0) * 1.0 / 3.0), _sw(3), JMI_REL_LT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(2) = jmi_turn_switch_time(jmi, _time - (pre__sampleItr_2_6 * 1.0 / 3.0), _sw(2), JMI_REL_GEQ);
    }
    ef |= jmi_solve_block_residual(jmi->dae_block_residuals[0]);
    if (jmi->atInitial || jmi->atEvent) {
        _sw(1) = jmi_turn_switch_time(jmi, _time - ((pre__sampleItr_1_4 + 1.0) * 2.0 / 3.0), _sw(1), JMI_REL_LT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch_time(jmi, _time - (pre__sampleItr_1_4 * 2.0 / 3.0), _sw(0), JMI_REL_GEQ);
    }
...
int model_ode_initialize_base(jmi_t* jmi) {
    ...
    __sampleItr_1_4 = COND_EXP_EQ(_sw_init(0), JMI_TRUE, 0.0, ceil(jmi_divide_equation(jmi, _time,2.0 / 3.0,\"time / (2 / 3)\")));
    ...
    __sampleItr_2_6 = COND_EXP_EQ(_sw_init(0), JMI_TRUE, 0.0, ceil(jmi_divide_equation(jmi, _time,1.0 / 3.0,\"time / (1 / 3)\")));
...
equation
    ...
    annotation(__JModelica(UnitTesting(tests={
        CCodeGenTestCase(
            name="WhenTests_WhenTestCache_WhenTestCache1",
            description="",
            template="
$C_ode_derivatives$
$C_dae_blocks_residual_functions$
...
equation
    ...
    annotation(__JModelica(UnitTesting(tests={
        CCodeGenTestCase(
            name="WhenTests_WhenTestCache_WhenTestCache2",
            description="",
            template="
$C_ode_derivatives$
$C_dae_blocks_residual_functions$
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    JMI_DEF(REA, tmp_6)
    if (_sw(0)) {
        func_CCodeGenTests_dummyFunc_def0(_time * _time * _time / 2.0, &tmp_1, &tmp_2);
        _x_0 = (tmp_1);
        _y_1 = (tmp_2);
    } else {
        if (_sw(1)) {
...
static jmi_real_t tmp_1;
static jmi_real_t tmp_2;
static jmi_real_t tmp_3;
static jmi_real_t tmp_4;
static jmi_real_t tmp_5;
static jmi_real_t tmp_6;
static jmi_real_t tmp_7;
...
static int dae_block_1(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = 5.0 - (3.0 * _z2_1_3 + 4.0 * _z2_2_4);
            (*res)[1] = 4.0 - (_z2_1_3 + 2.0 * _z2_2_4);
        }
    }
    JMI_DYNAMIC_FREE()
    return ef;
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_NOMINAL) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = _x_2_2 + -4.0 * _y_3 + 2.0 - (0.0);
            (*res)[1] = -5.0 * _y_3 + 5.0 - (_x_1_1);
            (*res)[2] = _x_1_1 - _y_3 + _x_2_2 - (3.0);
        }
    }
    JMI_DYNAMIC_FREE()
    return ef;
...
static int dae_block_1(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            (*res)[0] = 4.0 - (3.0 * _x_1_4 + 4.0 * _x_2_5);
            (*res)[1] = 3.0 - (_x_1_4 + 2.0 * _x_2_5);
        }
    }
    JMI_DYNAMIC_FREE()
    return ef;
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            ...
            jmi_array_ref_1(tmp_1, 1) = _time;
            jmi_array_ref_1(tmp_1, 2) = 2.0;
            (*res)[0] = _x_0 * func_CCodeGenTests_BlockTest9_F_exp0(tmp_1) - (0.0);
        }
    }
    JMI_DYNAMIC_FREE()
    return ef;
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE) {
            ...
            jmi_array_ref_1(tmp_1, 1) = _time;
            jmi_array_ref_1(tmp_1, 2) = 2.0;
            (*res)[0] = COND_EXP_EQ(_b_1, JMI_TRUE, _x_0 * func_CCodeGenTests_BlockTest10_F_exp0(tmp_1), -1.0) - (0.0);
        }
    }
    JMI_DYNAMIC_FREE()
    return ef;
...
int jmi_set_start_values_0_0(jmi_t* jmi) {
    ...
    __block_solver_experimental_mode_3 = (0.0);
    __cs_experimental_mode_5 = (0.0);
    __cs_solver_7 = (0.0);
    __iteration_variable_scaling_12 = (1.0);
    __log_level_13 = (3.0);
    __nle_active_bounds_mode_14 = (0.0);
    __nle_jacobian_calculation_mode_16 = (0.0);
    __nle_jacobian_update_mode_18 = (2.0);
    __nle_solver_exit_criterion_21 = (3.0);
    __nle_solver_max_iter_22 = (100.0);
    __nle_solver_max_iter_no_jacobian_23 = (10.0);
    __residual_equation_scaling_34 = (1.0);
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(jmi, (pre_j_17 + 1.0) / 4.0 - (pre_temp_2_20), _sw(0), JMI_REL_LT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(1) = jmi_turn_switch(jmi, (pre_j_17 + 1.0) / 4.0 - (pre_temp_2_20 + 1.0), _sw(1), JMI_REL_GEQ);
    }
    ef |= jmi_solve_block_residual(jmi->dae_block_residuals[0]);
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(jmi, (pre_j_16 + 1.0) / 4.0 - (pre_temp_2_20), _sw(0), JMI_REL_LT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(1) = jmi_turn_switch(jmi, (pre_j_16 + 1.0) / 4.0 - (pre_temp_2_20 + 1.0), _sw(1), JMI_REL_GEQ);
    }
    ef |= jmi_solve_block_residual(jmi->dae_block_residuals[0]);
...
C_ode_time_events
    ...
    if (SURELY_LT_ZERO(COND_EXP_EQ(LOG_EXP_NOT(_atInitial), JMI_TRUE, _time - (1.0 + pre__sampleItr_1_2 * func_CCodeGenTests_TestRelationalOp9_f_exp0(tmp_2)), 1.0))) {
...
",
    ...
    (*res)[2] = COND_EXP_EQ(func_CCodeGenTests_TestRelationalOp12_f_exp0(tmp_1), JMI_TRUE, _x_0 - (5.0), 1.0);
    JMI_DYNAMIC_FREE()
    return ef;
...
",
            generatedCode="
    jmi_real_t nSamp;
    if (SURELY_LT_ZERO(COND_EXP_EQ(_sw(2), JMI_TRUE, _time - (3.0), 1.0)) || (!jmi->eventPhase && ALMOST_ZERO(COND_EXP_EQ(_sw(2), JMI_TRUE, _time - (3.0), 1.0)))) {
        jmi_min_time_event(nextTimeEvent, 1, 1, 3.0);
    }
    if (SURELY_LT_ZERO(COND_EXP_EQ(_b1_2, JMI_TRUE, _time - (2.0), 1.0)) || (!jmi->eventPhase && ALMOST_ZERO(COND_EXP_EQ(_b1_2, JMI_TRUE, _time - (2.0), 1.0)))) {
...
void func_CCodeGenTests_StringOperations11_f2_def0(jmi_real_t x_v, jmi_real_t n_v, jmi_real_t* y_o) {
    ...
    i1_0ie = jmi_max(n_v, 0.0) + 1 / 2.0;
    for (i1_0i = 1; i1_0i < i1_0ie; i1_0i += 1) {
        JMI_ASG(STR, jmi_array_ref_1(temp_1_a, i1_0i), \"str\")
    }
    i1_1ie = jmi_max(n_v, 0.0) + 1 / 2.0;
    for (i1_1i = 1; i1_1i < i1_1ie; i1_1i += 1) {
