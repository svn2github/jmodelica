...
---
        ...
        extern void f(double, int, int, char*, int, double*, int*, int*, char*, int*);
...
---
        ...
        extern void f(double*, int, int*, int, int*, int, char*, int, int*, int, double*, int, int*, int, int*, int, char*, int, int*, int);
...
---
        ...
        extern void my_constructor2(double*, int*, void*, int*, char*);
...
---
        ...
        extern void* my_constructor1(double, int, int, char*);
