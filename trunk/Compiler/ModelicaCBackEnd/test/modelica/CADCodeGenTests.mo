...
equation
    ...
    (*res)[0] = _sw(0) - (_temp_1_3);
    (*res)[1] = COND_EXP_EQ(LOG_EXP_AND(_temp_1_3, LOG_EXP_NOT(pre_temp_1_3)), JMI_TRUE, pre_x_0, pre_z_1) - (_z_1);
    (*res)[2] = _time - (_x_0);
    (*dF)[2] = (*dz)[jmi->offs_t] - ((*dz)[jmi_get_index_from_value_ref(0)-jmi->offs_real_dx]);
")})));
end WhenTest11; 
