...
",
            generatedCode="
    (*res)[0] = _time - (_one_1);
    (*res)[1] = COND_EXP_EQ(LOG_EXP_NOT(_sw(0)), JMI_TRUE, _time - (_two_2), 1);
...
0
    ...
    (*res)[2] = COND_EXP_EQ(LOG_EXP_NOT(_sw_init(0)), JMI_TRUE, _time - (AD_WRAP_LITERAL(2)), 1);
...
void func_CCodeGenTests_CUnknownArray7_f_def0(jmi_ad_var_t m_v, R1_1_ra* o_a) {
    ...
    for (i_0i = 1; i_0i < i_0ie; i_0i += 1) {
        ...
        i2_1ie = jmi_max(m_v, AD_WRAP_LITERAL(0)) + 1 / 2.0;
        for (i2_1i = 1; i2_1i < i2_1ie; i2_1i += 1) {
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_SOLVED_REAL_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
                _sw(0) = jmi_turn_switch_time(_time - (1), _sw(0), JMI_ALMOST_EPS, JMI_REL_GEQ);
            }
            _temp_1_14 = _sw(0);
        }
...
static int dae_init_block_3(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    jmi_dae_add_equation_block(*jmi, dae_block_1, NULL, 2, 0, 0, 0, 0, 0, 0, JMI_CONSTANT_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 1, \"2\", -1);
    jmi_dae_add_equation_block(*jmi, dae_block_2, NULL, 2, 0, 0, 0, 0, 0, 0, JMI_PARAMETER_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 2, \"3\", -1);
    jmi_dae_add_equation_block(*jmi, dae_block_0, NULL, 0, 1, 1, 1, 0, 0, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);
    jmi_dae_add_equation_block(*jmi, dae_block_3, NULL, 2, 0, 0, 0, 0, 0, 0, JMI_DISCRETE_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 3, \"4\", -1);
    jmi_dae_add_equation_block(*jmi, dae_block_4, NULL, 2, 0, 0, 0, 0, 0, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 4, \"5\", -1);

    jmi_dae_init_add_equation_block(*jmi, dae_init_block_0, NULL, 2, 0, 0, 0, 0, 0, 0, JMI_CONSTANT_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);
    jmi_dae_init_add_equation_block(*jmi, dae_init_block_1, NULL, 2, 0, 0, 0, 0, 0, 0, JMI_PARAMETER_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 1, \"2\", -1);
    jmi_dae_init_add_equation_block(*jmi, dae_init_block_2, NULL, 2, 0, 0, 0, 0, 0, 0, JMI_DISCRETE_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 2, \"3\", -1);
    jmi_dae_init_add_equation_block(*jmi, dae_init_block_3, NULL, 2, 0, 0, 0, 0, 0, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 3, \"4\", -1);
...
static int dae_init_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    jmi_dae_add_equation_block(*jmi, dae_block_0, NULL, 2, 0, 1, 1, 0, 1, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_KINSOL_SOLVER, 0, \"1\", -1);

    jmi_dae_init_add_equation_block(*jmi, dae_init_block_0, NULL, 2, 0, 1, 1, 0, 1, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_KINSOL_SOLVER, 0, \"1\", -1);
")})));
end BlockTest8;
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    if (jmi->atInitial || jmi->atEvent) {
        ...
        _sw(0) = jmi_turn_switch(func_CCodeGenTests_InactiveBlockSwitch1_F_exp0(tmp_1) - (AD_WRAP_LITERAL(6.28)), _sw(0), jmi->events_epsilon, JMI_REL_LT);
    }
    ef |= jmi_solve_block_residual(jmi->dae_block_residuals[0]);
    return ef;
}
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            ...
            _sw(0) = jmi_turn_switch(func_CCodeGenTests_InactiveBlockSwitch1_F_exp0(tmp_2) - (AD_WRAP_LITERAL(6.28)), _sw(0), jmi->events_epsilon, JMI_REL_LT);
        }
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            ...
            _sw(0) = jmi_turn_switch(func_CCodeGenTests_InactiveBlockSwitch1_F_exp0(tmp_3) - (AD_WRAP_LITERAL(6.28)), _sw(0), jmi->events_epsilon, JMI_REL_LT);
        }
...
",
            generatedCode="
    jmi_dae_add_equation_block(*jmi, dae_block_0, NULL, 1, 3, 0, 0, 0, 0, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_KINSOL_SOLVER, 0, \"1\", -1);
    jmi_dae_add_equation_block(*jmi, dae_block_1, NULL, 1, 0, 0, 0, 0, 0, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_KINSOL_SOLVER, 1, \"2\", -1);
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    (*res)[0] = _y_1 - (_x_0 * 3);
    (*res)[1] = COND_EXP_EQ(LOG_EXP_NOT(_sw(0)), JMI_TRUE, _y_1 - 1 - (_x_0), 1);
")})));
end Algorithm12;
...
void func_Modelica_Math_Matrices_LAPACK_dgeev_def0(jmi_array_t* A_a, jmi_array_t* eigenReal_a, jmi_array_t* eigenImag_a, jmi_array_t* eigenVectors_a, jmi_ad_var_t* info_o) {
    ...
    JMI_ARRAY_INIT_1(DYNAREAL, jmi_ad_var_t, jmi_array_t, work_a, 12 * jmi_array_size(A_a, 0), 1, 12 * jmi_array_size(A_a, 0))
...
$C_ode_initialization$
",generatedCode="
    jmi_dae_add_equation_block(*jmi, dae_block_0, NULL, 1, 0, 0, 0, 0, 0, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_KINSOL_SOLVER, 0, \"1\", -1);
    jmi_dae_add_equation_block(*jmi, dae_block_1, NULL, 1, 0, 0, 0, 0, 0, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_KINSOL_SOLVER, 1, \"2\", -1);

    jmi_dae_init_add_equation_block(*jmi, dae_init_block_1, NULL, 2, 0, 0, 0, 0, 0, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_KINSOL_SOLVER, 1, \"1(Homotopy).1\", 0);
    jmi_dae_init_add_equation_block(*jmi, dae_init_block_0, NULL, 0, 0, 0, 0, 0, 0, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1(Homotopy)\", -1);
    jmi_dae_init_add_equation_block(*jmi, dae_init_block_2, NULL, 1, 0, 0, 0, 0, 0, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_KINSOL_SOLVER, 2, \"1(Simplified).1\", -1);
    jmi_dae_init_add_equation_block(*jmi, dae_init_block_3, NULL, 1, 0, 0, 0, 0, 0, 0, JMI_CONTINUOUS_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_KINSOL_SOLVER, 3, \"1(Simplified).2\", -1);
...
static int dae_init_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    jmi_dae_add_equation_block(*jmi, dae_block_0, NULL, 1, 3, 3, 2, 0, 2, 0, JMI_DISCRETE_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);

    jmi_dae_init_add_equation_block(*jmi, dae_init_block_0, NULL, 1, 3, 2, 2, 0, 2, 0, JMI_DISCRETE_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);
")})));
end TearingTest2;
...
const int fmi_runtime_options_map_vrefs[] = {
    ...
    10, 11, 536870935, 536870936, 536870937, 268435474, 536870938, 536870939, 536870940, 536870941,
    0
};

const int fmi_runtime_options_map_length = 30;
#define __block_jacobian_check_tol_2 ((*(jmi->z))[jmi->offs_real_pi+0])
#define __cs_rel_tol_5 ((*(jmi->z))[jmi->offs_real_pi+1])
#define __cs_step_size_7 ((*(jmi->z))[jmi->offs_real_pi+2])
#define __events_default_tol_9 ((*(jmi->z))[jmi->offs_real_pi+3])
#define __events_tol_factor_10 ((*(jmi->z))[jmi->offs_real_pi+4])
#define __nle_solver_default_tol_15 ((*(jmi->z))[jmi->offs_real_pi+5])
#define __nle_solver_max_residual_scaling_factor_17 ((*(jmi->z))[jmi->offs_real_pi+6])
#define __nle_solver_min_residual_scaling_factor_18 ((*(jmi->z))[jmi->offs_real_pi+7])
#define __nle_solver_min_tol_19 ((*(jmi->z))[jmi->offs_real_pi+8])
#define __nle_solver_regularization_tolerance_20 ((*(jmi->z))[jmi->offs_real_pi+9])
#define __nle_solver_step_limit_factor_21 ((*(jmi->z))[jmi->offs_real_pi+10])
#define __nle_solver_tol_factor_22 ((*(jmi->z))[jmi->offs_real_pi+11])
#define __block_solver_experimental_mode_3 ((*(jmi->z))[jmi->offs_integer_pi+0])
#define __cs_experimental_mode_4 ((*(jmi->z))[jmi->offs_integer_pi+1])
#define __cs_solver_6 ((*(jmi->z))[jmi->offs_integer_pi+2])
#define __iteration_variable_scaling_11 ((*(jmi->z))[jmi->offs_integer_pi+3])
#define __log_level_12 ((*(jmi->z))[jmi->offs_integer_pi+4])
#define __nle_solver_max_iter_16 ((*(jmi->z))[jmi->offs_integer_pi+5])
#define __residual_equation_scaling_26 ((*(jmi->z))[jmi->offs_integer_pi+6])
#define __block_jacobian_check_1 ((*(jmi->z))[jmi->offs_boolean_pi+0])
#define __enforce_bounds_8 ((*(jmi->z))[jmi->offs_boolean_pi+1])
#define __nle_brent_ignore_error_13 ((*(jmi->z))[jmi->offs_boolean_pi+2])
#define __nle_solver_check_jac_cond_14 ((*(jmi->z))[jmi->offs_boolean_pi+3])
#define __nle_solver_use_nominals_as_fallback_23 ((*(jmi->z))[jmi->offs_boolean_pi+4])
#define __rescale_after_singular_jac_24 ((*(jmi->z))[jmi->offs_boolean_pi+5])
#define __rescale_each_step_25 ((*(jmi->z))[jmi->offs_boolean_pi+6])
#define __runtime_log_to_file_27 ((*(jmi->z))[jmi->offs_boolean_pi+7])
#define __use_Brent_in_1d_28 ((*(jmi->z))[jmi->offs_boolean_pi+8])
#define __use_jacobian_equilibration_29 ((*(jmi->z))[jmi->offs_boolean_pi+9])
#define __use_newton_for_brent_30 ((*(jmi->z))[jmi->offs_boolean_pi+10])
...
int jmi_set_start_values_0_0(jmi_t* jmi) {
    ...
    __cs_experimental_mode_4 = (0);
    __cs_rel_tol_5 = (1.0E-6);
    __cs_solver_6 = (0);
    __cs_step_size_7 = (0.0011);
    __enforce_bounds_8 = (JMI_TRUE);
    __events_default_tol_9 = (1.0E-10);
    __events_tol_factor_10 = (1.0E-4);
    __iteration_variable_scaling_11 = (1);
    __log_level_12 = (3);
    __nle_brent_ignore_error_13 = (JMI_FALSE);
    __nle_solver_check_jac_cond_14 = (JMI_FALSE);
    __nle_solver_default_tol_15 = (1.0E-10);
    __nle_solver_max_iter_16 = (100);
    __nle_solver_max_residual_scaling_factor_17 = (1.0E10);
    __nle_solver_min_residual_scaling_factor_18 = (1.0E-10);
    __nle_solver_min_tol_19 = (1.0E-12);
    __nle_solver_regularization_tolerance_20 = (-1.0);
    __nle_solver_step_limit_factor_21 = (10.0);
    __nle_solver_tol_factor_22 = (1.0E-4);
    __nle_solver_use_nominals_as_fallback_23 = (JMI_TRUE);
    __rescale_after_singular_jac_24 = (JMI_TRUE);
    __rescale_each_step_25 = (JMI_FALSE);
    __residual_equation_scaling_26 = (1);
    __runtime_log_to_file_27 = (JMI_FALSE);
    __use_Brent_in_1d_28 = (JMI_TRUE);
    __use_jacobian_equilibration_29 = (JMI_FALSE);
    __use_newton_for_brent_30 = (JMI_TRUE);
    return ef;
}
...
C_ode_time_events
    ...
    if (SURELY_LT_ZERO(COND_EXP_EQ(_sw(0), JMI_TRUE, AD_WRAP_LITERAL(1) - (_time), 1)) || (!jmi->eventPhase && ALMOST_ZERO(COND_EXP_EQ(_sw(0), JMI_TRUE, AD_WRAP_LITERAL(1) - (_time), 1)))) {
        jmi_min_time_event(&nextEvent, 1, 1, AD_WRAP_LITERAL(1));
    }
    if (SURELY_LT_ZERO(COND_EXP_EQ(LOG_EXP_NOT(LOG_EXP_AND(_sw(0), _sw(1))), JMI_TRUE, _time - (AD_WRAP_LITERAL(1)), 1)) || (!jmi->eventPhase && ALMOST_ZERO(COND_EXP_EQ(LOG_EXP_NOT(LOG_EXP_AND(_sw(0), _sw(1))), JMI_TRUE, _time - (AD_WRAP_LITERAL(1)), 1)))) {
        jmi_min_time_event(&nextEvent, 1, 1, AD_WRAP_LITERAL(1));
    }
    if (SURELY_LT_ZERO(COND_EXP_EQ(LOG_EXP_AND(LOG_EXP_NOT(LOG_EXP_AND(_sw(0), _sw(1))), _sw(2)), JMI_TRUE, AD_WRAP_LITERAL(1) - (_time), 1))) {
        jmi_min_time_event(&nextEvent, 1, 0, AD_WRAP_LITERAL(1));
    }
    if (SURELY_LT_ZERO(COND_EXP_EQ(LOG_EXP_NOT(LOG_EXP_OR(LOG_EXP_AND(_sw(0), _sw(1)), LOG_EXP_AND(_sw(2), _sw(3)))), JMI_TRUE, _time - (AD_WRAP_LITERAL(1)), 1)) || (!jmi->eventPhase && ALMOST_ZERO(COND_EXP_EQ(LOG_EXP_NOT(LOG_EXP_OR(LOG_EXP_AND(_sw(0), _sw(1)), LOG_EXP_AND(_sw(2), _sw(3)))), JMI_TRUE, _time - (AD_WRAP_LITERAL(1)), 1)))) {
        jmi_min_time_event(&nextEvent, 1, 1, AD_WRAP_LITERAL(1));
    }
    if (SURELY_LT_ZERO(COND_EXP_EQ(LOG_EXP_AND(LOG_EXP_NOT(LOG_EXP_OR(LOG_EXP_AND(_sw(0), _sw(1)), LOG_EXP_AND(_sw(2), _sw(3)))), _sw(4)), JMI_TRUE, AD_WRAP_LITERAL(1) - (_time), 1))) {
        jmi_min_time_event(&nextEvent, 1, 0, AD_WRAP_LITERAL(1));
    }
    if (SURELY_LT_ZERO(COND_EXP_EQ(LOG_EXP_NOT(LOG_EXP_OR(LOG_EXP_OR(LOG_EXP_AND(_sw(0), _sw(1)), LOG_EXP_AND(_sw(2), _sw(3))), LOG_EXP_AND(_sw(4), _sw(5)))), JMI_TRUE, _time - (AD_WRAP_LITERAL(1)), 1))) {
        jmi_min_time_event(&nextEvent, 1, 0, AD_WRAP_LITERAL(1));
    }
    if (SURELY_LT_ZERO(COND_EXP_EQ(LOG_EXP_AND(LOG_EXP_NOT(LOG_EXP_OR(LOG_EXP_OR(LOG_EXP_AND(_sw(0), _sw(1)), LOG_EXP_AND(_sw(2), _sw(3))), LOG_EXP_AND(_sw(4), _sw(5)))), _sw(6)), JMI_TRUE, AD_WRAP_LITERAL(1) - (_time), 1)) || (!jmi->eventPhase && ALMOST_ZERO(COND_EXP_EQ(LOG_EXP_AND(LOG_EXP_NOT(LOG_EXP_OR(LOG_EXP_OR(LOG_EXP_AND(_sw(0), _sw(1)), LOG_EXP_AND(_sw(2), _sw(3))), LOG_EXP_AND(_sw(4), _sw(5)))), _sw(6)), JMI_TRUE, AD_WRAP_LITERAL(1) - (_time), 1)))) {
        jmi_min_time_event(&nextEvent, 1, 1, AD_WRAP_LITERAL(1));
    }
    *event = nextEvent;
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    if (jmi->atInitial || jmi->atEvent) {
        ...
        _sw(0) = jmi_turn_switch_time(_time - (func_CCodeGenTests_TestRelationalOp9_f_exp0(tmp_4)), _sw(0), JMI_ALMOST_EPS, jmi->eventPhase ? (JMI_REL_GEQ) : (JMI_REL_GT));
    }
    _b1_0 = _sw(0);
    pre_b1_0 = _b1_0;
    JMI_ARRAY_INIT_1(STAT, jmi_ad_var_t, jmi_array_t, tmp_3, 3, 1, 3)
...
",
    ...
    (*res)[1] = COND_EXP_EQ(_sw(0), JMI_TRUE, _x_0 - (AD_WRAP_LITERAL(2)), 1);
    (*res)[2] = COND_EXP_EQ(LOG_EXP_NOT(_sw(0)), JMI_TRUE, _x_0 - (AD_WRAP_LITERAL(3)), 1);
    (*res)[3] = COND_EXP_EQ(LOG_EXP_AND(LOG_EXP_NOT(_sw(0)), LOG_EXP_NOT(_sw(2))), JMI_TRUE, _x_0 - (AD_WRAP_LITERAL(4)), 1);
    (*res)[4] = COND_EXP_EQ(LOG_EXP_AND(LOG_EXP_AND(LOG_EXP_NOT(_sw(0)), LOG_EXP_NOT(_sw(2))), _sw(3)), JMI_TRUE, _x_0 - (AD_WRAP_LITERAL(5)), 1);
")})));
...
",
    ...
    (*res)[1] = COND_EXP_EQ(func_CCodeGenTests_TestRelationalOp12_f_exp0(tmp_1), JMI_TRUE, _x_0 - (5), 1);
...
int model_ode_derivatives_base(jmi_t* jmi) {
    ...
    _x_0 = _time + 1;
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(_x_0 - (AD_WRAP_LITERAL(4)), _sw(0), jmi->events_epsilon, JMI_REL_GT);
    }
    if (jmi->atInitial || jmi->atEvent) {
        _sw(0) = jmi_turn_switch(_x_0 - (AD_WRAP_LITERAL(4)), _sw(0), jmi->events_epsilon, JMI_REL_GT);
    }
    ...
    if (jmi->atInitial || jmi->atEvent) {
        _sw(1) = jmi_turn_switch(_x_0 - (5), _sw(1), jmi->events_epsilon, JMI_REL_GT);
    }
...
void func_CCodeGenTests_StringOperations11_f2_def0(jmi_ad_var_t x_v, jmi_ad_var_t n_v, jmi_ad_var_t* y_o) {
    ...
    i2_0ie = jmi_max(n_v, AD_WRAP_LITERAL(0)) + 1 / 2.0;
...
static int dae_init_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    jmi_dae_add_equation_block(*jmi, dae_block_0, NULL, 1, 0, 1, 1, 0, 1, 0, JMI_CONSTANT_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);

    jmi_dae_init_add_equation_block(*jmi, dae_init_block_0, NULL, 1, 0, 1, 1, 0, 1, 0, JMI_CONSTANT_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);
")})));
end ActiveSwitches1;
...
static int dae_init_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    jmi_dae_add_equation_block(*jmi, dae_block_0, NULL, 1, 0, 0, 0, 0, 1, 1, JMI_CONSTANT_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);
    jmi_dae_add_equation_block(*jmi, dae_block_1, NULL, 1, 0, 0, 0, 0, 0, 0, JMI_DISCRETE_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 1, \"2\", -1);

    jmi_dae_init_add_equation_block(*jmi, dae_init_block_0, NULL, 1, 2, 0, 0, 0, 3, 3, JMI_DISCRETE_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);
")})));
end ActiveSwitches2;
...
C_dae_init_add_blocks_residual_functions
    jmi_dae_init_add_equation_block(*jmi, dae_init_block_0, NULL, 1, 1, 0, 0, 0, 1, 1, JMI_CONSTANT_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);
...
C_dae_init_add_blocks_residual_functions
    jmi_dae_init_add_equation_block(*jmi, dae_init_block_0, NULL, 1, 1, 0, 0, 0, 0, 0, JMI_CONSTANT_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
                _sw(0) = jmi_turn_switch(_x_2 - (0), _sw(0), jmi->events_epsilon, JMI_REL_GT);
            }
            _b1_0 = _sw(0);
        }
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
                _sw(2) = jmi_turn_switch(_y_4 - (1), _sw(2), jmi->events_epsilon, JMI_REL_LT);
            }
...
static int dae_init_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    jmi_dae_add_equation_block(*jmi, dae_block_0, NULL, 1, 1, 2, 1, 0, 2, 1, JMI_CONSTANT_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);

    jmi_dae_init_add_equation_block(*jmi, dae_init_block_0, NULL, 1, 1, 2, 1, 0, 2, 1, JMI_CONSTANT_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);
")})));
...
static int dae_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    if (evaluation_mode == JMI_BLOCK_VALUE_REFERENCE) {
        ...
        memset(residual, 0, 1 * sizeof(jmi_real_t));
        if (evaluation_mode & JMI_BLOCK_EVALUATE_NON_REALS) {
            _sw(0) = jmi_turn_switch(_time - (_x_2_1), _sw(0), jmi->events_epsilon, JMI_REL_GT);
        }
...
static int dae_init_block_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* residual, int evaluation_mode) {
    ...
    jmi_dae_add_equation_block(*jmi, dae_block_0, NULL, 1, 0, 0, 0, 0, 1, 1, JMI_DISCRETE_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);

    jmi_dae_init_add_equation_block(*jmi, dae_init_block_0, NULL, 1, 0, 0, 0, 0, 1, 1, JMI_DISCRETE_VARIABILITY, JMI_CONSTANT_VARIABILITY, JMI_LINEAR_SOLVER, 0, \"1\", -1);
")})));
