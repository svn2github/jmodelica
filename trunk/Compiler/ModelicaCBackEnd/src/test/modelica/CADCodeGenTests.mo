...
void func_CADCodeGenTests_CADFunction8_f2_der_AD(jmi_array_t* x_var_a, jmi_array_t* x_der_a, jmi_array_t* y_var_a, jmi_array_t* y_der_a) {
    ...
    v_5 = jmi_array_val_1(x_var_a, 1) + AD_WRAP_LITERAL(1);
    d_5 = jmi_array_val_1(x_der_a, 1) + AD_WRAP_LITERAL(0);
    jmi_array_ref_1(tmp_var_0, 1) = v_5;
    v_6 = jmi_array_val_1(x_var_a, 2) + AD_WRAP_LITERAL(1);
    d_6 = jmi_array_val_1(x_der_a, 2) + AD_WRAP_LITERAL(0);
    jmi_array_ref_1(tmp_var_0, 2) = v_6;
    JMI_ARRAY_STATIC_INIT_1(tmp_der_0, 2)
    jmi_array_ref_1(tmp_der_0, 1) = d_5;
    jmi_array_ref_1(tmp_der_0, 2) = d_6;
    func_CADCodeGenTests_CADFunction8_f1_der_AD(tmp_var_0, tmp_der_0, temp_2_var_a, temp_2_der_a);
    v_7 = jmi_array_val_1(temp_1_var_a, 1) + jmi_array_val_1(temp_2_var_a, 1);
    d_7 = jmi_array_val_1(temp_1_der_a, 1) + jmi_array_val_1(temp_2_der_a, 1);
    jmi_array_ref_1(y_var_a, 1) = v_7;
    jmi_array_ref_1(y_der_a, 1) = d_7;
    v_8 = jmi_array_val_1(temp_1_var_a, 2) + jmi_array_val_1(temp_2_var_a, 2);
    d_8 = jmi_array_val_1(temp_1_der_a, 2) + jmi_array_val_1(temp_2_der_a, 2);
    jmi_array_ref_1(y_var_a, 2) = v_8;
    jmi_array_ref_1(y_der_a, 2) = d_8;
    func_CADCodeGenTests_CADFunction8_f1_der_AD(y_var_a, y_der_a, temp_3_var_a, temp_3_der_a);
    v_10 = jmi_array_val_1(y_var_a, 1) + jmi_array_val_1(temp_3_var_a, 1);
    d_10 = jmi_array_val_1(y_der_a, 1) + jmi_array_val_1(temp_3_der_a, 1);
    jmi_array_ref_1(y_var_a, 1) = v_10;
    jmi_array_ref_1(y_der_a, 1) = d_10;
    v_11 = jmi_array_val_1(y_var_a, 2) + jmi_array_val_1(temp_3_var_a, 2);
    d_11 = jmi_array_val_1(y_der_a, 2) + jmi_array_val_1(temp_3_der_a, 2);
    jmi_array_ref_1(y_var_a, 2) = v_11;
    jmi_array_ref_1(y_der_a, 2) = d_11;
...
void func_CADCodeGenTests_CADFunction8_f1_der_AD(jmi_array_t* x_var_a, jmi_array_t* x_der_a, jmi_array_t* y_var_a, jmi_array_t* y_der_a) {
    ...
    v_12 = jmi_array_val_1(x_var_a, 1) + 1;
    d_12 = jmi_array_val_1(x_der_a, 1) + AD_WRAP_LITERAL(0);
    jmi_array_ref_1(y_var_a, 1) = v_12;
    jmi_array_ref_1(y_der_a, 1) = d_12;
    v_13 = jmi_array_val_1(x_var_a, 2) + 1;
    d_13 = jmi_array_val_1(x_der_a, 2) + AD_WRAP_LITERAL(0);
    jmi_array_ref_1(y_var_a, 2) = v_13;
    jmi_array_ref_1(y_der_a, 2) = d_13;
    v_14 = jmi_array_val_1(y_var_a, 1) + jmi_array_val_1(x_var_a, 1);
    d_14 = jmi_array_val_1(y_der_a, 1) + jmi_array_val_1(x_der_a, 1);
    jmi_array_ref_1(y_var_a, 1) = v_14;
    jmi_array_ref_1(y_der_a, 1) = d_14;
    v_15 = jmi_array_val_1(y_var_a, 2) + jmi_array_val_1(x_var_a, 2);
    d_15 = jmi_array_val_1(y_der_a, 2) + jmi_array_val_1(x_der_a, 2);
    jmi_array_ref_1(y_var_a, 2) = v_15;
    jmi_array_ref_1(y_der_a, 2) = d_15;
    ...
    d_19 = (*dz)[jmi->offs_t];
(*res)[2] = v_19 - _x_1_0;
(*dF)[2]  = d_19 - (*dz)[jmi_get_index_from_value_ref(0)-jmi->offs_real_dx];
    v_21 = _time;
    d_21 = (*dz)[jmi->offs_t];
    v_20 = v_21 * 2;
    d_20 = (d_21 * 2 + v_21 * AD_WRAP_LITERAL(0));
(*res)[3] = v_20 - _x_2_1;
(*dF)[3]  = d_20 - (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx];
")})));
end CADFunction8;
...
,void func_CADCodeGenTests_CADDerAnno2_f_der_der_AD(jmi_ad_var_t x1_var_v, jmi_ad_var_t i1_v, jmi_ad_var_t b1_v, jmi_ad_var_t der_x1_var_v, jmi_ad_var_t x1_der_v, jmi_ad_var_t der_x1_der_v, jmi_ad_var_t* der_y1_var_o, jmi_ad_var_t* der_y1_der_o) {
    JMI_DYNAMIC_INIT()
    jmi_ad_var_t der_y1_var_v;
    jmi_ad_var_t der_y1_der_v;
...
jmi_ad_var_t v_5;
jmi_ad_var_t d_5;
v_2 = AD_WRAP_LITERAL(2) * x1_var_v;
d_2 = (AD_WRAP_LITERAL(0) * x1_var_v + AD_WRAP_LITERAL(2) * x1_der_v);
v_1 = v_2 * der_x1_var_v;
d_1 = (d_2 * der_x1_var_v + v_2 * der_x1_der_v);
v_5 = pow(x1_var_v , AD_WRAP_LITERAL(2));
if(x1_var_v== 0){
d_5=0;
} else{
d_5 = v_5 * (AD_WRAP_LITERAL(0) * log(jmi_abs(x1_var_v)) + AD_WRAP_LITERAL(2) * x1_der_v / x1_var_v);
}
v_4 = AD_WRAP_LITERAL(3) * v_5;
d_4 = (AD_WRAP_LITERAL(0) * v_5 + AD_WRAP_LITERAL(3) * d_5);
v_3 = v_4 * der_x1_var_v;
d_3 = (d_4 * der_x1_var_v + v_4 * der_x1_der_v);
 v_0 = COND_EXP_EQ(b1_v, JMI_TRUE, v_1, v_3);
 d_0 = COND_EXP_EQ(b1_v, JMI_TRUE, d_1, d_3);
der_y1_var_v = v_0;
der_y1_der_v = d_0;

if (der_y1_var_o != NULL) *der_y1_var_o = der_y1_var_v;
if (der_y1_der_o != NULL) *der_y1_der_o = der_y1_der_v;
JMI_DYNAMIC_FREE()
return;
}
...
d_12 = d_13 + d_14;
v_16 = -2.51;
d_16 = -AD_WRAP_LITERAL(0);
v_15 = v_16 * _w_ode_1_2_2;
d_15 = (d_16 * _w_ode_1_2_2 + v_16 * (*dz)[jmi_get_index_from_value_ref(6)-jmi->offs_real_dx]);
v_11 = v_12 + v_15;
d_11 = d_12 + d_15;
...
d_6 = d_7 + d_22;
v_26 = -2.89;
d_26 = -AD_WRAP_LITERAL(0);
v_25 = v_26 * _x_1_0;
d_25 = (d_26 * _x_1_0 + v_26 * (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx]);
v_24 = -v_25;
d_24 = -d_25;
v_5 = v_6 + v_24;
d_5 = d_6 + d_24;
...
d_3 = d_4 + d_28;
v_30 = -2.34;
d_30 = -AD_WRAP_LITERAL(0);
v_29 = v_30 * _ur_3_5;
d_29 = (d_30 * _ur_3_5 + v_30 * (*dz)[jmi_get_index_from_value_ref(4)-jmi->offs_real_dx]);
v_2 = v_3 + v_29;
d_2 = d_3 + d_29;
v_31 = sin(_ur_3_5);
...
d_1 = d_2 + d_31;
v_33 = -1.23;
d_33 = -AD_WRAP_LITERAL(0);
v_32 = v_33 * _ur_2_4;
d_32 = (d_33 * _ur_2_4 + v_33 * (*dz)[jmi_get_index_from_value_ref(3)-jmi->offs_real_dx]);
v_0 = v_1 + v_32;
d_0 = d_1 + d_32;
  _der_x_1_6 = v_0;
  (*dz)[jmi_get_index_from_value_ref(0)-jmi->offs_real_dx] =d_0;
...
if (evaluation_mode == JMI_BLOCK_EVALUATE_INACTIVE || evaluation_mode == JMI_BLOCK_EVALUATE|| evaluation_mode == JMI_BLOCK_WRITE_BACK ){
...
d_45 = d_46 + d_48;
v_52 = -2.01;
d_52 = -AD_WRAP_LITERAL(0);
v_51 = v_52 * _x_1_0;
d_51 = (d_52 * _x_1_0 + v_52 * (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx]);
v_50 = -v_51;
d_50 = -d_51;
v_44 = v_45 + v_50;
d_44 = d_45 + d_50;
...
d_43 = d_44 + d_53;
v_57 = -1.18;
d_57 = -AD_WRAP_LITERAL(0);
v_56 = v_57 * _x_1_0;
d_56 = (d_57 * _x_1_0 + v_57 * (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx]);
v_55 = -v_56;
d_55 = -d_56;
v_42 = v_43 + v_55;
d_42 = d_43 + d_55;
...
d_39 = d_40 + d_62;
v_66 = -1.24;
d_66 = -AD_WRAP_LITERAL(0);
v_65 = v_66 * _ur_2_4;
d_65 = (d_66 * _ur_2_4 + v_66 * (*dz)[jmi_get_index_from_value_ref(3)-jmi->offs_real_dx]);
v_64 = -v_65;
d_64 = -d_65;
v_38 = v_39 + v_64;
d_38 = d_39 + d_64;
...
v_78 = -2.1;
d_78 = -AD_WRAP_LITERAL(0);
v_77 = v_78 * _w_ode_1_1_1;
d_77 = (d_78 * _w_ode_1_1_1 + v_78 * (*dz)[jmi_get_index_from_value_ref(5)-jmi->offs_real_dx]);
...
v_16 = jmi_array_val_2(A_var_a, 1, 1) - jmi_array_val_2(X_var_a, 1, 1);
d_16 = jmi_array_val_2(A_der_a, 1, 1) - jmi_array_val_2(X_der_a, 1, 1);
jmi_array_ref_2(B_var_a, 1, 1) = v_16;
jmi_array_ref_2(B_der_a, 1, 1) = d_16;
v_17 = jmi_array_val_2(A_var_a, 1, 2) - jmi_array_val_2(X_var_a, 1, 2);
d_17 = jmi_array_val_2(A_der_a, 1, 2) - jmi_array_val_2(X_der_a, 1, 2);
jmi_array_ref_2(B_var_a, 1, 2) = v_17;
jmi_array_ref_2(B_der_a, 1, 2) = d_17;
v_18 = jmi_array_val_2(A_var_a, 2, 1) - jmi_array_val_2(X_var_a, 2, 1);
d_18 = jmi_array_val_2(A_der_a, 2, 1) - jmi_array_val_2(X_der_a, 2, 1);
jmi_array_ref_2(B_var_a, 2, 1) = v_18;
jmi_array_ref_2(B_der_a, 2, 1) = d_18;
v_19 = jmi_array_val_2(A_var_a, 2, 2) - jmi_array_val_2(X_var_a, 2, 2);
d_19 = jmi_array_val_2(A_der_a, 2, 2) - jmi_array_val_2(X_der_a, 2, 2);
jmi_array_ref_2(B_var_a, 2, 2) = v_19;
jmi_array_ref_2(B_der_a, 2, 2) = d_19;
