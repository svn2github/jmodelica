...
jmi_real_t** dz = jmi->dz;
    ...
    d_7 = d_8 + d_17;
    v_6 = v_7 + (- 2.19 * _x_1_0);
    d_6 = d_7 + - (AD_WRAP_LITERAL(0) * _x_1_0 + 2.19 * (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx]);
    v_5 = v_6 + (- sin(_x_1_0));
    d_5 = d_6 + - ((*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx] * cos(_x_1_0));
    v_4 = v_5 + (- (- 2.89) * _x_1_0);
    d_4 = d_5 + - (AD_WRAP_LITERAL(0) * _x_1_0 + (- 2.89) * (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx]);
    v_18 = 2.99 * _ur_1_3;
    d_18 = AD_WRAP_LITERAL(0) * _ur_1_3 + 2.99 * (*dz)[jmi_get_index_from_value_ref(2)-jmi->offs_real_dx];
    v_3 = v_4 + v_18;
    d_3 = d_4 + d_18;
    v_19 = sin(_ur_1_3);
    d_19 = (*dz)[jmi_get_index_from_value_ref(2)-jmi->offs_real_dx] * cos(_ur_1_3);
    v_2 = v_3 + v_19;
    d_2 = d_3 + d_19;
    v_20 = (- 2.34) * _ur_3_5;
    d_20 = AD_WRAP_LITERAL(0) * _ur_3_5 + (- 2.34) * (*dz)[jmi_get_index_from_value_ref(4)-jmi->offs_real_dx];
    v_1 = v_2 + v_20;
    d_1 = d_2 + d_20;
    v_21 = sin(_ur_3_5);
    d_21 = (*dz)[jmi_get_index_from_value_ref(4)-jmi->offs_real_dx] * cos(_ur_3_5);
    v_0 = v_1 + v_21;
    d_0 = d_1 + d_21;
    v_22 = (- 1.23) * _ur_2_4;
    d_22 = AD_WRAP_LITERAL(0) * _ur_2_4 + (- 1.23) * (*dz)[jmi_get_index_from_value_ref(3)-jmi->offs_real_dx];
    _der_x_1_6 = v_0 + v_22;
    (*dz)[jmi_get_index_from_value_ref(0)-jmi->offs_real_dx] = d_0 + d_22;
    /*********** Real outputs **********/
    /*** Integer and boolean outputs ***/
    /********* Other variables *********/
...
static int dae_block_dir_der_0(jmi_t* jmi, jmi_real_t* x, jmi_real_t* dx,jmi_real_t* residual, jmi_real_t* dRes, int evaluation_mode) {
    ...
    v_32 = - 1.3 * _w_ode_1_2_2 + (- sin(_w_ode_1_2_2));
    d_32 = - (AD_WRAP_LITERAL(0) * _w_ode_1_2_2 + 1.3 * (*dz)[jmi_get_index_from_value_ref(6)-jmi->offs_real_dx]) + - ((*dz)[jmi_get_index_from_value_ref(6)-jmi->offs_real_dx] * cos(_w_ode_1_2_2));
    v_31 = v_32 + (- (- 2.01) * _x_1_0);
    d_31 = d_32 + - (AD_WRAP_LITERAL(0) * _x_1_0 + (- 2.01) * (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx]);
    v_30 = v_31 + (- sin(_x_1_0));
    d_30 = d_31 + - ((*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx] * cos(_x_1_0));
    v_29 = v_30 + (- (- 1.18) * _x_1_0);
    d_29 = d_30 + - (AD_WRAP_LITERAL(0) * _x_1_0 + (- 1.18) * (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx]);
    v_28 = v_29 + (- 1.45 * _x_1_0);
    d_28 = d_29 + - (AD_WRAP_LITERAL(0) * _x_1_0 + 1.45 * (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx]);
    v_27 = v_28 + (- 1.09 * _ur_2_4);
    d_27 = d_28 + - (AD_WRAP_LITERAL(0) * _ur_2_4 + 1.09 * (*dz)[jmi_get_index_from_value_ref(3)-jmi->offs_real_dx]);
    v_26 = v_27 + (- sin(_ur_2_4));
    d_26 = d_27 + - ((*dz)[jmi_get_index_from_value_ref(3)-jmi->offs_real_dx] * cos(_ur_2_4));
    v_25 = v_26 + (- (- 1.24) * _ur_2_4);
    d_25 = d_26 + - (AD_WRAP_LITERAL(0) * _ur_2_4 + (- 1.24) * (*dz)[jmi_get_index_from_value_ref(3)-jmi->offs_real_dx]);
    v_24 = v_25 + (- 2.16 * _ur_3_5);
    d_24 = d_25 + - (AD_WRAP_LITERAL(0) * _ur_3_5 + 2.16 * (*dz)[jmi_get_index_from_value_ref(4)-jmi->offs_real_dx]);
    v_23 = (v_24 + (- sin(_ur_3_5)));
    d_23 = d_24 + - ((*dz)[jmi_get_index_from_value_ref(4)-jmi->offs_real_dx] * cos(_ur_3_5));
    _w_ode_1_1_1 = jmi_divide_equation(jmi, v_23,20,\"(- 1.3 * w_ode_1_2 + (- sin(w_ode_1_2)) + (- (- 2.01) * x_1) + (- sin(x_1)) + (- (- 1.18) * x_1) + (- 1.45 * x_1) + (- 1.09 * ur_2) + (- sin(ur_2)) + (- (- 1.24) * ur_2) + (- 2.16 * ur_3) + (- sin(ur_3))) / 20\");
    (*dz)[jmi_get_index_from_value_ref(5)-jmi->offs_real_dx] = (d_23 * 20 - v_23 * AD_WRAP_LITERAL(0)) / (20 * 20);
    if (evaluation_mode == JMI_BLOCK_EVALUATE_INACTIVE || evaluation_mode == JMI_BLOCK_EVALUATE) {
        v_36 = _w_ode_1_2_2 * 20;
        d_36 = (*dz)[jmi_get_index_from_value_ref(6)-jmi->offs_real_dx] * 20 + _w_ode_1_2_2 * AD_WRAP_LITERAL(0);
        v_38 = (- 2.1) * _w_ode_1_1_1;
        d_38 = AD_WRAP_LITERAL(0) * _w_ode_1_1_1 + (- 2.1) * (*dz)[jmi_get_index_from_value_ref(5)-jmi->offs_real_dx];
        v_39 = sin(_w_ode_1_1_1);
        d_39 = (*dz)[jmi_get_index_from_value_ref(5)-jmi->offs_real_dx] * cos(_w_ode_1_1_1);
        v_37 = (v_38 + v_39);
        d_37 = d_38 + d_39;
        v_35 = v_36 + v_37;
        d_35 = d_36 + d_37;
        v_41 = 1.63 * _x_1_0;
        d_41 = AD_WRAP_LITERAL(0) * _x_1_0 + 1.63 * (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx];
        v_42 = sin(_x_1_0);
        ...
        d_34 = d_35 + d_40;
        v_44 = 2.59 * _x_1_0;
        d_44 = AD_WRAP_LITERAL(0) * _x_1_0 + 2.59 * (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx];
        v_45 = sin(_x_1_0);
        d_45 = (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx] * cos(_x_1_0);
        v_43 = (v_44 + v_45);
        d_43 = d_44 + d_45;
        v_33 = v_34 + v_43;
        d_33 = d_34 + d_43;
        v_46 = 2.05 * _x_1_0;
        d_46 = AD_WRAP_LITERAL(0) * _x_1_0 + 2.05 * (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx];
        (*res)[0] = 0 - (v_33 - v_46);
        (*dF)[0] = AD_WRAP_LITERAL(0) - (d_33 - d_46);
...
static int dae_block_dir_der_1(jmi_t* jmi, jmi_real_t* x, jmi_real_t* dx,jmi_real_t* residual, jmi_real_t* dRes, int evaluation_mode) {
    ...
    v_0 = (- _c_2 + _b_1);
    d_0 = - ((*dz)[jmi_get_index_from_value_ref(2)-jmi->offs_real_dx]) + (*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx];
    _a_0 = jmi_divide_equation(jmi, v_0,(- 1.0),\"(- c + b) / (- 1.0)\");
    (*dz)[jmi_get_index_from_value_ref(0)-jmi->offs_real_dx] = (d_0 * (- 1.0) - v_0 * AD_WRAP_LITERAL(0)) / ((- 1.0) * (- 1.0));
    if (evaluation_mode == JMI_BLOCK_EVALUATE_INACTIVE || evaluation_mode == JMI_BLOCK_EVALUATE) {
        (*res)[0] = _c_2 * _a_0 - (20);
...
void func_CADCodeGenTests_CADExpInFuncArg1_f1_der_AD(jmi_ad_var_t x_var_v, jmi_ad_var_t x_der_v, jmi_ad_var_t* y_var_o, jmi_ad_var_t* y_der_o) {
    ...
    func_CADCodeGenTests_CADExpInFuncArg1_f2_der_AD(v_6, d_6, &v_5, &d_5);
    v_4 = (1.0 / (v_5) / (v_5));
    y_var_v = v_4;
...
jmi_ad_var_t tmp_der_5;
    if (_sw(0)) {
      ...
      if (_sw(1)) {
        ...
        func_CADCodeGenTests_dummyFunc_der_AD(v_3, d_3, &tmp_var_2, &tmp_var_3, &tmp_der_2, &tmp_der_3);
        ...
        func_CADCodeGenTests_dummyFunc_der_AD(_time, (*dz)[jmi->offs_t], &tmp_var_4, &tmp_var_5, &tmp_der_4, &tmp_der_5);
