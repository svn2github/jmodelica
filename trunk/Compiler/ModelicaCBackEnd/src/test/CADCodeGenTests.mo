...
jmi_ad_var_t tmp_der_6;
    ...
    (*res)[2] = tmp_var_1 - (_der_x1_15);
    (*dF)[2] = tmp_der_1 - ((*dz)[jmi_get_index_from_value_ref(1)-jmi->offs_real_dx]);
    (*res)[3] = tmp_var_2 - (_der_x2_16);
    (*dF)[3] = tmp_der_2 - ((*dz)[jmi_get_index_from_value_ref(2)-jmi->offs_real_dx]);
