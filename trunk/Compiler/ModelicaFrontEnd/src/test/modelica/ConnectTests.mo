...
fclass ConnectTests.CauerLowPassAnalog
 ...
 Modelica.SIunits.Voltage C1.v(start = 0,fixed = true) \"Voltage drop between the two pins (= p.v - n.v)\";
 ...
 Modelica.SIunits.Voltage C2.v(start = 0) \"Voltage drop between the two pins (= p.v - n.v)\";
 ...
 Modelica.SIunits.Voltage C3.v(start = 0,fixed = true) \"Voltage drop between the two pins (= p.v - n.v)\";
 ...
 Modelica.SIunits.Voltage C4.v(start = 0) \"Voltage drop between the two pins (= p.v - n.v)\";
 ...
 Modelica.SIunits.Voltage C5.v(start = 0,fixed = true) \"Voltage drop between the two pins (= p.v - n.v)\";
 ...
 Modelica.SIunits.Current L1.i(start = 0,fixed = true) \"Current flowing from pin p to pin n\";
 ...
 Modelica.SIunits.Current L2.i(start = 0,fixed = true) \"Current flowing from pin p to pin n\";
