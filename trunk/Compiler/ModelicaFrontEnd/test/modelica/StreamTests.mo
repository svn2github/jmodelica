...
equation
 ...
 a2.c.s = 2;
 a3.c.s = 3;
 x1 = (max(- a2.c.f, _inStreamEpsilon) * a2.c.s + max(- a3.c.f, _inStreamEpsilon) * a3.c.s) / (max(- a2.c.f, _inStreamEpsilon) + max(- a3.c.f, _inStreamEpsilon));
 x2 = (max(- a1.c.f, _inStreamEpsilon) * a1.c.s + max(- a3.c.f, _inStreamEpsilon) * a3.c.s) / (max(- a1.c.f, _inStreamEpsilon) + max(- a3.c.f, _inStreamEpsilon));
 x3 = (max(- a1.c.f, _inStreamEpsilon) * a1.c.s + max(- a2.c.f, _inStreamEpsilon) * a2.c.s) / (max(- a1.c.f, _inStreamEpsilon) + max(- a2.c.f, _inStreamEpsilon));
...
equation
 ...
 a1.c.p = a2.c.p;
 a2.c.p = c.p;
 c.s = (max(- a1.c.f, _inStreamEpsilon) * a1.c.s + max(- a2.c.f, _inStreamEpsilon) * a2.c.s) / (max(- a1.c.f, _inStreamEpsilon) + max(- a2.c.f, _inStreamEpsilon));
 c.f = 0;
 a1.c.p = 4;
 a1.c.f = time;
 a1.c.s = 1;
 a2.c.s = 2;
 x1 = (max(- a2.c.f, _inStreamEpsilon) * a2.c.s + max(c.f, _inStreamEpsilon) * c.s) / (max(- a2.c.f, _inStreamEpsilon) + max(c.f, _inStreamEpsilon));
 x2 = (max(- a1.c.f, _inStreamEpsilon) * a1.c.s + max(c.f, _inStreamEpsilon) * c.s) / (max(- a1.c.f, _inStreamEpsilon) + max(c.f, _inStreamEpsilon));
 x3 = c.s;
...
equation
 ...
 a.c.p = c1.p;
 c1.p = c2.p;
 c1.s = (max(- a.c.f, _inStreamEpsilon) * a.c.s + max(c2.f, _inStreamEpsilon) * c2.s) / (max(- a.c.f, _inStreamEpsilon) + max(c2.f, _inStreamEpsilon));
 c2.s = (max(- a.c.f, _inStreamEpsilon) * a.c.s + max(c1.f, _inStreamEpsilon) * c1.s) / (max(- a.c.f, _inStreamEpsilon) + max(c1.f, _inStreamEpsilon));
 c1.f = 0;
 c2.f = 0;
 a.c.p = 2;
 a.c.s = 1;
 x1 = (max(c1.f, _inStreamEpsilon) * c1.s + max(c2.f, _inStreamEpsilon) * c2.s) / (max(c1.f, _inStreamEpsilon) + max(c2.f, _inStreamEpsilon));
 x2 = c1.s;
 x3 = c2.s;
...
equation
 ...
 a.c1.p = a.c2.p;
 a.c2.p = a.c3.p;
 a.c1.s = (max(a.c2.f, _inStreamEpsilon) * b.c5.s + max(a.c3.f, _inStreamEpsilon) * b.c6.s) / (max(a.c2.f, _inStreamEpsilon) + max(a.c3.f, _inStreamEpsilon));
 a.c2.s = (max(a.c1.f, _inStreamEpsilon) * b.c4.s + max(a.c3.f, _inStreamEpsilon) * b.c6.s) / (max(a.c1.f, _inStreamEpsilon) + max(a.c3.f, _inStreamEpsilon));
 a.c3.s = (max(a.c1.f, _inStreamEpsilon) * b.c4.s + max(a.c2.f, _inStreamEpsilon) * b.c5.s) / (max(a.c1.f, _inStreamEpsilon) + max(a.c2.f, _inStreamEpsilon));
 a.x1 = b.c4.s;
 a.x2 = b.c5.s;
 a.x3 = b.c6.s;
 b.c4.p = 7;
...
equation
 ...
 a2.c.p = c1.p;
 c1.p = c2.p;
 c1.s = (max(- a1.c.f, _inStreamEpsilon) * a1.c.s + max(- a2.c.f, _inStreamEpsilon) * a2.c.s + max(c2.f, _inStreamEpsilon) * c2.s) / (max(- a1.c.f, _inStreamEpsilon) + max(- a2.c.f, _inStreamEpsilon) + max(c2.f, _inStreamEpsilon));
 c2.s = (max(- a1.c.f, _inStreamEpsilon) * a1.c.s + max(- a2.c.f, _inStreamEpsilon) * a2.c.s + max(c1.f, _inStreamEpsilon) * c1.s) / (max(- a1.c.f, _inStreamEpsilon) + max(- a2.c.f, _inStreamEpsilon) + max(c1.f, _inStreamEpsilon));
 c1.f = 0;
 c2.f = 0;
 a1.c.p = 4;
 a1.c.f = time;
 a1.c.s = 1;
 a2.c.s = 2;
 x1 = (max(- a2.c.f, _inStreamEpsilon) * a2.c.s + max(c1.f, _inStreamEpsilon) * c1.s + max(c2.f, _inStreamEpsilon) * c2.s) / (max(- a2.c.f, _inStreamEpsilon) + max(c1.f, _inStreamEpsilon) + max(c2.f, _inStreamEpsilon));
 x2 = (max(- a1.c.f, _inStreamEpsilon) * a1.c.s + max(c1.f, _inStreamEpsilon) * c1.s + max(c2.f, _inStreamEpsilon) * c2.s) / (max(- a1.c.f, _inStreamEpsilon) + max(c1.f, _inStreamEpsilon) + max(c2.f, _inStreamEpsilon));
 x3 = c1.s;
 x4 = c2.s;
...
equation
 ...
 a2.c.p = c1.p;
 c1.p = c2.p;
 c1.s = (max(- a2.c.f, _inStreamEpsilon) * a2.c.s + max(c2.f, _inStreamEpsilon) * c2.s) / (max(- a2.c.f, _inStreamEpsilon) + max(c2.f, _inStreamEpsilon));
 c2.s = a2.c.s;
 c1.f = 0;
 c2.f = 0;
 a1.c.p = 4;
 ...
 a1.c.s = 1;
 a2.c.s = 2;
 x1 = (max(- a2.c.f, _inStreamEpsilon) * a2.c.s + max(c2.f, _inStreamEpsilon) * c2.s) / (max(- a2.c.f, _inStreamEpsilon) + max(c2.f, _inStreamEpsilon));
 x2 = c2.s;
...
equation
 ...
 a.c1.p = a.c2.p;
 a.c2.p = a.c3.p;
 a.c1.s = (max(a.c2.f, _inStreamEpsilon * 0.1) * b.c5.s + max(a.c3.f, _inStreamEpsilon * 0.1) * b.c6.s) / (max(a.c2.f, _inStreamEpsilon * 0.1) + max(a.c3.f, _inStreamEpsilon * 0.1));
 a.c2.s = (max(a.c1.f, _inStreamEpsilon * 0.1) * b.c4.s + max(a.c3.f, _inStreamEpsilon * 0.1) * b.c6.s) / (max(a.c1.f, _inStreamEpsilon * 0.1) + max(a.c3.f, _inStreamEpsilon * 0.1));
 a.c3.s = (max(a.c1.f, _inStreamEpsilon * 0.1) * b.c4.s + max(a.c2.f, _inStreamEpsilon * 0.1) * b.c5.s) / (max(a.c1.f, _inStreamEpsilon * 0.1) + max(a.c2.f, _inStreamEpsilon * 0.1));
 a.x1 = b.c4.s;
 a.x2 = b.c5.s;
 a.x3 = b.c6.s;
 b.c4.p = 7;
...
equation
 ...
 a.c1.p = a.c2.p;
 a.c2.p = a.c3.p;
 a.c1.s = (max(a.c2.f, _inStreamEpsilon * 2.0) * b.c5.s + max(a.c3.f, _inStreamEpsilon * 2.0) * b.c6.s) / (max(a.c2.f, _inStreamEpsilon * 2.0) + max(a.c3.f, _inStreamEpsilon * 2.0));
 a.c2.s = (max(a.c1.f, _inStreamEpsilon * 2.0) * b.c4.s + max(a.c3.f, _inStreamEpsilon * 2.0) * b.c6.s) / (max(a.c1.f, _inStreamEpsilon * 2.0) + max(a.c3.f, _inStreamEpsilon * 2.0));
 a.c3.s = (max(a.c1.f, _inStreamEpsilon * 2.0) * b.c4.s + max(a.c2.f, _inStreamEpsilon * 2.0) * b.c5.s) / (max(a.c1.f, _inStreamEpsilon * 2.0) + max(a.c2.f, _inStreamEpsilon * 2.0));
 a.x1 = b.c4.s;
 a.x2 = b.c5.s;
 a.x3 = b.c6.s;
 b.c4.p = 7;
...
equation
 ...
 a.c1.f = time;
 a.c3.f = 2 * time;
 a.x1 = (max(- a.c2.f, _inStreamEpsilon) * 5.0 + max(- a.c3.f, _inStreamEpsilon) * 6.0) / (max(- a.c2.f, _inStreamEpsilon) + max(- a.c3.f, _inStreamEpsilon));
 a.x2 = (max(- a.c1.f, _inStreamEpsilon) * 4.0 + max(- a.c3.f, _inStreamEpsilon) * 6.0) / (max(- a.c1.f, _inStreamEpsilon) + max(- a.c3.f, _inStreamEpsilon));
 a.x3 = (max(- a.c1.f, _inStreamEpsilon) * 4.0 + max(- a.c2.f, _inStreamEpsilon) * 5.0) / (max(- a.c1.f, _inStreamEpsilon) + max(- a.c2.f, _inStreamEpsilon));
 y1 = ((noEvent(if - a.c2.f > _inStreamEpsilon then - a.c2._der_f else 0.0) * 5.0 + noEvent(if - a.c3.f > _inStreamEpsilon then - a.c3._der_f else 0.0) * 6.0) * (max(- a.c2.f, _inStreamEpsilon) + max(- a.c3.f, _inStreamEpsilon)) - (max(- a.c2.f, _inStreamEpsilon) * 5.0 + max(- a.c3.f, _inStreamEpsilon) * 6.0) * (noEvent(if - a.c2.f > _inStreamEpsilon then - a.c2._der_f else 0.0) + noEvent(if - a.c3.f > _inStreamEpsilon then - a.c3._der_f else 0.0))) / (max(- a.c2.f, _inStreamEpsilon) + max(- a.c3.f, _inStreamEpsilon)) ^ 2;
 y2 = (((noEvent(if - a.c2.f > _inStreamEpsilon then - a.c2._der_f else 0.0) * 5.0 + noEvent(if - a.c3.f > _inStreamEpsilon then - a.c3._der_f else 0.0) * 6.0) * (noEvent(if - a.c2.f > _inStreamEpsilon then - a.c2._der_f else 0.0) + noEvent(if - a.c3.f > _inStreamEpsilon then - a.c3._der_f else 0.0)) + (noEvent(if - a.c2.f > _inStreamEpsilon then - der(a.c2._der_f) else 0.0) * 5.0 + noEvent(if - a.c3.f > _inStreamEpsilon then - der(a.c3._der_f) else 0.0) * 6.0) * (max(- a.c2.f, _inStreamEpsilon) + max(- a.c3.f, _inStreamEpsilon)) - ((max(- a.c2.f, _inStreamEpsilon) * 5.0 + max(- a.c3.f, _inStreamEpsilon) * 6.0) * (noEvent(if - a.c2.f > _inStreamEpsilon then - der(a.c2._der_f) else 0.0) + noEvent(if - a.c3.f > _inStreamEpsilon then - der(a.c3._der_f) else 0.0)) + (noEvent(if - a.c2.f > _inStreamEpsilon then - a.c2._der_f else 0.0) * 5.0 + noEvent(if - a.c3.f > _inStreamEpsilon then - a.c3._der_f else 0.0) * 6.0) * (noEvent(if - a.c2.f > _inStreamEpsilon then - a.c2._der_f else 0.0) + noEvent(if - a.c3.f > _inStreamEpsilon then - a.c3._der_f else 0.0)))) * (max(- a.c2.f, _inStreamEpsilon) + max(- a.c3.f, _inStreamEpsilon)) ^ 2 - ((noEvent(if - a.c2.f > _inStreamEpsilon then - a.c2._der_f else 0.0) * 5.0 + noEvent(if - a.c3.f > _inStreamEpsilon then - a.c3._der_f else 0.0) * 6.0) * (max(- a.c2.f, _inStreamEpsilon) + max(- a.c3.f, _inStreamEpsilon)) - (max(- a.c2.f, _inStreamEpsilon) * 5.0 + max(- a.c3.f, _inStreamEpsilon) * 6.0) * (noEvent(if - a.c2.f > _inStreamEpsilon then - a.c2._der_f else 0.0) + noEvent(if - a.c3.f > _inStreamEpsilon then - a.c3._der_f else 0.0))) * (2 * (max(- a.c2.f, _inStreamEpsilon) + max(- a.c3.f, _inStreamEpsilon)) * (noEvent(if - a.c2.f > _inStreamEpsilon then - a.c2._der_f else 0.0) + noEvent(if - a.c3.f > _inStreamEpsilon then - a.c3._der_f else 0.0)))) / ((max(- a.c2.f, _inStreamEpsilon) + max(- a.c3.f, _inStreamEpsilon)) ^ 2) ^ 2;
...
equation
 ...
 a2[2].c.p = c1[2].p;
 c1[2].p = c2[2].p;
 c1[2].s = (max(- a1[2].c.f, _inStreamEpsilon) * a1[2].c.s + max(- a2[2].c.f, _inStreamEpsilon) * a2[2].c.s) / (max(- a1[2].c.f, _inStreamEpsilon) + max(- a2[2].c.f, _inStreamEpsilon));
 c2[2].s = (max(- a1[2].c.f, _inStreamEpsilon) * a1[2].c.s + max(- a2[2].c.f, _inStreamEpsilon) * a2[2].c.s) / (max(- a1[2].c.f, _inStreamEpsilon) + max(- a2[2].c.f, _inStreamEpsilon));
 a1[2].c.p = 4 * time;
 a1[2].c.f = time;
 a1[2].c.s = 2 * time;
 a2[2].c.s = 6 * time;
...
fclass StreamTests.StreamWithConst4
 ...
 Real x3;
equation
 x1 = (max(- a2.c.f, _inStreamEpsilon) * 3.0 + max(- a3.c.f, _inStreamEpsilon) * 4.0) / (max(- a2.c.f, _inStreamEpsilon) + max(- a3.c.f, _inStreamEpsilon));
 x2 = 4.0;
 x3 = 3.0;
 a2.c.f + a3.c.f = 0;
 a1.c.s = 2 * time;
...
initial equation 
 ...
 y3 = 0.0;
equation
 x1 = (max(- der(y2), _inStreamEpsilon) * a2.c.s + max(- der(y3), _inStreamEpsilon) * a3.c.s) / (max(- der(y2), _inStreamEpsilon) + max(- der(y3), _inStreamEpsilon));
 x2 = (max(- der(y1), _inStreamEpsilon) * a1.c.s + max(- der(y3), _inStreamEpsilon) * a3.c.s) / (max(- der(y1), _inStreamEpsilon) + max(- der(y3), _inStreamEpsilon));
 x3 = (max(- der(y1), _inStreamEpsilon) * a1.c.s + max(- der(y2), _inStreamEpsilon) * a2.c.s) / (max(- der(y1), _inStreamEpsilon) + max(- der(y2), _inStreamEpsilon));
 a1.c.f = der(y1);
 a2.c.f = der(y2);
 a3.c.f = der(y3);
