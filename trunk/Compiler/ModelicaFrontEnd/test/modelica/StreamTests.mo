...
equation
 ...
 a2.c.s = 2;
 a3.c.s = 3;
 x1 = ((_stream_s_1 * max(- a2.c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon) * a2.c.s + (_stream_s_1 * max(- a3.c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon) * a3.c.s) / (_stream_s_1 * max(- a2.c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon + (_stream_s_1 * max(- a3.c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon));
 x2 = ((_stream_s_2 * max(- a1.c.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon) * a1.c.s + (_stream_s_2 * max(- a3.c.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon) * a3.c.s) / (_stream_s_2 * max(- a1.c.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon + (_stream_s_2 * max(- a3.c.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon));
 x3 = ((_stream_s_3 * max(- a1.c.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon) * a1.c.s + (_stream_s_3 * max(- a2.c.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon) * a2.c.s) / (_stream_s_3 * max(- a1.c.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon + (_stream_s_3 * max(- a2.c.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon));
...
equation
 ...
 a1.c.p = a2.c.p;
 a2.c.p = c.p;
 c.s = ((_stream_s_1 * max(- a1.c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon) * a1.c.s + (_stream_s_1 * max(- a2.c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon) * a2.c.s) / (_stream_s_1 * max(- a1.c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon + (_stream_s_1 * max(- a2.c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon));
 c.f = 0;
 a1.c.p = 4;
 a1.c.f = time;
 a1.c.s = 1;
 a2.c.s = 2;
 x1 = ((_stream_s_2 * max(- a2.c.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon) * a2.c.s + (_stream_s_2 * max(c.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon) * c.s) / (_stream_s_2 * max(- a2.c.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon + (_stream_s_2 * max(c.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon));
 x2 = ((_stream_s_3 * max(- a1.c.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon) * a1.c.s + (_stream_s_3 * max(c.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon) * c.s) / (_stream_s_3 * max(- a1.c.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon + (_stream_s_3 * max(c.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon));
 x3 = c.s;
...
equation
 ...
 a.c.p = c1.p;
 c1.p = c2.p;
 c1.s = ((_stream_s_1 * max(- a.c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon) * a.c.s + (_stream_s_1 * max(c2.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon) * c2.s) / (_stream_s_1 * max(- a.c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon + (_stream_s_1 * max(c2.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon));
 c2.s = ((_stream_s_2 * max(- a.c.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon) * a.c.s + (_stream_s_2 * max(c1.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon) * c1.s) / (_stream_s_2 * max(- a.c.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon + (_stream_s_2 * max(c1.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon));
 c1.f = 0;
 c2.f = 0;
 a.c.p = 2;
 a.c.s = 1;
 x1 = ((_stream_s_3 * max(c1.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon) * c1.s + (_stream_s_3 * max(c2.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon) * c2.s) / (_stream_s_3 * max(c1.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon + (_stream_s_3 * max(c2.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon));
 x2 = c1.s;
 x3 = c2.s;
...
equation
 ...
 a.c1.p = a.c2.p;
 a.c2.p = a.c3.p;
 a.c1.s = ((_stream_s_1 * max(a.c2.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon) * b.c5.s + (_stream_s_1 * max(a.c3.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon) * b.c6.s) / (_stream_s_1 * max(a.c2.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon + (_stream_s_1 * max(a.c3.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon));
 a.c2.s = ((_stream_s_2 * max(a.c1.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon) * b.c4.s + (_stream_s_2 * max(a.c3.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon) * b.c6.s) / (_stream_s_2 * max(a.c1.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon + (_stream_s_2 * max(a.c3.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon));
 a.c3.s = ((_stream_s_3 * max(a.c1.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon) * b.c4.s + (_stream_s_3 * max(a.c2.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon) * b.c5.s) / (_stream_s_3 * max(a.c1.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon + (_stream_s_3 * max(a.c2.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon));
 a.x1 = b.c4.s;
 a.x2 = b.c5.s;
 a.x3 = b.c6.s;
 b.c4.p = 7;
...
equation
 ...
 a2.c.p = c1.p;
 c1.p = c2.p;
 c1.s = ((_stream_s_1 * max(- a1.c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon) * a1.c.s + (_stream_s_1 * max(- a2.c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon) * a2.c.s + (_stream_s_1 * max(c2.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon) * c2.s) / (_stream_s_1 * max(- a1.c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon + (_stream_s_1 * max(- a2.c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon) + (_stream_s_1 * max(c2.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon));
 c2.s = ((_stream_s_2 * max(- a1.c.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon) * a1.c.s + (_stream_s_2 * max(- a2.c.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon) * a2.c.s + (_stream_s_2 * max(c1.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon) * c1.s) / (_stream_s_2 * max(- a1.c.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon + (_stream_s_2 * max(- a2.c.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon) + (_stream_s_2 * max(c1.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon));
 c1.f = 0;
 c2.f = 0;
 a1.c.p = 4;
 a1.c.f = time;
 a1.c.s = 1;
 a2.c.s = 2;
 x1 = ((_stream_s_3 * max(- a2.c.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon) * a2.c.s + (_stream_s_3 * max(c1.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon) * c1.s + (_stream_s_3 * max(c2.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon) * c2.s) / (_stream_s_3 * max(- a2.c.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon + (_stream_s_3 * max(c1.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon) + (_stream_s_3 * max(c2.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon));
 x2 = ((_stream_s_4 * max(- a1.c.f, 0) + (1 - _stream_s_4) * _inStreamEpsilon) * a1.c.s + (_stream_s_4 * max(c1.f, 0) + (1 - _stream_s_4) * _inStreamEpsilon) * c1.s + (_stream_s_4 * max(c2.f, 0) + (1 - _stream_s_4) * _inStreamEpsilon) * c2.s) / (_stream_s_4 * max(- a1.c.f, 0) + (1 - _stream_s_4) * _inStreamEpsilon + (_stream_s_4 * max(c1.f, 0) + (1 - _stream_s_4) * _inStreamEpsilon) + (_stream_s_4 * max(c2.f, 0) + (1 - _stream_s_4) * _inStreamEpsilon));
 x3 = c1.s;
 x4 = c2.s;
...
equation
 ...
 a2.c.p = c1.p;
 c1.p = c2.p;
 c1.s = ((_stream_s_1 * max(- a2.c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon) * a2.c.s + (_stream_s_1 * max(c2.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon) * c2.s) / (_stream_s_1 * max(- a2.c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon + (_stream_s_1 * max(c2.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon));
 c2.s = a2.c.s;
 c1.f = 0;
 c2.f = 0;
 a1.c.p = 4;
 ...
 a1.c.s = 1;
 a2.c.s = 2;
 x1 = ((_stream_s_2 * max(- a2.c.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon) * a2.c.s + (_stream_s_2 * max(c2.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon) * c2.s) / (_stream_s_2 * max(- a2.c.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon + (_stream_s_2 * max(c2.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon));
 x2 = c2.s;
 _stream_s_1 = max(c2.f, 0) + max(- a2.c.f, 0);
 _stream_alpha_1 = smooth(1, if _stream_s_1 > _inStreamEpsilon then 1 elseif _stream_s_1 > 0 then _stream_s_1 / _inStreamEpsilon * (_stream_s_1 / _inStreamEpsilon * (3 - 2 * _stream_s_1)) else 0);
 _stream_s_2 = max(c2.f, 0) + max(- a2.c.f, 0);
 _stream_alpha_2 = smooth(1, if _stream_s_2 > _inStreamEpsilon then 1 elseif _stream_s_2 > 0 then _stream_s_2 / _inStreamEpsilon * (_stream_s_2 / _inStreamEpsilon * (3 - 2 * _stream_s_2)) else 0);
...
equation
 ...
 a.c1.p = a.c2.p;
 a.c2.p = a.c3.p;
 a.c1.s = ((_stream_s_1 * max(a.c2.f, 0) + (1 - _stream_s_1) * (_inStreamEpsilon * 0.1)) * b.c5.s + (_stream_s_1 * max(a.c3.f, 0) + (1 - _stream_s_1) * (_inStreamEpsilon * 0.1)) * b.c6.s) / (_stream_s_1 * max(a.c2.f, 0) + (1 - _stream_s_1) * (_inStreamEpsilon * 0.1) + (_stream_s_1 * max(a.c3.f, 0) + (1 - _stream_s_1) * (_inStreamEpsilon * 0.1)));
 a.c2.s = ((_stream_s_2 * max(a.c1.f, 0) + (1 - _stream_s_2) * (_inStreamEpsilon * 0.1)) * b.c4.s + (_stream_s_2 * max(a.c3.f, 0) + (1 - _stream_s_2) * (_inStreamEpsilon * 0.1)) * b.c6.s) / (_stream_s_2 * max(a.c1.f, 0) + (1 - _stream_s_2) * (_inStreamEpsilon * 0.1) + (_stream_s_2 * max(a.c3.f, 0) + (1 - _stream_s_2) * (_inStreamEpsilon * 0.1)));
 a.c3.s = ((_stream_s_3 * max(a.c1.f, 0) + (1 - _stream_s_3) * (_inStreamEpsilon * 0.1)) * b.c4.s + (_stream_s_3 * max(a.c2.f, 0) + (1 - _stream_s_3) * (_inStreamEpsilon * 0.1)) * b.c5.s) / (_stream_s_3 * max(a.c1.f, 0) + (1 - _stream_s_3) * (_inStreamEpsilon * 0.1) + (_stream_s_3 * max(a.c2.f, 0) + (1 - _stream_s_3) * (_inStreamEpsilon * 0.1)));
 a.x1 = b.c4.s;
 a.x2 = b.c5.s;
 a.x3 = b.c6.s;
 b.c4.p = 7;
...
equation
 ...
 a.c1.p = a.c2.p;
 a.c2.p = a.c3.p;
 a.c1.s = ((_stream_s_1 * max(a.c2.f, 0) + (1 - _stream_s_1) * (_inStreamEpsilon * 2.0)) * b.c5.s + (_stream_s_1 * max(a.c3.f, 0) + (1 - _stream_s_1) * (_inStreamEpsilon * 2.0)) * b.c6.s) / (_stream_s_1 * max(a.c2.f, 0) + (1 - _stream_s_1) * (_inStreamEpsilon * 2.0) + (_stream_s_1 * max(a.c3.f, 0) + (1 - _stream_s_1) * (_inStreamEpsilon * 2.0)));
 a.c2.s = ((_stream_s_2 * max(a.c1.f, 0) + (1 - _stream_s_2) * (_inStreamEpsilon * 2.0)) * b.c4.s + (_stream_s_2 * max(a.c3.f, 0) + (1 - _stream_s_2) * (_inStreamEpsilon * 2.0)) * b.c6.s) / (_stream_s_2 * max(a.c1.f, 0) + (1 - _stream_s_2) * (_inStreamEpsilon * 2.0) + (_stream_s_2 * max(a.c3.f, 0) + (1 - _stream_s_2) * (_inStreamEpsilon * 2.0)));
 a.c3.s = ((_stream_s_3 * max(a.c1.f, 0) + (1 - _stream_s_3) * (_inStreamEpsilon * 2.0)) * b.c4.s + (_stream_s_3 * max(a.c2.f, 0) + (1 - _stream_s_3) * (_inStreamEpsilon * 2.0)) * b.c5.s) / (_stream_s_3 * max(a.c1.f, 0) + (1 - _stream_s_3) * (_inStreamEpsilon * 2.0) + (_stream_s_3 * max(a.c2.f, 0) + (1 - _stream_s_3) * (_inStreamEpsilon * 2.0)));
 a.x1 = b.c4.s;
 a.x2 = b.c5.s;
 a.x3 = b.c6.s;
 b.c4.p = 7;
...
equation
 ...
 a.c1.s = b.c5.s;
 a.c2.s = b.c4.s;
 a.c3.s = ((_stream_s_1 * max(a.c1.f, 0) + (1 - _stream_s_1) * (_inStreamEpsilon * 2.0)) * b.c4.s + (_stream_s_1 * max(a.c2.f, 0) + (1 - _stream_s_1) * (_inStreamEpsilon * 2.0)) * b.c5.s) / (_stream_s_1 * max(a.c1.f, 0) + (1 - _stream_s_1) * (_inStreamEpsilon * 2.0) + (_stream_s_1 * max(a.c2.f, 0) + (1 - _stream_s_1) * (_inStreamEpsilon * 2.0)));
 a.x1 = b.c4.s;
 a.x2 = b.c5.s;
 a.x3 = b.c6.s;
 b.c4.p = 7;
 ...
 b.c6.f = 9;
 b.c6.s = 6;
 _stream_s_1 = max(a.c2.f, 0) + max(a.c1.f, 0);
 _stream_alpha_1 = smooth(1, if _stream_s_1 > _inStreamEpsilon * 2.0 then 1 elseif _stream_s_1 > 0 then _stream_s_1 / (_inStreamEpsilon * 2.0) * (_stream_s_1 / (_inStreamEpsilon * 2.0) * (3 - 2 * _stream_s_1)) else 0);
...
equation
 ...
 a.c1.f = time;
 a.c3.f = 2 * time;
 a.x1 = ((_stream_s_1 * max(- a.c2.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon) * 5.0 + (_stream_s_1 * max(- a.c3.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon) * 6.0) / (_stream_s_1 * max(- a.c2.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon + (_stream_s_1 * max(- a.c3.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon));
 a.x2 = ((_stream_s_2 * max(- a.c1.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon) * 4.0 + (_stream_s_2 * max(- a.c3.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon) * 6.0) / (_stream_s_2 * max(- a.c1.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon + (_stream_s_2 * max(- a.c3.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon));
 a.x3 = ((_stream_s_3 * max(- a.c1.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon) * 4.0 + (_stream_s_3 * max(- a.c2.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon) * 5.0) / (_stream_s_3 * max(- a.c1.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon + (_stream_s_3 * max(- a.c2.f, 0) + (1 - _stream_s_3) * _inStreamEpsilon));
 y1 = (((_stream_s_4 * noEvent(if - a.c2.f > 0 then - a.c2._der_f else 0) + _der_stream_s_4 * max(- a.c2.f, 0) + (- _der_stream_s_4) * _inStreamEpsilon) * 5.0 + (_stream_s_4 * noEvent(if - a.c3.f > 0 then - a.c3._der_f else 0) + _der_stream_s_4 * max(- a.c3.f, 0) + (- _der_stream_s_4) * _inStreamEpsilon) * 6.0) * (_stream_s_4 * max(- a.c2.f, 0) + (1 - _stream_s_4) * _inStreamEpsilon + (_stream_s_4 * max(- a.c3.f, 0) + (1 - _stream_s_4) * _inStreamEpsilon)) - ((_stream_s_4 * max(- a.c2.f, 0) + (1 - _stream_s_4) * _inStreamEpsilon) * 5.0 + (_stream_s_4 * max(- a.c3.f, 0) + (1 - _stream_s_4) * _inStreamEpsilon) * 6.0) * (_stream_s_4 * noEvent(if - a.c2.f > 0 then - a.c2._der_f else 0) + _der_stream_s_4 * max(- a.c2.f, 0) + (- _der_stream_s_4) * _inStreamEpsilon + (_stream_s_4 * noEvent(if - a.c3.f > 0 then - a.c3._der_f else 0) + _der_stream_s_4 * max(- a.c3.f, 0) + (- _der_stream_s_4) * _inStreamEpsilon))) / (_stream_s_4 * max(- a.c2.f, 0) + (1 - _stream_s_4) * _inStreamEpsilon + (_stream_s_4 * max(- a.c3.f, 0) + (1 - _stream_s_4) * _inStreamEpsilon)) ^ 2;
 y2 = ((((_stream_s_5 * noEvent(if - a.c2.f > 0 then - a.c2._der_f else 0) + _der_stream_s_5 * max(- a.c2.f, 0) + (- _der_stream_s_5) * _inStreamEpsilon) * 5.0 + (_stream_s_5 * noEvent(if - a.c3.f > 0 then - a.c3._der_f else 0) + _der_stream_s_5 * max(- a.c3.f, 0) + (- _der_stream_s_5) * _inStreamEpsilon) * 6.0) * (_stream_s_5 * noEvent(if - a.c2.f > 0 then - a.c2._der_f else 0) + _der_stream_s_5 * max(- a.c2.f, 0) + (- _der_stream_s_5) * _inStreamEpsilon + (_stream_s_5 * noEvent(if - a.c3.f > 0 then - a.c3._der_f else 0) + _der_stream_s_5 * max(- a.c3.f, 0) + (- _der_stream_s_5) * _inStreamEpsilon)) + ((_stream_s_5 * noEvent(if - a.c2.f > 0 then - der(a.c2._der_f) else 0) + _der_stream_s_5 * noEvent(if - a.c2.f > 0 then - a.c2._der_f else 0) + (_der_stream_s_5 * noEvent(if - a.c2.f > 0 then - a.c2._der_f else 0) + der(_der_stream_s_5) * max(- a.c2.f, 0)) + (- der(_der_stream_s_5)) * _inStreamEpsilon) * 5.0 + (_stream_s_5 * noEvent(if - a.c3.f > 0 then - der(a.c3._der_f) else 0) + _der_stream_s_5 * noEvent(if - a.c3.f > 0 then - a.c3._der_f else 0) + (_der_stream_s_5 * noEvent(if - a.c3.f > 0 then - a.c3._der_f else 0) + der(_der_stream_s_5) * max(- a.c3.f, 0)) + (- der(_der_stream_s_5)) * _inStreamEpsilon) * 6.0) * (_stream_s_5 * max(- a.c2.f, 0) + (1 - _stream_s_5) * _inStreamEpsilon + (_stream_s_5 * max(- a.c3.f, 0) + (1 - _stream_s_5) * _inStreamEpsilon)) - (((_stream_s_5 * max(- a.c2.f, 0) + (1 - _stream_s_5) * _inStreamEpsilon) * 5.0 + (_stream_s_5 * max(- a.c3.f, 0) + (1 - _stream_s_5) * _inStreamEpsilon) * 6.0) * (_stream_s_5 * noEvent(if - a.c2.f > 0 then - der(a.c2._der_f) else 0) + _der_stream_s_5 * noEvent(if - a.c2.f > 0 then - a.c2._der_f else 0) + (_der_stream_s_5 * noEvent(if - a.c2.f > 0 then - a.c2._der_f else 0) + der(_der_stream_s_5) * max(- a.c2.f, 0)) + (- der(_der_stream_s_5)) * _inStreamEpsilon + (_stream_s_5 * noEvent(if - a.c3.f > 0 then - der(a.c3._der_f) else 0) + _der_stream_s_5 * noEvent(if - a.c3.f > 0 then - a.c3._der_f else 0) + (_der_stream_s_5 * noEvent(if - a.c3.f > 0 then - a.c3._der_f else 0) + der(_der_stream_s_5) * max(- a.c3.f, 0)) + (- der(_der_stream_s_5)) * _inStreamEpsilon)) + ((_stream_s_5 * noEvent(if - a.c2.f > 0 then - a.c2._der_f else 0) + _der_stream_s_5 * max(- a.c2.f, 0) + (- _der_stream_s_5) * _inStreamEpsilon) * 5.0 + (_stream_s_5 * noEvent(if - a.c3.f > 0 then - a.c3._der_f else 0) + _der_stream_s_5 * max(- a.c3.f, 0) + (- _der_stream_s_5) * _inStreamEpsilon) * 6.0) * (_stream_s_5 * noEvent(if - a.c2.f > 0 then - a.c2._der_f else 0) + _der_stream_s_5 * max(- a.c2.f, 0) + (- _der_stream_s_5) * _inStreamEpsilon + (_stream_s_5 * noEvent(if - a.c3.f > 0 then - a.c3._der_f else 0) + _der_stream_s_5 * max(- a.c3.f, 0) + (- _der_stream_s_5) * _inStreamEpsilon)))) * (_stream_s_5 * max(- a.c2.f, 0) + (1 - _stream_s_5) * _inStreamEpsilon + (_stream_s_5 * max(- a.c3.f, 0) + (1 - _stream_s_5) * _inStreamEpsilon)) ^ 2 - (((_stream_s_5 * noEvent(if - a.c2.f > 0 then - a.c2._der_f else 0) + _der_stream_s_5 * max(- a.c2.f, 0) + (- _der_stream_s_5) * _inStreamEpsilon) * 5.0 + (_stream_s_5 * noEvent(if - a.c3.f > 0 then - a.c3._der_f else 0) + _der_stream_s_5 * max(- a.c3.f, 0) + (- _der_stream_s_5) * _inStreamEpsilon) * 6.0) * (_stream_s_5 * max(- a.c2.f, 0) + (1 - _stream_s_5) * _inStreamEpsilon + (_stream_s_5 * max(- a.c3.f, 0) + (1 - _stream_s_5) * _inStreamEpsilon)) - ((_stream_s_5 * max(- a.c2.f, 0) + (1 - _stream_s_5) * _inStreamEpsilon) * 5.0 + (_stream_s_5 * max(- a.c3.f, 0) + (1 - _stream_s_5) * _inStreamEpsilon) * 6.0) * (_stream_s_5 * noEvent(if - a.c2.f > 0 then - a.c2._der_f else 0) + _der_stream_s_5 * max(- a.c2.f, 0) + (- _der_stream_s_5) * _inStreamEpsilon + (_stream_s_5 * noEvent(if - a.c3.f > 0 then - a.c3._der_f else 0) + _der_stream_s_5 * max(- a.c3.f, 0) + (- _der_stream_s_5) * _inStreamEpsilon))) * (2 * (_stream_s_5 * max(- a.c2.f, 0) + (1 - _stream_s_5) * _inStreamEpsilon + (_stream_s_5 * max(- a.c3.f, 0) + (1 - _stream_s_5) * _inStreamEpsilon)) * (_stream_s_5 * noEvent(if - a.c2.f > 0 then - a.c2._der_f else 0) + _der_stream_s_5 * max(- a.c2.f, 0) + (- _der_stream_s_5) * _inStreamEpsilon + (_stream_s_5 * noEvent(if - a.c3.f > 0 then - a.c3._der_f else 0) + _der_stream_s_5 * max(- a.c3.f, 0) + (- _der_stream_s_5) * _inStreamEpsilon)))) / ((_stream_s_5 * max(- a.c2.f, 0) + (1 - _stream_s_5) * _inStreamEpsilon + (_stream_s_5 * max(- a.c3.f, 0) + (1 - _stream_s_5) * _inStreamEpsilon)) ^ 2) ^ 2;
 _stream_s_1 = max(- a.c3.f, 0) + max(- a.c2.f, 0);
 _stream_alpha_1 = smooth(1, if _stream_s_1 > _inStreamEpsilon then 1 elseif _stream_s_1 > 0 then _stream_s_1 / _inStreamEpsilon * (_stream_s_1 / _inStreamEpsilon * (3 - 2 * _stream_s_1)) else 0);
 _stream_s_2 = max(- a.c3.f, 0) + max(- a.c1.f, 0);
 _stream_alpha_2 = smooth(1, if _stream_s_2 > _inStreamEpsilon then 1 elseif _stream_s_2 > 0 then _stream_s_2 / _inStreamEpsilon * (_stream_s_2 / _inStreamEpsilon * (3 - 2 * _stream_s_2)) else 0);
...
equation
 ...
 a2[2].c.p = c1[2].p;
 c1[2].p = c2[2].p;
 c1[2].s = ((_stream_s_1 * max(- a1[2].c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon) * a1[2].c.s + (_stream_s_1 * max(- a2[2].c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon) * a2[2].c.s) / (_stream_s_1 * max(- a1[2].c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon + (_stream_s_1 * max(- a2[2].c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon));
 c2[2].s = ((_stream_s_2 * max(- a1[2].c.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon) * a1[2].c.s + (_stream_s_2 * max(- a2[2].c.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon) * a2[2].c.s) / (_stream_s_2 * max(- a1[2].c.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon + (_stream_s_2 * max(- a2[2].c.f, 0) + (1 - _stream_s_2) * _inStreamEpsilon));
 a1[2].c.p = 4 * time;
 a1[2].c.f = time;
 a1[2].c.s = 2 * time;
 a2[2].c.s = 6 * time;
...
fclass StreamTests.StreamWithConst4
 ...
 Real _stream_alpha_1;
equation
 x1 = ((_stream_s_1 * max(- a2.c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon) * 3.0 + (_stream_s_1 * max(- a3.c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon) * 4.0) / (_stream_s_1 * max(- a2.c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon + (_stream_s_1 * max(- a3.c.f, 0) + (1 - _stream_s_1) * _inStreamEpsilon));
 x2 = 4.0;
 x3 = 3.0;
 a2.c.f + a3.c.f = 0;
 a1.c.s = 2 * time;
...
initial equation 
 ...
 y3 = 0.0;
equation
 x1 = ((_stream_s_1 * max(- der(y2), 0) + (1 - _stream_s_1) * _inStreamEpsilon) * a2.c.s + (_stream_s_1 * max(- der(y3), 0) + (1 - _stream_s_1) * _inStreamEpsilon) * a3.c.s) / (_stream_s_1 * max(- der(y2), 0) + (1 - _stream_s_1) * _inStreamEpsilon + (_stream_s_1 * max(- der(y3), 0) + (1 - _stream_s_1) * _inStreamEpsilon));
 x2 = ((_stream_s_2 * max(- der(y1), 0) + (1 - _stream_s_2) * _inStreamEpsilon) * a1.c.s + (_stream_s_2 * max(- der(y3), 0) + (1 - _stream_s_2) * _inStreamEpsilon) * a3.c.s) / (_stream_s_2 * max(- der(y1), 0) + (1 - _stream_s_2) * _inStreamEpsilon + (_stream_s_2 * max(- der(y3), 0) + (1 - _stream_s_2) * _inStreamEpsilon));
 x3 = ((_stream_s_3 * max(- der(y1), 0) + (1 - _stream_s_3) * _inStreamEpsilon) * a1.c.s + (_stream_s_3 * max(- der(y2), 0) + (1 - _stream_s_3) * _inStreamEpsilon) * a2.c.s) / (_stream_s_3 * max(- der(y1), 0) + (1 - _stream_s_3) * _inStreamEpsilon + (_stream_s_3 * max(- der(y2), 0) + (1 - _stream_s_3) * _inStreamEpsilon));
 a1.c.f = der(y1);
 a2.c.f = der(y2);
 a3.c.f = der(y3);
