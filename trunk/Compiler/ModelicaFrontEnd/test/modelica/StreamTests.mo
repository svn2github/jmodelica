...
equation
 ...
 a2[2].c.p = c1[2].p;
 c1[2].p = c2[2].p;
 c1[2].s = (_stream_positiveMax_1 * a1[2].c.s + _stream_positiveMax_2 * a2[2].c.s) / (_stream_positiveMax_1 + _stream_positiveMax_2);
 c2[2].s = (_stream_positiveMax_3 * a1[2].c.s + _stream_positiveMax_4 * a2[2].c.s) / (_stream_positiveMax_3 + _stream_positiveMax_4);
 a1[2].c.p = 4 * time;
 a1[2].c.f = time;
 a1[2].c.s = 2 * time;
 a2[2].c.s = 6 * time;
 ...
 x2[1] = 5.0;
 x2[2] = a1[2].c.s;
 _stream_s_1 = max(- a1[2].c.f, 0) + max(- a2[2].c.f, 0);
 _stream_alpha_1 = smooth(1, if _stream_s_1 > _inStreamEpsilon then 1 elseif _stream_s_1 > 0 then _stream_s_1 / _inStreamEpsilon * (_stream_s_1 / _inStreamEpsilon * (3 - 2 * _stream_s_1)) else 0);
 _stream_positiveMax_1 = _stream_alpha_1 * max(- a1[2].c.f, 0) + (1 - _stream_alpha_1) * _inStreamEpsilon;
 _stream_positiveMax_2 = _stream_alpha_1 * max(- a2[2].c.f, 0) + (1 - _stream_alpha_1) * _inStreamEpsilon;
 _stream_s_2 = max(- a1[2].c.f, 0) + max(- a2[2].c.f, 0);
 _stream_alpha_2 = smooth(1, if _stream_s_2 > _inStreamEpsilon then 1 elseif _stream_s_2 > 0 then _stream_s_2 / _inStreamEpsilon * (_stream_s_2 / _inStreamEpsilon * (3 - 2 * _stream_s_2)) else 0);
 _stream_positiveMax_3 = _stream_alpha_2 * max(- a1[2].c.f, 0) + (1 - _stream_alpha_2) * _inStreamEpsilon;
 _stream_positiveMax_4 = _stream_alpha_2 * max(- a2[2].c.f, 0) + (1 - _stream_alpha_2) * _inStreamEpsilon;
