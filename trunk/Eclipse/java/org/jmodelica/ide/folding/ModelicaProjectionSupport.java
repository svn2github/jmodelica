 ...
 */
public class ModelicaProjectionSupport {
	...
	private static class ProjectionAnnotationsPainter extends AnnotationPainter {
		...
		protected IAnnotationModel findAnnotationModel(ISourceViewer sourceViewer) {
			if (sourceViewer instanceof ModelicaProjectionViewer) {
				ModelicaProjectionViewer projectionViewer= (ModelicaProjectionViewer) sourceViewer;
		...
		public void draw(Annotation annotation, GC gc, StyledText textWidget, int offset, int length, Color color) {
			if (annotation instanceof ProjectionAnnotation) {
				...
				if (projectionAnnotation.isCollapsed()) {
					...
					if (gc != null) {
						if (annotation instanceof AnnotationProjectionAnnotation) {
							offset--;
	...
	private ModelicaProjectionViewer fViewer;
	 ...
	 */
	public ModelicaProjectionSupport(ModelicaProjectionViewer viewer, IAnnotationAccess annotationAccess, ISharedTextColors sharedTextColors) {
		fViewer= viewer;
	...
	public Object getAdapter(ISourceViewer viewer, Class required) {
		if (ProjectionAnnotationModel.class.equals(required)) {
			if (viewer instanceof ModelicaProjectionViewer) {
				ModelicaProjectionViewer projectionViewer= (ModelicaProjectionViewer) viewer;
				return projectionViewer.getProjectionAnnotationModel();
			}
		}
		return null;
	...
	public void setCursorLineBackground(Color bg) {
		IDrawingStrategy strategy = getDrawingStrategy();
		if (strategy instanceof ProjectionDrawingStrategy) {
			ProjectionDrawingStrategy projectionDrawingStrategy = (ProjectionDrawingStrategy) strategy;
			projectionDrawingStrategy.setCursorLineBackground(bg);
		}
	}
}
