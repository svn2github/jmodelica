 ...
 */
public class CharacterProjectionSupport {
	...
	private static class ProjectionAnnotationsPainter extends AnnotationPainter {
		...
		protected IAnnotationModel findAnnotationModel(ISourceViewer sourceViewer) {
			if (sourceViewer instanceof CharacterProjectionViewer) {
				CharacterProjectionViewer projectionViewer= (CharacterProjectionViewer) sourceViewer;
	...
	private CharacterProjectionViewer fViewer;
	 ...
	 */
	public CharacterProjectionSupport(CharacterProjectionViewer viewer, IAnnotationAccess annotationAccess, ISharedTextColors sharedTextColors) {
		fViewer= viewer;
	...
	public IDrawingStrategy getAnnotationPainterDrawingStrategy() {
		return getDrawingStrategy();
	}
	...
	public Object getAdapter(ISourceViewer viewer, Class required) {
		if (ProjectionAnnotationModel.class.equals(required)) {
			if (viewer instanceof CharacterProjectionViewer) {
				CharacterProjectionViewer projectionViewer= (CharacterProjectionViewer) viewer;
				return projectionViewer.getProjectionAnnotationModel();
			}
		}
		return null;
