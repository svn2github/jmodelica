...
public class ModelicaPreferences extends Preferences {
	
	public static final ModelicaPreferences INSTANCE = new ModelicaPreferences();
	...
	public Color getColor(String key) {
		return readColor(INSTANCE.get(key));
	}

	public void setColor(String key, Color value) {
		INSTANCE.set(key, writeColor(value));
	}
	...
	public void initializeDefaultPreferences() {
		...
		IEclipsePreferences node = DefaultScope.INSTANCE.getNode(IDEConstants.PLUGIN_ID);
	...
	public abstract static class SyntaxColorPref {
		...
		public Token getToken() {
			...
			if ((flags & FLAG_USE_ANNO_BG) == FLAG_USE_ANNO_BG) {
				Color bg = INSTANCE.getColor(IDEConstants.PREFERENCE_ANNO_BG_ID);
		...
		public static SyntaxColorPref getPref(String key) {
			String[] parts = INSTANCE.get(getPrefId(key)).split(",");
		...
		public void setPref() {
			INSTANCE.set(getPrefId(), toString());
		}
		
		public void clearPref() {
			INSTANCE.clear(getPrefId());
		}
