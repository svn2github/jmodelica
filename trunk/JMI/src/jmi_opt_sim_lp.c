...
*/
			...
			if (linearity_information_provided==1) {
				...
				// Iterate over element junction state variables.
				// Iterate over states
				for (i=0;i<n_e;i++) {
					for (k=0;k<jmi->n_x;k++) {
						if (x_lin[k]==0) {
