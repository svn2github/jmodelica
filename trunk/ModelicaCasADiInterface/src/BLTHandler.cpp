...
namespace ModelicaCasADi
{
    ...
    {
        int i=0;
        for(std::vector<Block*>::const_iterator it=blt.begin();
            it!=blt.end();++it){
                out << "Block[" <<i<<"]\n";
    ...
    void BLTHandler::substituteAllEliminateables(){
        ...
        for(std::vector<Block*>::iterator it=blt.begin();
            it!=blt.end();++it){
