...
class TestPolynomialMethods:
    ...
    def test_legendre_pn(self):
        ...
        nose.tools.assert_almost_equal(P_0, legendre_Pn(0, x), places=14)
        nose.tools.assert_almost_equal(P_1, legendre_Pn(1, x), places=14)
        nose.tools.assert_almost_equal(P_2, legendre_Pn(2, x), places=14)
        nose.tools.assert_almost_equal(P_3, legendre_Pn(3, x), places=14)
        nose.tools.assert_almost_equal(P_4, legendre_Pn(4, x), places=14)
    ...
    def test_legendre_dpn(self):
        ...
        nose.tools.assert_almost_equal(P_1, legendre_dPn(1, x), places=14)
        nose.tools.assert_almost_equal(P_2, legendre_dPn(2, x), places=14)
        nose.tools.assert_almost_equal(P_3, legendre_dPn(3, x), places=14)
        nose.tools.assert_almost_equal(P_4, legendre_dPn(4, x), places=14)
    ...
    def test_legendre_ddpn(self):
        ...
        nose.tools.assert_almost_equal(P_1, legendre_ddPn(1, x), places=14)
        nose.tools.assert_almost_equal(P_2, legendre_ddPn(2, x), places=14)
        nose.tools.assert_almost_equal(P_3, legendre_ddPn(3, x), places=14)
        nose.tools.assert_almost_equal(P_4, legendre_ddPn(4, x), places=14)
        nose.tools.assert_almost_equal(P_5, legendre_ddPn(5, x), places=14)
    ...
    def test_jacobi_a1_b0_roots(self):
        ...
        nose.tools.assert_almost_equal(pn_r[0], roots1[0], places=14)
    ...
    def test_differentiation_matrix(self):
        ...
        WTD = N.dot(W,D)
        nose.tools.assert_almost_equal(WTD[0], -1.0, places=12)
        nose.tools.assert_almost_equal(WTD[-1], 1.0, places=12)
        for i in range(1,9):
    ...
    def test_legendre_pn_roots(self):
        ...
        nose.tools.assert_almost_equal(pn_r[0], roots3[0], places=14)
        nose.tools.assert_almost_equal(pn_r[1], roots3[1], places=14)
        nose.tools.assert_almost_equal(pn_r[2], roots3[2], places=14)
        
        pn_r = legendre_Pn_roots(4)
        nose.tools.assert_almost_equal(pn_r[0], roots4[0], places=14)
        nose.tools.assert_almost_equal(pn_r[1], roots4[1], places=14)
        nose.tools.assert_almost_equal(pn_r[2], roots4[2], places=14)
        nose.tools.assert_almost_equal(pn_r[3], roots4[3], places=14)
        
        pn_r = legendre_Pn_roots(5)
        nose.tools.assert_almost_equal(pn_r[0], roots5[0], places=14)
        nose.tools.assert_almost_equal(pn_r[1], roots5[1], places=14)
        nose.tools.assert_almost_equal(pn_r[2], roots5[2], places=14)
    ...
    def test_gauss_legendre_radau_weights(self):
        ...
        nose.tools.assert_almost_equal(pn_w[0], w2[0], places=14)
        nose.tools.assert_almost_equal(pn_w[1], w2[1], places=14)
        
        pn_w = gauss_quadrature_weights("LGR", 3)
        nose.tools.assert_almost_equal(pn_w[0], w3[0], places=14)
        nose.tools.assert_almost_equal(pn_w[1], w3[1], places=14)
        nose.tools.assert_almost_equal(pn_w[2], w3[2], places=14)
    ...
    def test_gauss_legendre_lobatto_weights(self):
        ...
        nose.tools.assert_almost_equal(N.sum(pn_w), 2.0, places=14)
    ...
    def test_gauss_legendre_weights(self):
        ...
        nose.tools.assert_almost_equal(pn_w[0], w4[0], places=14)
        nose.tools.assert_almost_equal(pn_w[1], w4[1], places=14)
        nose.tools.assert_almost_equal(pn_w[2], w4[2], places=14)
        nose.tools.assert_almost_equal(pn_w[3], w4[3], places=14)
        
        pn_w = gauss_quadrature_weights("LG", 5)
        nose.tools.assert_almost_equal(pn_w[0], w5[0], places=14)
        nose.tools.assert_almost_equal(pn_w[1], w5[1], places=14)
        nose.tools.assert_almost_equal(pn_w[2], w5[2], places=14)
        nose.tools.assert_almost_equal(pn_w[3], w5[3], places=14)
        nose.tools.assert_almost_equal(pn_w[4], w5[4], places=14)
