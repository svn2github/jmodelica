...
setup(name=NAME,
      ...
      packages=['pyjmi','pyjmi.simulation','pyjmi.optimization','pyjmi.initialization','pyjmi.examples','pyjmi.common','pyjmi.common.plotting','pyjmi.log','pyjmi.optimization.mhe'],
