...
class Test_ODE_JACOBIANS1:
    ...
    def setUpClass(cls):
        ...
        _fn_furuta = compile_fmu(cname, fname, compiler_options={'generate_ode_jacobian':True}, version="2.0")
...
class Test_ODE_JACOBIANS2:
    ...
    def setUpClass(cls):
        ...
        _fn_nonlin = compile_fmu(cname, fname, compiler_options={'generate_ode_jacobian':True,'automatic_tearing':False}, version="2.0")
...
class Test_ODE_JACOBIANS3:
    ...
    def setUpClass(cls):
        ...
        _fn_distlib = compile_fmu(cname, fname, compiler_options={'generate_ode_jacobian':True}, version="2.0")
...
class Test_ODE_JACOBIANS4:
    ...
    def setUpClass(cls):
        ...
        fn_nonlinIO = compile_fmu(cname, fname, compiler_options={'generate_ode_jacobian':True,'eliminate_alias_variables':False,'automatic_tearing':False}, version="2.0")
...
class Test_ODE_JACOBIANS5:
    ...
    def setUpClass(cls):
        ...
        _fn_block = compile_fmu(cname, fname, compiler_options={'generate_ode_jacobian':True,'generate_runtime_option_parameters':False, 'automatic_tearing':False}, version="2.0")
