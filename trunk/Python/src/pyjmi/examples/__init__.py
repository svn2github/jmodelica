...
__all__ = ['ast_example', 'bang_control', 'blood_glucose', 'blood_glucose_opt', 
           ...
           'ccpp', 'coloumb_friction', 'cont_state', 'crane', 'crystallizer', 
           'cstr', 'cstr_casadi','cstr_mpc', 'cstr2', 'distillation', 
           ...
           'flight_path', 'furuta_dfo', 'furuta_dfo_cost', 'furuta_modified', 
           'helicopter_der', 'hohmann_transfer', 'if_example_1', 'if_example_2', 
           'lagrange_cost', 'leadtransport', 'mechanical_rotational_examples_coupled_clutches', 
