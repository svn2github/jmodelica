...
def run_demo(with_plots=True):
    ...
    r1,r2,my        = res_opt["rStart"],   res_opt["rFinal"], res_opt["my"]
    tf,t1           = res_opt["time"][-1], res_opt["t1"]
    ...
    res = model.simulate(start_time=t1,final_time=tf,options={'ncp':100,'solver':"CVode"})
    ...
    res = model.simulate(start_time=tf,final_time=tf*2,options={'ncp':100,'solver':"CVode"})
